...
template <int N>
BenchHeader<N>::BenchHeader () : m_ok (false)
{
}
...
main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("min-iterations", "number of subiterations to minimize iteration time over",
                minIterations);
