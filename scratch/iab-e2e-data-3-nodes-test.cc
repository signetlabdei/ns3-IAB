...
main (int argc, char *argv[])
{
  ...
  iabPositionAlloc->Add (Vector (10, 0.0, 0.0));
  iabPositionAlloc->Add (Vector (20, 0.0, 0.0));
  iabPositionAlloc->Add (Vector (25, 0.0, 0.0));
  ...
  uePositionAlloc->Add (Vector (21, 0.0, 0.0));
  uePositionAlloc->Add (Vector (26, 0.0, 0.0));
  ...
  mmwaveHelper->AttachToClosestIab (NetDeviceContainer (ueMmWaveDev.Get (0)), NetDeviceContainer (iabMmWaveDev.Get (1)));
  mmwaveHelper->AttachToClosestIab (NetDeviceContainer (ueMmWaveDev.Get (1)), NetDeviceContainer (iabMmWaveDev.Get (2)));
...
//   for (unsigned int i = 1; i < iabNode.GetN (); i++)
//     {
  InstallUdpApplication (ulNodeAppStream, iabNode.Get (0), internetIpIfaces.GetAddress (1),
                         ulAppParams);
  InstallUdpPacketSink (ulNodeAppStream, internetIpIfaces.GetAddress (1), remoteHost, ulAppParams);
