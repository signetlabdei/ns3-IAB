...
std::string dataSensorRate = "75Mbps";
double powerTx = 30;
double bw = 400e6;
double fc = 26e9;
...
NS_LOG_COMPONENT_DEFINE ("IabPaperScenario");
...
main (int argc, char *argv[])
{
  ...
  // LogComponentEnable("TwoRayPropagationLossModel", LOG_LEVEL_DEBUG);
  ...
  mmwaveHelper->AttachIabTotIabWithIndex (iabMmWaveDev, 6, 3, enbMmWaveDev, 0);
