  ...
  static TypeId tid =
      TypeId ("ns3::Ipv4L3ClickProtocol")
          ...
          .AddAttribute (
              ...
              UintegerValue (64), MakeUintegerAccessor (&Ipv4L3ClickProtocol::m_defaultTtl),
              MakeUintegerChecker<uint8_t> ())
          .AddAttribute (
              "InterfaceList", "The set of Ipv4 interfaces associated to this Ipv4 stack.",
              ObjectVectorValue (), MakeObjectVectorAccessor (&Ipv4L3ClickProtocol::m_interfaces),
              MakeObjectVectorChecker<Ipv4Interface> ());
  return tid;
}

Ipv4L3ClickProtocol::Ipv4L3ClickProtocol () : m_identification (0)
{
}
...
Ipv4Address
Ipv4L3ClickProtocol::SelectSourceAddress (Ptr<const NetDevice> device, Ipv4Address dst,
...
Ipv4L3ClickProtocol::SetPromisc (uint32_t i)
{
  ...
  Ptr<Node> node = GetObject<Node> ();
  NS_ASSERT (node);
  node->RegisterProtocolHandler (MakeCallback (&Ipv4L3ClickProtocol::Receive, this), 0, netdev,
                                 true);
}
...
Ipv4Header
Ipv4L3ClickProtocol::BuildHeader (Ipv4Address source, Ipv4Address destination, uint8_t protocol,
...
void
Ipv4L3ClickProtocol::Send (Ptr<Packet> packet, Ipv4Address source, Ipv4Address destination,
...
void
Ipv4L3ClickProtocol::Receive (Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol,
                              ...
                              NetDevice::PacketType packetType)
{
  ...
  click->Receive (packet->Copy (), Mac48Address::ConvertFrom (device->GetAddress ()),
