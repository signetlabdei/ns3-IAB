...
X2IfaceInfo::X2IfaceInfo (Ipv4Address remoteIpAddr, Ptr<Socket> localCtrlPlaneSocket,
...
EpcX2::EpcX2 () : m_x2cUdpPort (4444), m_x2uUdpPort (2152)
{
  NS_LOG_FUNCTION (this);
...
EpcX2::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::EpcX2")
          .SetParent<Object> ()
          .SetGroupName ("Lte")
          .AddTraceSource ("RxPDU", "PDU received.", MakeTraceSourceAccessor (&EpcX2::m_rxPdu),
...
// Add X2 endpoint
void
EpcX2::AddX2Interface (uint16_t localCellId, Ipv4Address localX2Address, uint16_t remoteCellId,
...
EpcX2::RecvFromX2cSocket (Ptr<Socket> socket)
{
  ...
  m_rxPdu (cellsInfo->m_remoteCellId, cellsInfo->m_localCellId, packet->GetSize (),
           delay.GetNanoSeconds (), 0);
