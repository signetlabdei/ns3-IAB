  ...
  static TypeId tid =
      TypeId ("ns3::EpsBearerTag")
          ...
          .AddAttribute ("rnti", "The rnti that indicates the UE which packet belongs",
                         UintegerValue (0), MakeUintegerAccessor (&EpsBearerTag::GetRnti),
                         MakeUintegerChecker<uint16_t> ())
          .AddAttribute ("bid", "The EPS bearer id within the UE to which the packet belongs",
                         UintegerValue (0), MakeUintegerAccessor (&EpsBearerTag::GetBid),
...
EpsBearerTag::EpsBearerTag () : m_rnti (0), m_bid (0)
{
}
EpsBearerTag::EpsBearerTag (uint16_t rnti, uint32_t bid) : m_rnti (rnti), m_bid (bid)
{
}
...
void
EpsBearerTag::SetBid (uint32_t bid)
{
  m_bid = bid;
}
