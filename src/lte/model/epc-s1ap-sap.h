...
public:
   ...
   *
   */
  virtual void InitialUeMessage (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, uint64_t stmsi,
                                 uint16_t ecgi) = 0;
  ...
  /**
    ...
    */
  virtual void
  ErabReleaseIndication (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
   ...
   *
   */
  virtual void InitialContextSetupResponse (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
   ...
   */
  virtual void
  PathSwitchRequest (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t gci,
...
{
public:
  virtual void SendInitialUeMessage (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, uint64_t stmsi,
                                     uint16_t ecgi) = 0;

  virtual void
  SendErabReleaseIndication (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
                             std::list<ErabToBeReleasedIndication> erabToBeReleaseIndication) = 0;

  virtual void SendInitialContextSetupResponse (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
                                                std::list<ErabSetupItem> erabSetupList) = 0;

  virtual void
  SendPathSwitchRequest (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t gci,
                         std::list<ErabSwitchedInDownlinkItem> erabToBeSwitchedInDownlinkList) = 0;
};
...
{
public:
  virtual void SendInitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
...
public:
  ...
  virtual void InitialUeMessage (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, uint64_t imsi,
                                 uint16_t ecgi);
  virtual void
  ErabReleaseIndication (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
  ...
  virtual void
  PathSwitchRequest (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t cgi,
...
template <class C>
void
MemberEpcS1apSapMme<C>::InitialUeMessage (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, uint64_t imsi,
                                          uint16_t ecgi)
{
...
template <class C>
void
MemberEpcS1apSapMme<C>::InitialContextSetupResponse (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
                                                     std::list<ErabSetupItem> erabSetupList)
{
...
public:
  ...
  virtual void SendInitialUeMessage (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, uint64_t imsi,
                                     uint16_t ecgi);
  virtual void
  SendErabReleaseIndication (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
                             std::list<ErabToBeReleasedIndication> erabToBeReleaseIndication);
  ...
  virtual void SendInitialContextSetupResponse (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
                                                std::list<ErabSetupItem> erabSetupList);
  virtual void
  SendPathSwitchRequest (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t cgi,
                         std::list<ErabSwitchedInDownlinkItem> erabToBeSwitchedInDownlinkList);
...
template <class C>
MemberEpcS1apSapEnbProvider<C>::MemberEpcS1apSapEnbProvider (C *owner) : m_owner (owner)
{
}
...
template <class C>
void
MemberEpcS1apSapEnbProvider<C>::SendInitialUeMessage (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
...
MemberEpcS1apSapEnbProvider<C>::SendInitialContextSetupResponse (
    uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<ErabSetupItem> erabSetupList)
{
...
public:
  ...
  virtual void InitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
                                           std::list<ErabToBeSetupItem> erabToBeSetupList);
  virtual void
  PathSwitchRequestAcknowledge (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t cgi,
...
template <class C>
void
MemberEpcS1apSapEnb<C>::InitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
                                                    std::list<ErabToBeSetupItem> erabToBeSetupList)
{
...
template <class C>
MemberEpcS1apSapMmeProvider<C>::MemberEpcS1apSapMmeProvider (C *owner) : m_owner (owner)
{
}
...
MemberEpcS1apSapMmeProvider<C>::SendInitialContextSetupRequest (
    uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<ErabToBeSetupItem> erabToBeSetupList,
    uint16_t cellId)
{
...
MemberEpcS1apSapMmeProvider<C>::SendPathSwitchRequestAcknowledge (
    ...
    std::list<ErabSwitchedInUplinkItem> erabToBeSwitchedInUplinkList)
{
  m_owner->DoSendPathSwitchRequestAcknowledge (enbUeS1Id, mmeUeS1Id, cgi,
