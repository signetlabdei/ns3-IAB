...
LteRlcSpecificLteMacSapUser::LteRlcSpecificLteMacSapUser (LteRlc *rlc) : m_rlc (rlc)
{
}
...
LteRlc::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::LteRlc")
          ...
          .AddTraceSource ("RxPDU", "PDU received.", MakeTraceSourceAccessor (&LteRlc::m_rxPdu),
                           "ns3::LteRlc::ReceiveTracedCallback")
          .AddTraceSource ("TxCompletedCallback", "PDU acked.",
...
LteRlcSm::ReportBufferStatus ()
{
  ...
  p.lcid = m_lcid;
  p.txQueueSize =
      1000000; // mmWave module: Arbitrarily changed full-buffer BSR to report 1MB available each subframe
