...
EpcX2Header::EpcX2Header ()
    : m_messageType (0xfa), m_procedureCode (0xfa), m_lengthOfIes (0xfa), m_numberOfIes (0xfa)
{
}
...
void
EpcX2RlcSetupRequestHeader::SetDrbid (uint32_t drbid)
{
  m_drbid = drbid;
}
...
EpcX2SnStatusTransferHeader::EpcX2SnStatusTransferHeader ()
    : m_numberOfIes (3), m_headerLength (6), m_oldEnbUeX2apId (0xfffa), m_newEnbUeX2apId (0xfffa)
{
...
EpcX2LoadInformationHeader::EpcX2LoadInformationHeader () : m_numberOfIes (1), m_headerLength (6)
{
...
EpcX2UeImsiSinrUpdateHeader::EpcX2UeImsiSinrUpdateHeader ()
    : m_numberOfIes (1 + 1), m_headerLength (2 + 2)
{
  m_map.clear ();
}
...
void
EpcX2ConnectionSwitchHeader::SetDrbid (uint32_t bid)
{
  m_drbid = bid;
}
