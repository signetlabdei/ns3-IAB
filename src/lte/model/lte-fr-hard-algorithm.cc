...
static const struct FrHardDownlinkDefaultConfiguration
{
  ...
  uint8_t m_dlSubBand; ///< DL subband
    ...
    {2, 25, 8, 8},   {3, 25, 16, 9},   {1, 50, 0, 16},  {2, 50, 16, 16},
    {3, 50, 32, 18}, {1, 75, 0, 24},   {2, 75, 24, 24}, {3, 75, 48, 27},
    {1, 100, 0, 32}, {2, 100, 32, 32}, {3, 100, 64, 36}}; ///< the hard downlink default configuration
...
static const struct FrHardUplinkDefaultConfiguration
{
  ...
  uint8_t m_ulSubBand; ///< UL subband
    ...
    {2, 25, 8, 8},   {3, 25, 16, 9},   {1, 50, 0, 16},  {2, 50, 16, 16},
    {3, 50, 32, 18}, {1, 75, 0, 24},   {2, 75, 24, 24}, {3, 75, 48, 27},
    {1, 100, 0, 32}, {2, 100, 32, 32}, {3, 100, 64, 36}}; ///< the hard uplink default configuration
...
LteFrHardAlgorithm::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::LteFrHardAlgorithm")
          ...
          .AddAttribute ("UlSubBandOffset", "Uplink Offset in number of Resource Block Groups",
                         UintegerValue (0), MakeUintegerAccessor (&LteFrHardAlgorithm::m_ulOffset),
                         MakeUintegerChecker<uint8_t> ())
          .AddAttribute (
              "UlSubBandwidth",
              "Uplink Transmission SubBandwidth Configuration in number of Resource Block Groups",
              UintegerValue (25), MakeUintegerAccessor (&LteFrHardAlgorithm::m_ulSubBand),
              MakeUintegerChecker<uint8_t> ())
          .AddAttribute ("DlSubBandOffset", "Downlink Offset in number of Resource Block Groups",
                         UintegerValue (0), MakeUintegerAccessor (&LteFrHardAlgorithm::m_dlOffset),
                         MakeUintegerChecker<uint8_t> ())
          .AddAttribute (
              "DlSubBandwidth",
              "Downlink Transmission SubBandwidth Configuration in number of Resource Block Groups",
              UintegerValue (25), MakeUintegerAccessor (&LteFrHardAlgorithm::m_dlSubBand),
              MakeUintegerChecker<uint8_t> ());
  return tid;
}
