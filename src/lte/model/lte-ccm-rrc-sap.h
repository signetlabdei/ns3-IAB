...
public:
  ...
  SetupDataRadioBearer (EpsBearer bearer, uint32_t bearerId, uint16_t rnti, uint8_t lcid,
                        uint8_t lcGroup, LteMacSapUser *msu) = 0;
...
public:
   ...
   */
  virtual uint8_t
  AddUeMeasReportConfigForComponentCarrier (LteRrcSap::ReportConfigEutra reportConfig) = 0;
...
public:
  ...
  virtual std::vector<LteCcmRrcSapProvider::LcsConfig>
  SetupDataRadioBearer (EpsBearer bearer, uint32_t bearerId, uint16_t rnti, uint8_t lcid,
                        uint8_t lcGroup, LteMacSapUser *msu);
...
template <class C>
MemberLteCcmRrcSapProvider<C>::MemberLteCcmRrcSapProvider (C *owner) : m_owner (owner)
{
}
...
MemberLteCcmRrcSapProvider<C>::SetupDataRadioBearer (EpsBearer bearer, uint32_t bearerId,
                                                     uint16_t rnti, uint8_t lcid, uint8_t lcGroup,
                                                     LteMacSapUser *msu)
{
...
public:
  ...
  virtual uint8_t
  AddUeMeasReportConfigForComponentCarrier (LteRrcSap::ReportConfigEutra reportConfig);
