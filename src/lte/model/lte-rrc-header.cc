  ...
  for (; it != drbToAddModList.end (); it++)
    {
      ...
      // Serialize eps-BearerIdentity::=INTEGER (0..m_maxRbId)
      SerializeInteger (it->epsBearerIdentity, 0, m_maxRbId);

      // Serialize drb-Identity ::= INTEGER (1..m_maxRbId)
      SerializeInteger (it->drbIdentity, 1, m_maxRbId);
    ...
    LteRrcSap::PhysicalConfigDedicated physicalConfigDedicated) const
{
  ...
  optionalFieldsPhysicalConfigDedicated.set (
      9, physicalConfigDedicated.havePdschConfigDedicated); // pdsch-ConfigDedicated
  ...
  optionalFieldsPhysicalConfigDedicated.set (
      2, physicalConfigDedicated.haveSoundingRsUlConfigDedicated); // soundingRS-UL-ConfigDedicated
  optionalFieldsPhysicalConfigDedicated.set (
      1, physicalConfigDedicated.haveAntennaInfoDedicated); // antennaInfo
  ...
  if (physicalConfigDedicated.haveSoundingRsUlConfigDedicated)
    {
      ...
      switch (physicalConfigDedicated.soundingRsUlConfigDedicated.type)
        ...
        default:
          ...
          SerializeInteger (physicalConfigDedicated.soundingRsUlConfigDedicated.srsConfigIndex, 0,
                            1023);
  ...
  if (measResults.haveScellsMeas)
    {
      ...
      for (it = measResults.measScellResultList.measResultScell.begin ();
           it != measResults.measScellResultList.measResultScell.end (); it++)
        {
          // Serialize measId
          SerializeInteger (
              it->servFreqId, 0,
              MAX_MEAS_ID); // ToDo: change with FreqId, currently is the componentCarrierId
  ...
  if (measConfig.haveSpeedStatePars)
    {
      switch (measConfig.speedStatePars.type)
        ...
        default:
          ...
          SerializeInteger (measConfig.speedStatePars.mobilityStateParameters.nCellChangeMedium, 1,
                            16);
          SerializeInteger (measConfig.speedStatePars.mobilityStateParameters.nCellChangeHigh, 1,
                            16);
    ...
    LteRrcSap::NonCriticalExtensionConfiguration nonCriticalExtension) const
{
  ...
  noncriticalExtension_v1020.set (
      0, 0); // No nonCriticalExtension RRCConnectionReconfiguration-v1130-IEs
  ...
  if (!nonCriticalExtension.sCellsToAddModList.empty ())
    {
      ...
      for (std::list<LteRrcSap::SCellToAddMod>::iterator it =
           ...
           it != nonCriticalExtension.sCellsToAddModList.end (); it++)
        {
          ...
          sCellToAddMod_r10.set (
              0, it->haveRadioResourceConfigDedicatedSCell); // No nonCriticalExtension RRC
      ...
      if (optionalFields[4])
        {
          ...
          bIterator = DeserializeInteger (&val, 0, m_maxRbId, bIterator);
          drbToAddMod.epsBearerIdentity = val;
        }

      bIterator = DeserializeInteger (&val, 1, m_maxRbId, bIterator);
...
RrcAsn1Header::DeserializeLogicalChannelConfig (
    LteRrcSap::LogicalChannelConfig *logicalChannelConfig, Buffer::Iterator bIterator)
{
  int n;
...
RrcAsn1Header::DeserializePhysicalConfigDedicated (
    LteRrcSap::PhysicalConfigDedicated *physicalConfigDedicated, Buffer::Iterator bIterator)
{
...
RrcAsn1Header::DeserializeNonCriticalExtensionConfig (
    LteRrcSap::NonCriticalExtensionConfiguration *nonCriticalExtension, Buffer::Iterator bIterator)
{
  NS_LOG_FUNCTION (this);
      ...
      if (nonCriticalExtension_v920[0])
        {
          ...
          NS_ASSERT (!nonCriticalExtension_v1020
          ...
          for (int i = 0; i < numElems; i++)
            {
              ...
              nonCriticalExtension->sCellsToAddModList.insert (
                  nonCriticalExtension->sCellsToAddModList.end (), sctam);
            }
        }
    }
...
RrcAsn1Header::DeserializeRadioResourceConfigCommonSCell (
    LteRrcSap::RadioResourceConfigCommonSCell *rrccsc, Buffer::Iterator bIterator)
{
  NS_LOG_FUNCTION (this);
  std::bitset<2> radioResourceConfigCommonSCell_r10;
...
RrcAsn1Header::DeserializeRadioResourceConfigDedicatedSCell (
    LteRrcSap::RadioResourceConfigDedicatedSCell *rrcdsc, Buffer::Iterator bIterator)
{
  NS_LOG_FUNCTION (this);
  std::bitset<1> RadioResourceConfigDedicatedSCell_r10;
...
RrcAsn1Header::DeserializePhysicalConfigDedicatedSCell (
    LteRrcSap::PhysicalConfigDedicatedSCell *pcdsc, Buffer::Iterator bIterator)
{
  NS_LOG_FUNCTION (this);
  std::bitset<2> pcdscOpt;
  ...
  for (; it != radioResourceConfigDedicated.srbToAddModList.end (); it++)
    {
      ...
      os << "         bucketSizeDurationMs: " << (int) it->logicalChannelConfig.bucketSizeDurationMs
         << std::endl;
...
RrcAsn1Header::DeserializeSystemInformationBlockType1 (
    LteRrcSap::SystemInformationBlockType1 *systemInformationBlockType1, Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
  ...
  bIterator = DeserializeBoolean (&systemInformationBlockType1->cellAccessRelatedInfo.csgIndication,
                                  bIterator);
...
RrcAsn1Header::DeserializeSystemInformationBlockType2 (
    LteRrcSap::SystemInformationBlockType2 *systemInformationBlockType2, Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
...
RrcAsn1Header::DeserializeRadioResourceConfigCommon (
    LteRrcSap::RadioResourceConfigCommon *radioResourceConfigCommon, Buffer::Iterator bIterator)
{
  std::bitset<0> bitset0;
  int n;
  ...
  if (bitset11[8])
    {
      ...
      bIterator = DeserializeSequenceOf (&reportConfigToRemoveListElems, MAX_REPORT_CONFIG_ID, 1,
                                         bIterator);
  ...
  if (bitset11[7])
    {
      ...
      bIterator = DeserializeSequenceOf (&reportConfigToAddModListElems, MAX_REPORT_CONFIG_ID, 1,
                                         bIterator);
              ...
              if (triggerTypeChoice == 0)
                {
                  ...
                  switch (eventIdChoice)
                    ...
                    case 0:
                      ...
                      bIterator = DeserializeSequence (&bitset0, false, bIterator);
                      bIterator =
                          DeserializeThresholdEutra (&elem.reportConfigEutra.threshold1, bIterator);
                      break;
                    ...
                    default:
                      ...
                      bIterator =
                          DeserializeThresholdEutra (&elem.reportConfigEutra.threshold1, bIterator);
                      bIterator =
                          DeserializeThresholdEutra (&elem.reportConfigEutra.threshold2, bIterator);
                    }
...
RrcConnectionSwitchHeader::PreSerialize () const
{
  ...
  SerializeInteger (m_msg.drbidList.size (), 0, m_maxRbId);

  auto drbIt = m_msg.drbidList.begin ();
  for (; drbIt != m_msg.drbidList.end (); ++drbIt)
    {
      SerializeInteger (*drbIt, 0, m_maxRbId);
    }
...
RrcConnectionSwitchHeader::Deserialize (Buffer::Iterator bIterator)
{
  ...
  for (int i = 0; i < listSize; i++)
    {
      bIterator = DeserializeInteger (&n, 0, m_maxRbId, bIterator);
      uint32_t drb = (uint32_t) n;
...
RrcConnectionReconfigurationHeader::PreSerialize () const
{
  ...
  options.set (
      0,
      m_haveNonCriticalExtension); // Implemented nonCriticalExtension because compatibility with R10 - CA
          ...
          for (; it != auxList.end (); it++)
            {
              ...
              os << "    reportConfigEutra.triggerType  " << (int) it->reportConfigEutra.triggerType
                 << std::endl;
...
HandoverPreparationInfoHeader::PreSerialize () const
{
  ...
  SerializeSequence (std::bitset<0> (), false);
  SerializeEnum (
      6, BandwidthToEnum (m_asConfig.sourceMasterInformationBlock.dlBandwidth)); // dl-Bandwidth
