...
public:
   ...
   * Constructor
   */
  EpcS1apEnb (Ptr<Socket> localSocket, Ipv4Address enbAddress, Ipv4Address mmeAddress,
   ...
   */
  void AddS1apInterface (uint16_t enbId, Ipv4Address enbAddress, uint16_t mmeId,
...
protected:
  ...
  virtual void DoSendInitialUeMessage (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, uint64_t stmsi,
                                       uint16_t ecgi);
  ...
  virtual void
  DoSendInitialContextSetupResponse (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
...
protected:
  ...
  virtual void
  DoSendInitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
