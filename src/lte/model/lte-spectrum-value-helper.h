...
public:
   ...
   */
  static Ptr<SpectrumValue> CreateTxPowerSpectralDensity (uint32_t earfcn, uint8_t bandwidth,
                                                          double powerTx,
   ...
   * \return a pointer to a newly allocated SpectrumValue representing the TX Power Spectral Density in W/Hz for each Resource Block
   */
  static Ptr<SpectrumValue> CreateUlTxPowerSpectralDensity (uint16_t earfcn, uint8_t bandwidth,
                                                            double powerTx,
                                                            std::vector<int> activeRbs);
   ...
   */
  static Ptr<SpectrumValue> CreateNoisePowerSpectralDensity (uint32_t earfcn, uint8_t bandwidth,
                                                             double noiseFigure);
