...
static const struct FrSoftDownlinkDefaultConfiguration
{
  ...
  uint8_t dlEdgeSubBandwidth; ///< Dl edge subbandwidth
    ...
    {1, 100, 0, 32}, {2, 100, 32, 32}, {3, 100, 64, 36}}; ///< soft downlink default configuration
...
static const struct FrSoftUplinkDefaultConfiguration
{
  ...
  uint8_t ulEdgeSubBandwidth; ///< UL endge subbandwidth
    ...
    {2, 25, 8, 8},   {3, 25, 16, 9},   {1, 50, 0, 16},  {2, 50, 16, 16},
    {3, 50, 32, 18}, {1, 75, 0, 24},   {2, 75, 24, 24}, {3, 75, 48, 27},
    {1, 100, 0, 32}, {2, 100, 32, 32}, {3, 100, 64, 36}}; ///< soft uplink default configuration
  ...
  static TypeId tid =
      TypeId ("ns3::LteFrSoftAlgorithm")
          ...
          .AddAttribute (
              ...
              UintegerValue (0), MakeUintegerAccessor (&LteFrSoftAlgorithm::m_ulEdgeSubBandwidth),
              MakeUintegerChecker<uint8_t> ())
          ...
          .AddAttribute (
              ...
              UintegerValue (0), MakeUintegerAccessor (&LteFrSoftAlgorithm::m_dlEdgeSubBandwidth),
              MakeUintegerChecker<uint8_t> ())
          .AddAttribute ("AllowCenterUeUseEdgeSubBand",
                         "If true center UEs can receive on Edge SubBand RBGs", BooleanValue (true),
...
LteFrSoftAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  ...
  minContinuousUlBandwidth = ((centerBandwidth > 0) && (centerBandwidth < minContinuousUlBandwidth))
                                 ? centerBandwidth
                                 : minContinuousUlBandwidth;
