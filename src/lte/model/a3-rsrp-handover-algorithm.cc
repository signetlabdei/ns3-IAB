...
A3RsrpHandoverAlgorithm::A3RsrpHandoverAlgorithm () : m_handoverManagementSapUser (0)
{
  ...
  static TypeId tid =
      TypeId ("ns3::A3RsrpHandoverAlgorithm")
          ...
          .AddAttribute (
              ...
              DoubleValue (3.0), MakeDoubleAccessor (&A3RsrpHandoverAlgorithm::m_hysteresisDb),
              MakeDoubleChecker<uint8_t> (
                  0.0,
                  15.0)) // Hysteresis IE value range is [0..30] as per Section 6.3.5 of 3GPP TS 36.331
          .AddAttribute (
              "TimeToTrigger",
              ...
              TimeValue (MilliSeconds (
                  256)), // 3GPP time-to-trigger median value as per Section 6.3.5 of 3GPP TS 36.331
              MakeTimeAccessor (&A3RsrpHandoverAlgorithm::m_timeToTrigger), MakeTimeChecker ());
  return tid;
}
