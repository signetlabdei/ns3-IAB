...
LteUeRrcProtocolReal::LteUeRrcProtocolReal () : m_ueRrcSapProvider (0), m_enbRrcSapProvider (0)
{
...
LteEnbRrcProtocolReal::LteEnbRrcProtocolReal () : m_enbRrcSapProvider (0)
{
  NS_LOG_FUNCTION (this);
              ...
              if (ueRrc->GetCellId () == cellId)
                {
                  ...
                  Simulator::ScheduleWithContext (node->GetId (), RRC_REAL_MSG_DELAY,
