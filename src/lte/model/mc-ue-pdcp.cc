...
McUePdcpSpecificLteRlcSapUser::McUePdcpSpecificLteRlcSapUser (McUePdcp *pdcp) : m_pdcp (pdcp)
{
}
...
McUePdcp::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::McUePdcp")
          ...
          .AddTraceSource ("RxPDU", "PDU received.", MakeTraceSourceAccessor (&McUePdcp::m_rxPdu),
                           "ns3::McUePdcp::PduRxTracedCallback")
          .AddAttribute ("LteUplink", "Use LTE for uplink", BooleanValue (false),
                         MakeBooleanAccessor (&McUePdcp::m_alwaysLteUplink), MakeBooleanChecker ());
  return tid;
}
