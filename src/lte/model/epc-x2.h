...
public:
   ...
   */
  void AddX2Interface (uint16_t enb1CellId, Ipv4Address enb1X2Address, uint16_t enb2CellId,
   ...
   */
  typedef void (*ReceiveTracedCallback) (uint16_t sourceCellId, uint16_t targetCellId,
                                         uint32_t bytes, uint64_t delay, bool data);
...
protected:
   ...
   */
  virtual void
  DoSendHandoverPreparationFailure (EpcX2SapProvider::HandoverPreparationFailureParams params);
  /**
  ...
  virtual void
  DoNotifyLteMmWaveHandoverCompleted (EpcX2SapProvider::SecondaryHandoverParams params);
  ...
  virtual void
  DoSendSecondaryCellHandoverCompleted (EpcX2SapProvider::SecondaryHandoverCompletedParams params);
