...
} g_frStrictDownlinkDefaultConfiguration[] = {{1, 15, 2, 0, 4},    {2, 15, 2, 4, 4},
                                              {3, 15, 2, 8, 4},    {1, 25, 6, 0, 6},
                                              {2, 25, 6, 6, 6},    {3, 25, 6, 12, 6},
                                              {1, 50, 21, 0, 9},   {2, 50, 21, 9, 9},
                                              {3, 50, 21, 18, 11}, {1, 75, 36, 0, 12},
                                              {2, 75, 36, 12, 12}, {3, 75, 36, 24, 15},
                                              {1, 100, 28, 0, 24}, {2, 100, 28, 24, 24},
...
} g_frStrictUplinkDefaultConfiguration[] = {{1, 15, 3, 0, 4},    {2, 15, 3, 4, 4},
                                            {3, 15, 3, 8, 4},    {1, 25, 6, 0, 6},
                                            {2, 25, 6, 6, 6},    {3, 25, 6, 12, 6},
                                            {1, 50, 21, 0, 9},   {2, 50, 21, 9, 9},
                                            {3, 50, 21, 18, 11}, {1, 75, 36, 0, 12},
                                            {2, 75, 36, 12, 12}, {3, 75, 36, 24, 15},
  ...
  static TypeId tid =
      TypeId ("ns3::LteFrStrictAlgorithm")
          ...
          .AddAttribute (
              ...
              UintegerValue (0), MakeUintegerAccessor (&LteFrStrictAlgorithm::m_ulEdgeSubBandwidth),
              MakeUintegerChecker<uint8_t> ())
          .AddAttribute (
          ...
          .AddAttribute (
              ...
              UintegerValue (0), MakeUintegerAccessor (&LteFrStrictAlgorithm::m_dlEdgeSubBandwidth),
              MakeUintegerChecker<uint8_t> ())
          .AddAttribute (
              "RsrqThreshold",
...
LteFrStrictAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  ...
  uint8_t minContinuousUlBandwidth =
      m_ulCommonSubBandwidth < m_ulEdgeSubBandwidth ? m_ulCommonSubBandwidth : m_ulEdgeSubBandwidth;
