...
public:
   ...
   */
  virtual void SendData (Ptr<Packet> packet, uint32_t bid) = 0;
  ...
  virtual void NotifySecondaryCellHandover (
      uint16_t oldRnti, uint16_t newRnti, uint16_t mmWaveCellId,
...
public:
  ...
  virtual void SendData (Ptr<Packet> packet, uint32_t bid);
...
template <class C>
void
MemberLteAsSapProvider<C>::SendData (Ptr<Packet> packet, uint32_t bid)
{
...
MemberLteAsSapProvider<C>::NotifySecondaryCellHandover (
    ...
    LteRrcSap::RadioResourceConfigDedicated radioResourceConfigDedicated)
{
  m_owner->DoNotifySecondaryCellHandover (oldRnti, newRnti, mmWaveCellId,
...
MemberLteAsSapUser<C>::NotifySecondaryCellHandoverStarted (
    ...
    LteRrcSap::RadioResourceConfigDedicated radioResourceConfigDedicated)
{
  m_owner->DoNotifySecondaryCellHandoverStarted (oldRnti, newRnti, mmWaveCellId,
                                                 radioResourceConfigDedicated);
}
