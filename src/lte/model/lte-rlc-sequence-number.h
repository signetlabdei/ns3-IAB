...
{
public:
  SequenceNumber10 () : m_value (0), m_modulusBase (0)
  {
  }
   ...
   */
  explicit SequenceNumber10 (uint16_t value) : m_value (value % 1024), m_modulusBase (0)
  {
  }
  ...
  SequenceNumber10 (SequenceNumber10 const &value)
      : m_value (value.m_value), m_modulusBase (value.m_modulusBase)
  {
  }
   ...
   */
  void
  SetModulusBase (SequenceNumber10 modulusBase)
  {
   ...
   */
  void
  SetModulusBase (uint16_t modulusBase)
  {
   ...
   */
  uint16_t
  operator- (const SequenceNumber10 &other) const
  {
