...
template <class C>
EpcX2SpecificEpcX2SapProvider<C>::EpcX2SpecificEpcX2SapProvider (C *x2) : m_x2 (x2)
{
}
...
template <class C>
EpcX2PdcpSpecificProvider<C>::EpcX2PdcpSpecificProvider (C *x2) : m_x2 (x2)
{
}
...
template <class C>
EpcX2RlcSpecificProvider<C>::EpcX2RlcSpecificProvider (C *x2) : m_x2 (x2)
{
}
...
template <class C>
EpcX2PdcpSpecificUser<C>::EpcX2PdcpSpecificUser (C *pdcp) : m_pdcp (pdcp)
{
}
...
template <class C>
EpcX2RlcSpecificUser<C>::EpcX2RlcSpecificUser (C *rlc) : m_rlc (rlc)
{
}
