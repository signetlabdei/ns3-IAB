...
public:
  ...
  virtual void TransmitBapPdu (Ptr<Packet> p) = 0;
};
...
public:
  ...
  virtual void TransmitBapPdu (Ptr<Packet> p);
...
template <class C>
LteRlcSpecificLteRlcSapProvider<C>::LteRlcSpecificLteRlcSapProvider (C *rlc) : m_rlc (rlc)
{
}
...
template <class C>
void
LteRlcSpecificLteRlcSapProvider<C>::TransmitBapPdu (Ptr<Packet> p)
{
  m_rlc->DoTransmitPdcpPdu (p);
}
...
template <class C>
LteRlcSpecificLteRlcSapUser<C>::LteRlcSpecificLteRlcSapUser (C *pdcp) : m_pdcp (pdcp)
{
}
