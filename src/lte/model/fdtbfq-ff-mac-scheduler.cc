...
FdTbfqFfMacScheduler::FdTbfqFfMacScheduler ()
    : m_cschedSapUser (0), m_schedSapUser (0), m_nextRntiUl (0), bankSize (0)
{
...
FdTbfqFfMacScheduler::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::FdTbfqFfMacScheduler")
          ...
          .AddAttribute (
              "DebtLimit", "Flow debt limit (default -625000 bytes)", IntegerValue (-625000),
              MakeIntegerAccessor (&FdTbfqFfMacScheduler::m_debtLimit), MakeIntegerChecker<int> ())
          .AddAttribute ("CreditLimit", "Flow credit limit (default 625000 bytes)",
                         UintegerValue (625000),
                         MakeUintegerAccessor (&FdTbfqFfMacScheduler::m_creditLimit),
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("TokenPoolSize", "The maximum value of flow token pool (default 1 bytes)",
                         UintegerValue (1),
                         MakeUintegerAccessor (&FdTbfqFfMacScheduler::m_tokenPoolSize),
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("CreditableThreshold", "Threshold of flow credit (default 0 bytes)",
                         UintegerValue (0),
          ...
          .AddAttribute ("HarqEnabled", "Activate/Deactivate the HARQ [by default is active].",
                         BooleanValue (true), MakeBooleanAccessor (&FdTbfqFfMacScheduler::m_harqOn),
                         MakeBooleanChecker ())
