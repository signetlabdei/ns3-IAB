...
public:
  ...
  typedef enum { CONTROL_PDU = 0, DATA_PDU = 1 } DataControlPdu_t; ///< DataControlPdu_t typedef
  ...
  typedef enum { PDU = 0, SEGMENT = 1 } ResegmentationFlag_t; ///< ResegmentationFlag_t typedef
