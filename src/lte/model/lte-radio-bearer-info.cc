  ...
  static TypeId tid =
      TypeId ("ns3::LteDataRadioBearerInfo")
          ...
          .AddAttribute ("logicalChannelIdentity",
                         ...
                         MakeUintegerChecker<uint8_t> ())
          .AddAttribute ("LteRlc", "RLC instance of the radio bearer.", PointerValue (),
                         MakePointerAccessor (&LteRadioBearerInfo::m_rlc),
                         MakePointerChecker<LteRlc> ())
          .AddAttribute ("LtePdcp", "PDCP instance of the radio bearer.", PointerValue (),
                         MakePointerAccessor (&LteRadioBearerInfo::m_pdcp),
                         MakePointerChecker<LtePdcp> ())
          .AddAttribute ("InnerPdcp", "InnerPDCP instance of the radio bearer.", PointerValue (),
                         MakePointerAccessor (&LteRadioBearerInfo::m_innerPdcp),
                         MakePointerChecker<InnerPdcp> ());
  return tid;
}
...
RlcBearerInfo::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::RlcBearerInfo")
          ...
          .AddAttribute ("LteRlc", "RLC instance of the secondary connection.", PointerValue (),
