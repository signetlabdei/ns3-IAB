...
static const struct FfrEnhancedDownlinkDefaultConfiguration
{
  ...
  uint8_t dlReuse1SubBandwidth; ///< reuse 1 subbandwidth
    ...
    {1, 25, 0, 4, 4},     {2, 25, 8, 4, 4},
    {3, 25, 16, 4, 4},    {1, 50, 0, 9, 6},
    {2, 50, 15, 9, 6},    {3, 50, 30, 9, 6},
    {1, 75, 0, 8, 16},    {2, 75, 24, 8, 16},
    {3, 75, 48, 8, 16},   {1, 100, 0, 16, 16},
    {2, 100, 32, 16, 16}, {3, 100, 64, 16, 16}}; ///< the enhanced downlink default configation
...
static const struct FfrEnhancedUplinkDefaultConfiguration
{
  ...
  uint8_t ulReuse1SubBandwidth; ///< UL reuse 1 subbandwidth
    ...
    {1, 75, 0, 8, 16},    {2, 75, 24, 8, 16},
    {3, 75, 48, 8, 16},   {1, 100, 0, 16, 16},
    {2, 100, 32, 16, 16}, {3, 100, 64, 16, 16}}; ///< the enhanced uplink default configuration
...
LteFfrEnhancedAlgorithm::LteFfrEnhancedAlgorithm ()
    : m_ffrSapUser (0), m_ffrRrcSapUser (0), m_measId (0)
{
  ...
  static TypeId tid =
      TypeId ("ns3::LteFfrEnhancedAlgorithm")
          ...
          .AddAttribute (
              ...
              UintegerValue (26), MakeUintegerAccessor (&LteFfrEnhancedAlgorithm::m_rsrqThreshold),
              MakeUintegerChecker<uint8_t> ())
...
double
LteFfrEnhancedAlgorithm::EstimateUlSinr (uint16_t rnti, uint16_t rb,
