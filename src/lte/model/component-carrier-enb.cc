...
ComponentCarrierEnb::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::ComponentCarrierEnb")
          ...
          .AddAttribute ("LteEnbPhy", "The PHY associated to this EnbNetDevice", PointerValue (),
                         MakePointerAccessor (&ComponentCarrierEnb::m_phy),
                         MakePointerChecker<LteEnbPhy> ())
          .AddAttribute ("LteEnbMac", "The MAC associated to this EnbNetDevice", PointerValue (),
                         MakePointerAccessor (&ComponentCarrierEnb::m_mac),
                         MakePointerChecker<LteEnbMac> ())
          .AddAttribute ("FfMacScheduler", "The scheduler associated to this EnbNetDevice",
                         PointerValue (), MakePointerAccessor (&ComponentCarrierEnb::m_scheduler),
