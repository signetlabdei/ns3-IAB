...
LteFlowId_t::LteFlowId_t (const uint16_t a, const uint8_t b) : m_rnti (a), m_lcId (b)
{
}
...
ImsiLcidPair_t::ImsiLcidPair_t (const uint64_t a, const uint8_t b) : m_imsi (a), m_lcId (b)
{
}
