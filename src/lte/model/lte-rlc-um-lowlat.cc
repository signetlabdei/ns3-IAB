  ...
  static TypeId tid =
      TypeId ("ns3::LteRlcUmLowLat")
          ...
          .AddAttribute ("ReportBufferStatusTimer",
                         ...
                         MakeTimeAccessor (&LteRlcUmLowLat::m_rbsTimerValue), MakeTimeChecker ())
          ...
          .AddAttribute (
              "SendBsrWhenPacketTx",
              "Call DoReportBufferStatus at the end of DoNotifyTxOpportunity", BooleanValue (false),
              MakeBooleanAccessor (&LteRlcUmLowLat::m_sendBsrWhenPacketTx), MakeBooleanChecker ());
  return tid;
}
