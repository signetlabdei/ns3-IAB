...
EpcS1apEnb::EpcS1apEnb (Ptr<Socket> localSocket, Ipv4Address enbAddress, Ipv4Address mmeAddress,
                        uint16_t cellId, uint16_t mmeId)
...
void
EpcS1apEnb::AddS1apInterface (uint16_t enbId, Ipv4Address enbAddress, uint16_t mmeId,
                              Ipv4Address mmeAddress, Ptr<Socket> localS1apSocket)
{
...
//
void
EpcS1apEnb::DoSendInitialUeMessage (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, uint64_t stmsi,
                                    uint16_t ecgi)
{
  NS_LOG_FUNCTION (this);
...
void
EpcS1apEnb::DoSendInitialContextSetupResponse (uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
...
EpcS1apMme::DoSendInitialContextSetupRequest (
    uint64_t mmeUeS1Id, uint16_t enbUeS1Id,
    std::list<EpcS1apSap::ErabToBeSetupItem> erabToBeSetupList, uint16_t cellId)
{
  NS_LOG_FUNCTION (this);
