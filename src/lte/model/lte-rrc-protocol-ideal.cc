...
LteUeRrcProtocolIdeal::LteUeRrcProtocolIdeal () : m_ueRrcSapProvider (0), m_enbRrcSapProvider (0)
{
...
LteEnbRrcProtocolIdeal::LteEnbRrcProtocolIdeal () : m_enbRrcSapProvider (0)
{
  NS_LOG_FUNCTION (this);
...
void
LteEnbRrcProtocolIdeal::DoSendRrcConnectionReject (uint16_t rnti,
...
void
LteEnbRrcProtocolIdeal::DoSendRrcConnectionSwitch (uint16_t rnti,
