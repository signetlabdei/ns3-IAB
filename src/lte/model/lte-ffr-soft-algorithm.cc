...
} g_ffrSoftDownlinkDefaultConfiguration[] = {{1, 15, 2, 0, 4},    {2, 15, 2, 4, 4},
...
} g_ffrSoftUplinkDefaultConfiguration[] = {{1, 15, 3, 0, 4},    {2, 15, 3, 4, 4},
  ...
  static TypeId tid =
      TypeId ("ns3::LteFfrSoftAlgorithm")
          ...
          .AddAttribute (
              ...
              UintegerValue (6), MakeUintegerAccessor (&LteFfrSoftAlgorithm::m_ulEdgeSubBandwidth),
              MakeUintegerChecker<uint8_t> ())
          ...
          .AddAttribute (
              ...
              UintegerValue (0), MakeUintegerAccessor (&LteFfrSoftAlgorithm::m_dlEdgeSubBandwidth),
              MakeUintegerChecker<uint8_t> ())
          .AddAttribute (
              "CenterRsrqThreshold",
