...
PhyStatsCalculator::PhyStatsCalculator ()
    : m_RsrpSinrFirstWrite (true), m_UeSinrFirstWrite (true), m_InterferenceFirstWrite (true)
{
  ...
  static TypeId tid =
      TypeId ("ns3::PhyStatsCalculator")
          ...
          .AddAttribute (
              ...
              MakeStringAccessor (&PhyStatsCalculator::SetUeSinrFilename), MakeStringChecker ())
...
PhyStatsCalculator::ReportCurrentCellRsrpSinrCallback (Ptr<PhyStatsCalculator> phyStats,
                                                       ...
                                                       uint16_t rnti, double rsrp, double sinr,
                                                       uint8_t componentCarrierId)
{
