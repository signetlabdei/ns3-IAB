  ...
  static TypeId tid =
      TypeId ("ns3::PointToPointEpcHelper")
          ...
          .AddAttribute ("S1uLinkPcapPrefix", "Prefix for Pcap generated by S1-U link",
                         ...
                         MakeStringChecker ())
          .AddAttribute (
              "X2LinkPcapPrefix", "Prefix for Pcap generated by X2 link", StringValue ("x2"),
              MakeStringAccessor (&PointToPointEpcHelper::m_x2LinkPcapPrefix), MakeStringChecker ())
          .AddAttribute ("X2LinkEnablePcap", "Enable Pcap for X2 link", BooleanValue (false),
...
void
PointToPointEpcHelper::AddDu (Ptr<Node> enb, Ptr<NetDevice> lteEnbNetDevice, uint16_t cellId,
                              bool isIab)
{
...
uint32_t
PointToPointEpcHelper::ActivateEpsBearer (Ptr<NetDevice> ueDevice, uint64_t imsi, Ptr<EpcTft> tft,
                                          EpsBearer bearer)
{
...
uint32_t
PointToPointEpcHelper::ActivateEpsBearer (Ptr<NetDevice> ueDevice, Ptr<EpcUeNas> ueNas,
