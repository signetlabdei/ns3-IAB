...
public:
   ...
   */
  static std::string BuildNameString (double orientationDegrees, double beamwidthDegrees, double x,
                                      double y);
  /**
   * Constructor
   *
   ...
   */
  LteEnbAntennaTestCase (double orientationDegrees, double beamwidthDegrees, double x, double y,
...
std::string
LteEnbAntennaTestCase::BuildNameString (double orientationDegrees, double beamwidthDegrees,
                                        double x, double y)
{
...
LteEnbAntennaTestCase::LteEnbAntennaTestCase (double orientationDegrees, double beamwidthDegrees,
  ...
  if (expectedSinrDl > 0)
    {
      ...
      NS_LOG_INFO ("expected " << m_antennaGainDb << " actual " << calculatedAntennaGainDbDl
                               << " tol " << tolerance);
      NS_TEST_ASSERT_MSG_EQ_TOL (calculatedAntennaGainDbDl, m_antennaGainDb, tolerance,
  ...
  if (expectedSinrUl > 0)
    {
      ...
      NS_TEST_ASSERT_MSG_EQ_TOL (calculatedAntennaGainDbUl, m_antennaGainDb, tolerance,
...
LteAntennaTestSuite::LteAntennaTestSuite () : TestSuite ("lte-antenna", TestSuite::Type::SYSTEM)
{
  NS_LOG_FUNCTION (this);
  ...
  AddTestCase (new LteEnbAntennaTestCase (0.0, 90.0, 1.0, -1.0, -3.0), TestCase::Duration::QUICK);
  AddTestCase (new LteEnbAntennaTestCase (0.0, 90.0, -1.0, -1.0, -36.396), TestCase::Duration::QUICK);
  AddTestCase (new LteEnbAntennaTestCase (0.0, 90.0, -1.0, -0.0, -1414.6), TestCase::Duration::QUICK);
  AddTestCase (new LteEnbAntennaTestCase (0.0, 90.0, -1.0, 1.0, -36.396), TestCase::Duration::QUICK);
  ...
  AddTestCase (new LteEnbAntennaTestCase (0.0, 120.0, 0.5, sin (M_PI / 3), -3.0), TestCase::Duration::QUICK);
  AddTestCase (new LteEnbAntennaTestCase (0.0, 120.0, 0.5, -sin (M_PI / 3), -3.0), TestCase::Duration::QUICK);
  AddTestCase (new LteEnbAntennaTestCase (0.0, 120.0, -1.0, -2.0, -13.410), TestCase::Duration::QUICK);
  AddTestCase (new LteEnbAntennaTestCase (0.0, 120.0, -1.0, 1.0, -20.034), TestCase::Duration::QUICK);
  AddTestCase (new LteEnbAntennaTestCase (60.0, 120.0, 0.5, sin (M_PI / 3), 0.0), TestCase::Duration::QUICK);
  ...
  AddTestCase (new LteEnbAntennaTestCase (-120.0, 120.0, -1, 2, -15.578), TestCase::Duration::QUICK);
  ...
  AddTestCase (new LteEnbAntennaTestCase (-120.0, 120.0, 1, -0.1, -12.754), TestCase::Duration::QUICK);
}
