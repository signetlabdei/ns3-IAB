...
LteUplinkPowerControlTestSuite::LteUplinkPowerControlTestSuite ()
    : TestSuite ("lte-uplink-power-control", TestSuite::Type::SYSTEM)
{
  ...
  AddTestCase (new LteUplinkOpenLoopPowerControlTestCase ("OpenLoopTest1"), TestCase::Duration::QUICK);
  AddTestCase (
      new LteUplinkClosedLoopPowerControlAbsoluteModeTestCase ("ClosedLoopAbsoluteModeTest1"),
      TestCase::Duration::QUICK);
  AddTestCase (
      new LteUplinkClosedLoopPowerControlAccumulatedModeTestCase ("ClosedLoopAccumulatedModeTest1"),
      TestCase::Duration::QUICK);
}
 ...
 */
void
PuschTxPowerNofitication (LteUplinkPowerControlTestCase *testcase, uint16_t cellId, uint16_t rnti,
                          double txPower)
{
...
void
PucchTxPowerNofitication (LteUplinkPowerControlTestCase *testcase, uint16_t cellId, uint16_t rnti,
                          double txPower)
{
...
void
SrsTxPowerNofitication (LteUplinkPowerControlTestCase *testcase, uint16_t cellId, uint16_t rnti,
                        double txPower)
{
  testcase->SrsTxPowerTrace (cellId, rnti, txPower);
}

LteUplinkPowerControlTestCase::LteUplinkPowerControlTestCase (std::string name) : TestCase (name)
{
...
void
LteUplinkPowerControlTestCase::TeleportUe (uint32_t x, uint32_t y, double expectedPuschTxPower,
 ...
 */
  ...
  Simulator::Schedule (MilliSeconds (0), &LteUplinkPowerControlTestCase::TeleportUe, this, 0, 0,
                       -40, -40, -40);
  Simulator::Schedule (MilliSeconds (200), &LteUplinkPowerControlTestCase::TeleportUe, this, 200, 0,
                       8.9745, 8.9745, 11.9745);
  Simulator::Schedule (MilliSeconds (300), &LteUplinkPowerControlTestCase::TeleportUe, this, 400, 0,
                       14.9951, 14.9951, 17.9951);
  Simulator::Schedule (MilliSeconds (400), &LteUplinkPowerControlTestCase::TeleportUe, this, 600, 0,
                       18.5169, 18.5169, 21.5169);
  Simulator::Schedule (MilliSeconds (500), &LteUplinkPowerControlTestCase::TeleportUe, this, 800, 0,
                       21.0157, 21.0157, 23);
  Simulator::Schedule (MilliSeconds (600), &LteUplinkPowerControlTestCase::TeleportUe, this, 1000,
                       0, 22.9539, 22.9539, 23);
  Simulator::Schedule (MilliSeconds (700), &LteUplinkPowerControlTestCase::TeleportUe, this, 1200,
                       0, 23, 10, 23);
  Simulator::Schedule (MilliSeconds (800), &LteUplinkPowerControlTestCase::TeleportUe, this, 400, 0,
                       14.9951, 14.9951, 17.9951);
  Simulator::Schedule (MilliSeconds (900), &LteUplinkPowerControlTestCase::TeleportUe, this, 800, 0,
                       21.0157, 21.0157, 23);
  Simulator::Schedule (MilliSeconds (1000), &LteUplinkPowerControlTestCase::TeleportUe, this, 0, 0,
                       -40, -40, -40);
  Simulator::Schedule (MilliSeconds (1100), &LteUplinkPowerControlTestCase::TeleportUe, this, 100,
                       0, 2.9539, 2.9539, 5.9539);
 ...
 */
  ...
  //Changing TPC value
  Simulator::Schedule (MilliSeconds (0), &LteUplinkPowerControlTestCase::SetTpcConfiguration, this,
                       1, 0, 1.9539, 1.9539, 4.9539);
  Simulator::Schedule (MilliSeconds (100), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 0, 0, -1.0461, -1.0461, 1.9539);
  Simulator::Schedule (MilliSeconds (200), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 2, 0, 3.9539, 3.9539, 6.9539);
  Simulator::Schedule (MilliSeconds (300), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 3, 0, 6.9539, 6.9539, 9.9539);
  Simulator::Schedule (MilliSeconds (400), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 0, 0, -1.0461, -1.0461, 1.9539);
  Simulator::Schedule (MilliSeconds (500), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 1, 0, 1.9539, 1.9539, 4.9539);
  Simulator::Schedule (MilliSeconds (600), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 3, 0, 6.9539, 6.9539, 9.9539);
  Simulator::Schedule (MilliSeconds (800), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 2, 0, 3.9539, 3.9539, 6.9539);
 ...
 */
  ...
  Simulator::Schedule (MilliSeconds (100), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 0, 20, -37.0461, -37.0461, -34.0461);
  Simulator::Schedule (MilliSeconds (200), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 0, 20, -40, 10, -37.0461);
  Simulator::Schedule (MilliSeconds (300), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 2, 1, -39.0461, -39.0461, -36.0461);
  Simulator::Schedule (MilliSeconds (400), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 3, 10, -9.0461, -9.0461, -6.0461);
  Simulator::Schedule (MilliSeconds (500), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 2, 15, 5.9539, 5.9539, 8.9539);
  Simulator::Schedule (MilliSeconds (600), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 3, 1, 8.9539, 8.9539, 11.9539);
  Simulator::Schedule (MilliSeconds (700), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 2, 10, 18.9539, 18.9539, 21.9539);
  Simulator::Schedule (MilliSeconds (800), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 2, 20, 23, 23, 23);
  Simulator::Schedule (MilliSeconds (900), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 0, 1, 22.9539, 22.9539, 23);
  Simulator::Schedule (MilliSeconds (1000), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 0, 20, 2.9539, 2.9539, 5.9539);
  Simulator::Schedule (MilliSeconds (1100), &LteUplinkPowerControlTestCase::SetTpcConfiguration,
                       this, 2, 5, 7.9539, 7.9539, 10.9539);
  Simulator::Stop (Seconds (1.200));
  Simulator::Run ();
