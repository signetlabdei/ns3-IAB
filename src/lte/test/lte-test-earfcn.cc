...
LteEarfcnTestSuite::LteEarfcnTestSuite () : TestSuite ("lte-earfcn", TestSuite::Type::UNIT)
{
  ...
  AddTestCase (new LteEarfcnDlTestCase ("DL EARFCN=1301", 1301, 1815.1e6), TestCase::Duration::QUICK);
  ...
  AddTestCase (new LteEarfcnUlTestCase ("UL EARFCN=18100", 18100, 1930e6), TestCase::Duration::QUICK);
  AddTestCase (new LteEarfcnUlTestCase ("UL EARFCN=19000", 19000, 1890e6), TestCase::Duration::QUICK);
  AddTestCase (new LteEarfcnUlTestCase ("UL EARFCN=19400", 19400, 1730e6), TestCase::Duration::QUICK);
