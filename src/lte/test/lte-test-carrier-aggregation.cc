...
void
LteTestDlSchedulingCallback (CarrierAggregationTestCase *testcase, std::string path,
...
LteTestUlSchedulingCallback (CarrierAggregationTestCase *testcase, std::string path,
                             uint32_t frameNo, uint32_t subframeNo, uint16_t rnti, uint8_t mcs,
                             uint16_t sizeTb, uint8_t ccId)
{
  testcase->UlScheduling (frameNo, subframeNo, rnti, mcs, sizeTb, ccId);
}

TestCarrierAggregationSuite::TestCarrierAggregationSuite ()
    : TestSuite ("lte-carrier-aggregation", TestSuite::Type::SYSTEM)
{
  NS_LOG_INFO ("creating CarrierAggregationTestCase");

  if (CarrierAggregationTestCase::s_writeResults) // write result vectors to file
    {
      std::cout << "\n Running TestCarrierAggregationSuite with activated option to write results "
                   "to files."
                   "Dl results will be written to "
                << dlResultsFileName << " and uplink results to " << ulResultsFileName << std::endl;
      ...
      if (fopen (ulResultsFileName.c_str (), "r"))
        {
          std::cout << "\nResults file " << ulResultsFileName
                    << " already exists. Move it out of the way or specify another uplink results "
                       "file name."
                    << std::endl;
          abort = true;
        }
  ...
  else
    {
      ...
      AddTestCase (new CarrierAggregationTestCase (12, 0, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 0, 25, 25, 2), TestCase::Duration::EXTENSIVE);

      AddTestCase (new CarrierAggregationTestCase (1, 4800, 25, 25, 2), TestCase::Duration::QUICK);
      AddTestCase (new CarrierAggregationTestCase (3, 4800, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 4800, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 4800, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 4800, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 4800, 25, 25, 2), TestCase::Duration::EXTENSIVE);

      AddTestCase (new CarrierAggregationTestCase (1, 6000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (3, 6000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 6000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 6000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 6000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 6000, 25, 25, 2), TestCase::Duration::EXTENSIVE);

      AddTestCase (new CarrierAggregationTestCase (1, 20000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (3, 20000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 20000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 20000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 20000, 25, 25, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 20000, 25, 25, 2), TestCase::Duration::QUICK);
      ...
      AddTestCase (new CarrierAggregationTestCase (12, 0, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 0, 25, 25, 3), TestCase::Duration::EXTENSIVE);

      AddTestCase (new CarrierAggregationTestCase (1, 4800, 25, 25, 3), TestCase::Duration::QUICK);
      AddTestCase (new CarrierAggregationTestCase (3, 4800, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 4800, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 4800, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 4800, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 4800, 25, 25, 3), TestCase::Duration::EXTENSIVE);

      AddTestCase (new CarrierAggregationTestCase (1, 6000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (3, 6000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 6000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 6000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 6000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 6000, 25, 25, 3), TestCase::Duration::EXTENSIVE);

      AddTestCase (new CarrierAggregationTestCase (1, 20000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (3, 20000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 20000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 20000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 20000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 20000, 25, 25, 3), TestCase::Duration::EXTENSIVE);
      ...
      AddTestCase (new CarrierAggregationTestCase (3, 4800, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 4800, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 4800, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 4800, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 4800, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (1, 6000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (3, 6000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 6000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 6000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 6000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 6000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (1, 20000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (3, 20000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 20000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 20000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 20000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 20000, 6, 6, 3), TestCase::Duration::EXTENSIVE);
      ...
      AddTestCase (new CarrierAggregationTestCase (1, 4800, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (3, 4800, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 4800, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 4800, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 4800, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 4800, 6, 6, 2), TestCase::Duration::EXTENSIVE);

      AddTestCase (new CarrierAggregationTestCase (1, 6000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (3, 6000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 6000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 6000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 6000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 6000, 6, 6, 2), TestCase::Duration::QUICK);

      AddTestCase (new CarrierAggregationTestCase (1, 20000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (3, 20000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (6, 20000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (9, 20000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (12, 20000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
      AddTestCase (new CarrierAggregationTestCase (15, 20000, 6, 6, 2), TestCase::Duration::EXTENSIVE);
    }
}
...
std::string
CarrierAggregationTestCase::BuildNameString (uint16_t nUser, uint16_t dist, uint32_t dlBandwidth,
                                             uint32_t ulBandwidth,
                                             uint32_t numberOfComponentCarriers)
{
  std::ostringstream oss;
  oss << nUser << " UEs, distance " << dist << " m"
      << " dlBandwidth " << dlBandwidth << " ulBandwidth " << ulBandwidth << " number of carriers "
      << numberOfComponentCarriers;
  return oss.str ();
}

CarrierAggregationTestCase::CarrierAggregationTestCase (uint16_t nUser, uint16_t dist,
...
CarrierAggregationTestCase::DoRun (void)
{
  ...
  for (std::map<uint8_t, uint32_t>::iterator itDownlink = m_ccDownlinkTraffic.begin ();
       itDownlink != m_ccDownlinkTraffic.end (); itDownlink++)
    {
  ...
  for (std::map<uint8_t, uint32_t>::iterator itUplink = m_ccUplinkTraffic.begin ();
       itUplink != m_ccUplinkTraffic.end (); itUplink++)
    {
  ...
  NS_TEST_ASSERT_MSG_EQ (m_ccUplinkTraffic.size (), m_numberOfComponentCarriers,
                         "Number of carriers in uplink does not correspond to number of carriers "
                         "being configured in test.");
  NS_TEST_ASSERT_MSG_EQ (m_ccDownlinkTraffic.size (), m_numberOfComponentCarriers,
                         "Number of carriers in downlink does not correspond to number of carriers "
                         "being configured in test.");

  NS_TEST_ASSERT_MSG_EQ (testDownlinkShare, true,
  ...
  if (Simulator::Now () > MilliSeconds (300))
    {
      if (m_ccDownlinkTraffic.find (dlInfo.componentCarrierId) == m_ccDownlinkTraffic.end ())
        {
          m_ccDownlinkTraffic.insert (std::pair<uint8_t, uint32_t> (
              dlInfo.componentCarrierId, dlInfo.sizeTb1 + dlInfo.sizeTb2));
        }
      else
        {
