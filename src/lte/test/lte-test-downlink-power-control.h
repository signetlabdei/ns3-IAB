 ...
 */
  LteDownlinkPowerControlSpectrumValueTestCase (std::string name, uint16_t earfcn, uint8_t bw,
...
public:
   ...
   * \param rnti the RNTI
   */
  void ConnectionReconfigurationEnb (std::string context, uint64_t imsi, uint16_t cellid,
                                     uint16_t rnti);
   ...
   * \param rnti the RNTI
   */
  void ConnectionReconfigurationUe (std::string context, uint64_t imsi, uint16_t cellid,
                                    uint16_t rnti);
