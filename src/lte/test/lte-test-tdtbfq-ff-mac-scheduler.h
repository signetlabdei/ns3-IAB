...
public:
   ...
   */
  LenaTdTbfqFfMacSchedulerTestCase1 (uint16_t nUser, double dist, double thrRefDl, double thrRefUl,
...
public:
   ...
   * \param errorModelEnabled if true the error model is enabled
   */
  LenaTdTbfqFfMacSchedulerTestCase2 (std::vector<double> dist, std::vector<uint32_t> estThrTdTbfqDl,
