...
public:
   ...
   */
  void TeleportUe (uint32_t x, uint32_t y, double expectedPuschTxPower, double expectedPucchTxPower,
   ...
   * \param expectedSrsTxPower the expected SRS transmit power
   */
  void SetTpcConfiguration (uint32_t tpc, uint32_t tpcNum, double expectedPuschTxPower,
