...
EpsGtpuTestSuite::EpsGtpuTestSuite () : TestSuite ("epc-gtpu", TestSuite::Type::SYSTEM)
{
...
EpsGtpuHeaderTestCase::EpsGtpuHeaderTestCase () : TestCase ("Check header coding and decoding")
{
