...
void
LteTestUlSchedulingCallback (LteCqiGenerationTestCase *testcase, std::string path, uint32_t frameNo,
...
LteCqiGenerationTestSuite::LteCqiGenerationTestSuite () : TestSuite ("lte-cqi-generation", TestSuite::Type::SYSTEM)
{
  ...
  AddTestCase (new LteCqiGenerationDlPowerControlTestCase (
                   "CqiGenerationWithDlPowerControl", LteRrcSap::PdschConfigDedicated::dB0,
                   LteRrcSap::PdschConfigDedicated::dB0, 4, 2),
               TestCase::Duration::QUICK);
  AddTestCase (new LteCqiGenerationDlPowerControlTestCase (
                   "CqiGenerationWithDlPowerControl", LteRrcSap::PdschConfigDedicated::dB0,
                   LteRrcSap::PdschConfigDedicated::dB_3, 8, 2),
               TestCase::Duration::QUICK);
  AddTestCase (new LteCqiGenerationDlPowerControlTestCase (
                   "CqiGenerationWithDlPowerControl", LteRrcSap::PdschConfigDedicated::dB0,
                   LteRrcSap::PdschConfigDedicated::dB_6, 10, 2),
               TestCase::Duration::QUICK);
  AddTestCase (new LteCqiGenerationDlPowerControlTestCase (
                   "CqiGenerationWithDlPowerControl", LteRrcSap::PdschConfigDedicated::dB1,
                   LteRrcSap::PdschConfigDedicated::dB_6, 12, 2),
               TestCase::Duration::QUICK);
  AddTestCase (new LteCqiGenerationDlPowerControlTestCase (
                   "CqiGenerationWithDlPowerControl", LteRrcSap::PdschConfigDedicated::dB2,
                   LteRrcSap::PdschConfigDedicated::dB_6, 14, 2),
               TestCase::Duration::QUICK);
  AddTestCase (new LteCqiGenerationDlPowerControlTestCase (
                   "CqiGenerationWithDlPowerControl", LteRrcSap::PdschConfigDedicated::dB3,
                   LteRrcSap::PdschConfigDedicated::dB_6, 14, 2),
               TestCase::Duration::QUICK);
  AddTestCase (new LteCqiGenerationDlPowerControlTestCase (
                   "CqiGenerationWithDlPowerControl", LteRrcSap::PdschConfigDedicated::dB3,
                   LteRrcSap::PdschConfigDedicated::dB0, 8, 2),
               TestCase::Duration::QUICK);
}
...
LteCqiGenerationTestCase::LteCqiGenerationTestCase (std::string name, bool usePdcchForCqiGeneration,
    ...
    : TestCase ("Downlink Power Control: " + name), m_dlMcs (dlMcs), m_ulMcs (ulMcs)
{
...
LteCqiGenerationDlPowerControlTestCase::LteCqiGenerationDlPowerControlTestCase (
    std::string name, uint8_t cell0Pa, uint8_t cell1Pa, uint16_t dlMcs, uint16_t ulMcs)
...
void
LteCqiGenerationDlPowerControlTestCase::UlScheduling (uint32_t frameNo, uint32_t subframeNo,
