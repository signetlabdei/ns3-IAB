...
public:
   ...
   *                              all eNodeBs
   */
  LteHandoverTargetTestCase (std::string name, Vector uePosition, uint8_t gridSizeX,
                             uint8_t gridSizeY, uint16_t sourceCellId, uint16_t targetCellId,
   ...
   */
  void HandoverStartCallback (std::string context, uint64_t imsi, uint16_t sourceCellId,
...
LteHandoverTargetTestCase::DoRun ()
{
  ...
  enbMobility.SetPositionAllocator ("ns3::GridPositionAllocator", "MinX", DoubleValue (0.0), "MinY",
                                    ...
                                    DoubleValue (130.0), "GridWidth", UintegerValue (m_gridSizeX),
