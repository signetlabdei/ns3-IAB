...
LteFrequencyReuseTestSuite::LteFrequencyReuseTestSuite ()
    : TestSuite ("lte-frequency-reuse", TestSuite::Type::SYSTEM)
{
  ...
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrPf1", 1, "ns3::PfFfMacScheduler", 25, 25, 0,
                                      12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrPf2", 5, "ns3::PfFfMacScheduler", 25, 25, 0,
                                      12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrPss1", 1, "ns3::PssFfMacScheduler", 25, 25, 0,
                                      12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrPss2", 5, "ns3::PssFfMacScheduler", 25, 25, 0,
                                      12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrCqa1", 1, "ns3::CqaFfMacScheduler", 25, 25, 0,
                                      12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrCqa2", 5, "ns3::CqaFfMacScheduler", 25, 25, 0,
                                      12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrFdTbfq1", 1, "ns3::FdTbfqFfMacScheduler", 25,
                                      25, 0, 12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrFdTbfq2", 5, "ns3::FdTbfqFfMacScheduler", 25,
                                      25, 0, 12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrTdTbfq1", 1, "ns3::TdTbfqFfMacScheduler", 25,
                                      25, 0, 12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteHardFrTestCase ("DownlinkHardFrTdTbfq2", 5, "ns3::TdTbfqFfMacScheduler", 25,
                                      25, 0, 12, 0, 12, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  ...
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrPf1", 1, "ns3::PfFfMacScheduler", 25, 25,
                                        6, 6, 6, 6, 6, 6, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrPf2", 5, "ns3::PfFfMacScheduler", 25, 25,
                                        6, 6, 6, 6, 6, 6, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrPss1", 1, "ns3::PssFfMacScheduler", 25, 25,
                                        6, 6, 6, 6, 6, 6, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrPss2", 5, "ns3::PssFfMacScheduler", 25, 25,
                                        6, 6, 6, 6, 6, 6, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrCqa1", 1, "ns3::CqaFfMacScheduler", 25, 25,
                                        6, 6, 6, 6, 6, 6, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrCqa2", 5, "ns3::CqaFfMacScheduler", 25, 25,
                                        6, 6, 6, 6, 6, 6, availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrCqaFdTbfq1", 1,
                                        "ns3::FdTbfqFfMacScheduler", 25, 25, 6, 6, 6, 6, 6, 6,
                                        availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrCqaFdTbfq2", 5,
                                        "ns3::FdTbfqFfMacScheduler", 25, 25, 6, 6, 6, 6, 6, 6,
                                        availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrCqaTdTbfq1", 1,
                                        "ns3::TdTbfqFfMacScheduler", 25, 25, 6, 6, 6, 6, 6, 6,
                                        availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
  AddTestCase (new LteStrictFrTestCase ("DownlinkStrictFrCqaTdTbfq2", 5,
                                        "ns3::TdTbfqFfMacScheduler", 25, 25, 6, 6, 6, 6, 6, 6,
                                        availableDlRb, availableUlRb),
               TestCase::Duration::QUICK);
...
LteFrTestCase::LteFrTestCase (std::string name, uint32_t userNum, uint8_t dlBandwidth,
                              uint8_t ulBandwidth, std::vector<bool> availableDlRb,
                              std::vector<bool> availableUlRb)
    : TestCase ("Test: " + name),
      m_userNum (userNum),
...
LteHardFrTestCase::LteHardFrTestCase (std::string name, uint32_t userNum, std::string schedulerType,
...
LteHardFrTestCase::DoRun (void)
{
  ...
  testUlSpectrumPhy->TraceConnectWithoutContext (
      "RxStart", MakeBoundCallback (&UlDataRxStartNofitication, this));
...
LteStrictFrTestCase::LteStrictFrTestCase (
    std::string name, uint32_t userNum, std::string schedulerType, uint8_t dlBandwidth,
    uint8_t ulBandwidth, uint8_t dlCommonSubBandwidth, uint8_t dlEdgeSubBandOffset,
    uint8_t dlEdgeSubBandwidth, uint8_t ulCommonSubBandwidth, uint8_t ulEdgeSubBandOffset,
    uint8_t ulEdgeSubBandwidth, std::vector<bool> availableDlRb, std::vector<bool> availableUlRb)
    : LteFrTestCase (name, userNum, dlBandwidth, ulBandwidth, availableDlRb, availableUlRb),
      m_schedulerType (schedulerType),
...
LteFrAreaTestCase::LteFrAreaTestCase (std::string name, std::string schedulerType)
    : TestCase ("Test: " + name), m_schedulerType (schedulerType)
{
  m_dlBandwidth = 25;
  m_ulBandwidth = 25;
...
LteStrictFrAreaTestCase::DoRun (void)
{
  ...
  testUlSpectrumPhy->TraceConnectWithoutContext (
      "RxStart", MakeBoundCallback (&UlDataRxStartNofiticationArea, this));
  ...
  Simulator::Schedule (MilliSeconds (1), &LteFrAreaTestCase::TeleportUe, this, 200, 0, 1,
                       expectedDlRbCenterArea);
  Simulator::Schedule (MilliSeconds (1), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.0150543,
                       expectedUlRbCenterArea);

  Simulator::Schedule (MilliSeconds (501), &LteFrAreaTestCase::TeleportUe, this, 800, 0, 2,
                       expectedDlRbEdgeArea);
  Simulator::Schedule (MilliSeconds (501), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.199526,
                       expectedUlRbEdgeArea);

  Simulator::Schedule (MilliSeconds (1001), &LteFrAreaTestCase::TeleportUe, this, 200, 0, 1,
                       expectedDlRbCenterArea);
  Simulator::Schedule (MilliSeconds (1001), &LteFrAreaTestCase::SetUlExpectedValues, this,
...
LteSoftFfrAreaTestCase::DoRun (void)
{
  ...
  Simulator::Schedule (MilliSeconds (1), &LteFrAreaTestCase::TeleportUe, this, 200, 0,
                       expectedDlPowerCenterArea, expectedDlRbCenterArea);
  Simulator::Schedule (MilliSeconds (1), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.0150543,
                       expectedUlRbCenterArea);

  Simulator::Schedule (MilliSeconds (501), &LteFrAreaTestCase::TeleportUe, this, 600, 0,
                       expectedDlPowerMiddleArea, expectedDlRbMiddleArea);
  Simulator::Schedule (MilliSeconds (501), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.135489,
                       expectedUlRbMiddleArea);

  Simulator::Schedule (MilliSeconds (1001), &LteFrAreaTestCase::TeleportUe, this, 800, 0,
                       expectedDlPowerEdgeArea, expectedDlRbEdgeArea);
  Simulator::Schedule (MilliSeconds (1001), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.199526,
                       expectedUlRbEdgeArea);

  Simulator::Schedule (MilliSeconds (1501), &LteFrAreaTestCase::TeleportUe, this, 600, 0,
                       expectedDlPowerMiddleArea, expectedDlRbMiddleArea);
  Simulator::Schedule (MilliSeconds (1501), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.135489,
                       expectedUlRbMiddleArea);

  Simulator::Schedule (MilliSeconds (2001), &LteFrAreaTestCase::TeleportUe, this, 200, 0,
                       expectedDlPowerCenterArea, expectedDlRbCenterArea);
  Simulator::Schedule (MilliSeconds (2001), &LteFrAreaTestCase::SetUlExpectedValues, this,
                       0.0150543, expectedUlRbCenterArea);
...
LteEnhancedFfrAreaTestCase::DoRun (void)
{
  ...
  Simulator::Schedule (MilliSeconds (1), &LteEnhancedFfrAreaTestCase::TeleportUe, this, 100, 0,
                       expectedDlPowerCenterArea, expectedDlRbCenterArea);
  Simulator::Schedule (MilliSeconds (1), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.00250905,
                       expectedUlRbCenterArea);

  Simulator::Schedule (MilliSeconds (501), &LteEnhancedFfrAreaTestCase::TeleportUe, this, 300, 0,
                       expectedDlPowerMiddleArea, expectedDlRbMiddleArea);
  Simulator::Schedule (MilliSeconds (501), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.0225815,
                       expectedUlRbMiddleArea);

  Simulator::Schedule (MilliSeconds (1001), &LteEnhancedFfrAreaTestCase::TeleportUe, this, 600, 0,
                       expectedDlPowerEdgeArea, expectedDlRbEdgeArea);
  Simulator::Schedule (MilliSeconds (1001), &LteFrAreaTestCase::SetUlExpectedValues, this,
                       0.0903259, expectedUlRbEdgeArea);

  Simulator::Schedule (MilliSeconds (1501), &LteEnhancedFfrAreaTestCase::TeleportUe, this, 100, 0,
                       expectedDlPowerCenterArea, expectedDlRbCenterArea);
  Simulator::Schedule (MilliSeconds (1501), &LteFrAreaTestCase::SetUlExpectedValues, this,
                       0.00250905, expectedUlRbCenterArea);

  Simulator::Schedule (MilliSeconds (2001), &LteEnhancedFfrAreaTestCase::TeleportUe, this, 300, 0,
                       expectedDlPowerMiddleArea, expectedDlRbMiddleArea);
  Simulator::Schedule (MilliSeconds (2001), &LteFrAreaTestCase::SetUlExpectedValues, this,
...
LteDistributedFfrAreaTestCase::DoRun (void)
{
  ...
  Simulator::Schedule (MilliSeconds (1), &LteFrAreaTestCase::TeleportUe, this, 800, 0,
                       expectedDlPowerCenterArea, expectedDlRbCenterArea);
  Simulator::Schedule (MilliSeconds (1), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.0225815,
                       expectedUlRbCenterArea);

  Simulator::Schedule (MilliSeconds (501), &LteFrAreaTestCase::TeleportUe, this, 400, 0,
                       expectedDlPowerEdgeArea, expectedDlRbEdgeArea);
  Simulator::Schedule (MilliSeconds (501), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.135489,
                       expectedUlRbEdgeArea);

  Simulator::Schedule (MilliSeconds (1001), &LteFrAreaTestCase::TeleportUe2, this, ueNodes1.Get (0),
                       600, 0, expectedDlPowerEdgeArea, expectedDlRbEdgeArea2);
  Simulator::Schedule (MilliSeconds (1001), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.135489,
                       expectedUlRbEdgeArea2);

  Simulator::Schedule (MilliSeconds (1501), &LteFrAreaTestCase::TeleportUe2, this, ueNodes1.Get (0),
                       200, 0, expectedDlPowerEdgeArea, expectedDlRbEdgeArea);
  Simulator::Schedule (MilliSeconds (1501), &LteFrAreaTestCase::SetUlExpectedValues, this, 0.135489,
                       expectedUlRbEdgeArea);

  Simulator::Schedule (MilliSeconds (2001), &LteFrAreaTestCase::TeleportUe, this, 800, 0,
                       expectedDlPowerCenterArea, expectedDlRbCenterArea);
  Simulator::Schedule (MilliSeconds (2001), &LteFrAreaTestCase::SetUlExpectedValues, this,
                       0.0225815, expectedUlRbCenterArea);
