...
LteRlcUmTransmitterTestSuite::LteRlcUmTransmitterTestSuite ()
    : TestSuite ("lte-rlc-um-transmitter", TestSuite::Type::SYSTEM)
{
  ...
  AddTestCase (new LteRlcUmTransmitterOneSduTestCase ("One SDU, one PDU"), TestCase::Duration::QUICK);
  AddTestCase (new LteRlcUmTransmitterSegmentationTestCase ("Segmentation"), TestCase::Duration::QUICK);
  AddTestCase (new LteRlcUmTransmitterConcatenationTestCase ("Concatenation"), TestCase::Duration::QUICK);
...
LteRlcUmTransmitterTestCase::LteRlcUmTransmitterTestCase (std::string name) : TestCase (name)
{
...
void
LteRlcUmTransmitterTestCase::CheckDataReceived (Time time, std::string shouldReceived,
                                                std::string assertMsg)
{
  Simulator::Schedule (time, &LteRlcUmTransmitterTestCase::DoCheckDataReceived, this,
