...
LteIpv6RoutingTestCase::LteIpv6RoutingTestCase () : TestCase ("Test IPv6 Routing at LTE")
{
}
...
LteIpv6RoutingTestCase::DoRun (void)
{
  ...
  remoteHostStaticRouting->AddNetworkRouteTo ("7777:f00d::", Ipv6Prefix (64),
