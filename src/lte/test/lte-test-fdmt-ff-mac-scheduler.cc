...
LenaTestFdMtFfMacSchedulerSuite::LenaTestFdMtFfMacSchedulerSuite ()
    : TestSuite ("lte-fdmt-ff-mac-scheduler", TestSuite::Type::SYSTEM)
{
  ...
  AddTestCase (new LenaFdMtFfMacSchedulerTestCase (1, 100000, 0, 0, errorModel), TestCase::Duration::QUICK);
}
...
LenaFdMtFfMacSchedulerTestCase::LenaFdMtFfMacSchedulerTestCase (uint16_t nUser, double dist,
