...
public:
  /**
     ...
     */
  LteFadingTestCase (Ptr<BuildingsMobilityModel> m1, Ptr<BuildingsMobilityModel> m2,
...
public:
  ...
  /**
     ...
     */
  void DlScheduling (uint32_t frameNo, uint32_t subframeNo, uint16_t rnti, uint8_t mcsTb1,
                     uint16_t sizeTb1, uint8_t mcsTb2, uint16_t sizeTb2);
