...
void
BsmApplication::Setup (Ipv4InterfaceContainer &i, int nodeId, Time totalTime,
...
void
BsmApplication::GenerateWaveTraffic (Ptr<Socket> socket, uint32_t pktSize, uint32_t pktCount,
                                     Time pktInterval, uint32_t sendingNodeId)
{
  NS_LOG_FUNCTION (this);
