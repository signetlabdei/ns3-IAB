...
public:
  ...
  /**
     ...
     */
  WScalingTestCase (WScalingTestCase::Configuration conf, uint32_t maxRcvBufferSize,
...
WScalingTestCase::WScalingTestCase (WScalingTestCase::Configuration conf, uint32_t maxRcvBufferSize,
                                    uint32_t maxSndBufferSize, std::string name)
    : TcpGeneralTest (name)
{
...
public:
  ...
  {
    AddTestCase (new WScalingTestCase (WScalingTestCase::ENABLED, 200000, 65535, "WS only server"),
                 TestCase::QUICK);
    AddTestCase (new WScalingTestCase (WScalingTestCase::ENABLED, 65535, 65535,
                                       "Window scaling not used, all enabled"),
                 TestCase::QUICK);
    AddTestCase (new WScalingTestCase (WScalingTestCase::DISABLED, 65535, 65535, "WS disabled"),
                 TestCase::QUICK);
    AddTestCase (
        new WScalingTestCase (WScalingTestCase::ENABLED_SENDER, 65535, 65535, "WS enabled client"),
        TestCase::QUICK);
    AddTestCase (new WScalingTestCase (WScalingTestCase::ENABLED_RECEIVER, 65535, 65535,
                                       "WS disabled client"),
                 TestCase::QUICK);

    AddTestCase (new WScalingTestCase (WScalingTestCase::ENABLED, 65535, 200000, "WS only client"),
                 TestCase::QUICK);
    AddTestCase (new WScalingTestCase (WScalingTestCase::ENABLED, 131072, 65535, "WS only server"),
                 TestCase::QUICK);
    AddTestCase (new WScalingTestCase (WScalingTestCase::ENABLED, 65535, 131072, "WS only client"),
                 TestCase::QUICK);
    AddTestCase (
        new WScalingTestCase (WScalingTestCase::ENABLED, 4000, 4000, "WS small window, all"),
        TestCase::QUICK);
    AddTestCase (new WScalingTestCase (WScalingTestCase::ENABLED_SENDER, 4000, 4000,
