...
DynamicNeighborCacheTest::DoRun ()
{
  ...
  Simulator::Schedule (Seconds (0.5), &DynamicNeighborCacheTest::AddIpv4Address, this,
                       ipv4Interface, ifaceAddr);

  // Remove the first address (10.1.1.3) from rxNode in 1.5 seconds
  uint32_t addressIndex = 0;
  Simulator::Schedule (Seconds (1.5), &DynamicNeighborCacheTest::RemoveIpv4Address, this,
  ...
  Simulator::Schedule (Seconds (0.5), &DynamicNeighborCacheTest::AddIpv6Address, this,
                       ipv6Interface, ifaceAddrv6);

  // Remove the second address (2001:1::200:ff:fe00:3) from rxNode in 1.5 seconds
  addressIndex = 1;
  Simulator::Schedule (Seconds (1.5), &DynamicNeighborCacheTest::RemoveIpv6Address, this,
  ...
  NS_TEST_EXPECT_MSG_EQ (rxSocketv4->Bind (InetSocketAddress (Ipv4Address ("10.0.1.5"), 1234)), 0,
                         "trivial");
  NS_TEST_EXPECT_MSG_EQ (
      rxSocketv6->Bind (Inet6SocketAddress (Ipv6Address ("2001:0::200:ff:fe00:5"), 1234)), 0,
      "trivial");
  ...
  NS_TEST_EXPECT_MSG_EQ (snifferSocketv4->Bind (InetSocketAddress (Ipv4Address ("10.0.1.4"), 1234)),
                         0, "trivial");
  NS_TEST_EXPECT_MSG_EQ (
      snifferSocketv6->Bind (Inet6SocketAddress (Ipv6Address ("2001:0::200:ff:fe00:4"), 1234)), 0,
      "trivial");
...
void
DynamicPartialTest::AddIpv4Address (Ptr<Ipv4Interface> ipv4Interface,
                                    Ipv4InterfaceAddress ifaceAddr)
{
  ipv4Interface->AddAddress (ifaceAddr);
}
...
void
DynamicPartialTest::AddIpv6Address (Ptr<Ipv6Interface> ipv6Interface,
                                    Ipv6InterfaceAddress ifaceAddr)
{
  ipv6Interface->AddAddress (ifaceAddr);
}
...
DynamicPartialTest::DoRun ()
{
  ...
  Simulator::Schedule (Seconds (0.5), &DynamicPartialTest::AddIpv4Address, this, ipv4Interface,
                       ifaceAddr);

  // Remove the first address (10.1.1.1) from n1 in 1.5 seconds
  uint32_t addressIndex = 0;
  Simulator::Schedule (Seconds (1.5), &DynamicPartialTest::RemoveIpv4Address, this, ipv4Interface,
                       addressIndex);
  ...
  Ipv6InterfaceAddress ifaceAddrv6 =
      Ipv6InterfaceAddress ("2001:0::200:ff:fe00:5", Ipv6Prefix (64));
  Simulator::Schedule (Seconds (0.5), &DynamicPartialTest::AddIpv6Address, this, ipv6Interface,
                       ifaceAddrv6);

  // Remove the second address (2001:1::200:ff:fe00:1) from n1 in 1.5 seconds
  addressIndex = 1;
  Simulator::Schedule (Seconds (1.5), &DynamicPartialTest::RemoveIpv6Address, this, ipv6Interface,
                       addressIndex);
