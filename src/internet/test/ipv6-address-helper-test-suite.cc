...
IpAddressHelperTestCasev6::DoRun ()
{
  ...
  ip1.NewNetwork ();
  ipAddr1 = ip1.NewAddress ();
  NS_TEST_ASSERT_MSG_EQ (ipAddr1, Ipv6Address ("2001:db8:0:1:0:0:0:1"),
  ...
  ipAddr1 = ip1.NewAddress (); // ::1 again
  NS_TEST_ASSERT_MSG_EQ (ipAddr1, Ipv6Address ("2001:f00d:cafe:0100::1"),
                         "Ipv6AddressHelper failure");
...
Ipv6AddressHelperTestSuite::Ipv6AddressHelperTestSuite () : TestSuite ("ipv6-address-helper", UNIT)
{
