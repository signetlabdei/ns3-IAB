...
Ipv6RipngTest::DoRun ()
{
  ...
  NS_TEST_EXPECT_MSG_EQ (
      rxSocket->Bind (Inet6SocketAddress (Ipv6Address ("2001:2::200:ff:fe00:8"), 1234)), 0,
      "trivial");
...
Ipv6RipngSplitHorizonStrategyTest::DoRun ()
{
  ...
  NS_TEST_EXPECT_MSG_EQ (rxSocket->Bind (Inet6SocketAddress (Ipv6Address ("ff02::9"), 521)), 0,
                         "trivial");
