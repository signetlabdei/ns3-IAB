...
public:
  Ptr<Ipv6Route>
  RouteOutput (Ptr<Packet> p, const Ipv6Header &header, Ptr<NetDevice> oif,
  ...
  bool
  RouteInput (Ptr<const Packet> p, const Ipv6Header &header, Ptr<const NetDevice> idev,
  ...
  void
  NotifyInterfaceUp (uint32_t interface) override
  {
  }

  void
  NotifyInterfaceDown (uint32_t interface) override
  {
  }

  void
  NotifyAddAddress (uint32_t interface, Ipv6InterfaceAddress address) override
  {
  }

  void
  NotifyRemoveAddress (uint32_t interface, Ipv6InterfaceAddress address) override
  {
  }

  void
  NotifyAddRoute (Ipv6Address dst, Ipv6Prefix mask, Ipv6Address nextHop, uint32_t interface,
                  Ipv6Address prefixToUse = Ipv6Address::GetZero ()) override
  {
  }

  void
  NotifyRemoveRoute (Ipv6Address dst, Ipv6Prefix mask, Ipv6Address nextHop, uint32_t interface,
                     Ipv6Address prefixToUse) override
  {
  }

  void
  SetIpv6 (Ptr<Ipv6> ipv6) override
  {
  }
