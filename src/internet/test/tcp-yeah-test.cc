...
public:
  ...
  TcpYeahIncrementTest (uint32_t cWnd, uint32_t ssThresh, uint32_t segmentSize,
                        ...
                        uint32_t segmentsAcked, Time minRtt, const std::string &name);
...
TcpYeahIncrementTest::TcpYeahIncrementTest (uint32_t cWnd, uint32_t ssThresh, uint32_t segmentSize,
...
public:
  ...
  TcpYeahDecrementTest (uint32_t cWnd, uint32_t ssThresh, uint32_t segmentSize,
                        SequenceNumber32 nextTxSeq, SequenceNumber32 lastAckedSeq, Time minRtt,
...
TcpYeahDecrementTest::TcpYeahDecrementTest (uint32_t cWnd, uint32_t ssThresh, uint32_t segmentSize,
                                            SequenceNumber32 nextTxSeq,
...
public:
  TcpYeahTestSuite () : TestSuite ("tcp-yeah-test", UNIT)
  {
    ...
    AddTestCase (new TcpYeahIncrementTest (
                     40 * 356, 30 * 356, 356, SequenceNumber32 (20761), SequenceNumber32 (21117), 1,
                     MilliSeconds (120),
                     "YeAH test on cWnd when in slow mode without precautionary decongestion"),
                 TestCase::QUICK);
    AddTestCase (new TcpYeahIncrementTest (
                     100 * 356, 70 * 356, 356, SequenceNumber32 (20761), SequenceNumber32 (21117),
                     1, MilliSeconds (600),
                     "YeAH test on cWnd when in slow mode with precautionary decongestion"),
                 TestCase::QUICK);
    AddTestCase (new TcpYeahDecrementTest (
                     40 * 1446, 30 * 1446, 1446, SequenceNumber32 (2893), SequenceNumber32 (7230),
                     MilliSeconds (120), UintegerValue (0),
                     "YeAH test on ssThresh upon loss while competing with Reno flows"),
                 TestCase::QUICK);
    AddTestCase (new TcpYeahDecrementTest (
                     57 * 1446, 42 * 1446, 1446, SequenceNumber32 (2893), SequenceNumber32 (7230),
                     MilliSeconds (200), UintegerValue (2),
