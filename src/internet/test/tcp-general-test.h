...
protected:
  ...
  void CompleteFork (Ptr<Packet> p, const TcpHeader &tcpHeader, const Address &fromAddress,
...
public:
  ...
  TcpSocketSmallAcks ()
      : TcpSocketMsgBase (), m_bytesToAck (125), m_bytesLeftToBeAcked (0), m_lastAckedSeq (1)
  {
  }
...
protected:
  ...
  /**
     ...
     */
  void
  SetAppPktSize (uint32_t pktSize)
  {
    m_pktSize = pktSize;
  }
  ...
  /**
     ...
     */
  void
  SetAppPktCount (uint32_t pktCount)
  {
    m_pktCount = pktCount;
  }
  ...
  /**
     ...
     */
  void
  SetAppPktInterval (Time pktInterval)
  {
  ...
  /**
     ...
     */
  void
  SetPropagationDelay (Time propDelay)
  {
  ...
  /**
     ...
     */
  void
  SetTransmitStart (Time startTime)
  {
  ...
  /**
     ...
     */
  void
  SetCongestionControl (TypeId congControl)
  {
  ...
  /**
     ...
     */
  void
  SetRecoveryAlgorithm (TypeId recovery)
  {
  ...
  /**
     ...
     */
  virtual void
  CongStateTrace (const TcpSocketState::TcpCongState_t oldValue [[maybe_unused]],
  ...
  /**
     ...
     */
  virtual void
  CWndTrace (uint32_t oldValue [[maybe_unused]], uint32_t newValue [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  CWndInflTrace (uint32_t oldValue [[maybe_unused]], uint32_t newValue [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  RttTrace (Time oldTime [[maybe_unused]], Time newTime [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  SsThreshTrace (uint32_t oldValue [[maybe_unused]], uint32_t newValue [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  BytesInFlightTrace (uint32_t oldValue [[maybe_unused]], uint32_t newValue [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  RtoTrace (Time oldValue [[maybe_unused]], Time newValue [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  NextTxSeqTrace (SequenceNumber32 oldValue [[maybe_unused]],
  ...
  /**
     ...
     */
  virtual void
  HighestTxSeqTrace (SequenceNumber32 oldValue [[maybe_unused]],
                     SequenceNumber32 newValue [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  RateUpdatedTrace (const TcpRateLinux::TcpRateConnection &rate [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  RateSampleUpdatedTrace (const TcpRateLinux::TcpRateSample &sample [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  NormalClose (SocketWho who [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  ErrorClose (SocketWho who [[maybe_unused]])
  {
  ...
  /**
     ...
     */
  virtual void
  QueueDrop (SocketWho who [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  PhyDrop (SocketWho who [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  RcvAck (const Ptr<const TcpSocketState> tcb [[maybe_unused]], const TcpHeader &h [[maybe_unused]],
  ...
  /**
     ...
     */
  virtual void
  ProcessedAck (const Ptr<const TcpSocketState> tcb [[maybe_unused]],
                const TcpHeader &h [[maybe_unused]], SocketWho who [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  AfterRTOExpired (const Ptr<const TcpSocketState> tcb [[maybe_unused]],
                   SocketWho who [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  BeforeRTOExpired (const Ptr<const TcpSocketState> tcb [[maybe_unused]],
                    SocketWho who [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  UpdatedRttHistory (const SequenceNumber32 &seq [[maybe_unused]], uint32_t sz [[maybe_unused]],
                     bool isRetransmission [[maybe_unused]], SocketWho who [[maybe_unused]])
  {
  }
  ...
  /**
     ...
     */
  virtual void
  DataSent (uint32_t size [[maybe_unused]], SocketWho who [[maybe_unused]])
  {
  }
...
private:
  ...
  /**
     ...
     */
  void UpdateRttHistoryCb (Ptr<const TcpSocketBase> tcp, const SequenceNumber32 &seq, uint32_t sz,
