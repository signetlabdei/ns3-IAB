...
public:
  /**
     ...
     */
  TcpHyblaIncrementTest (uint32_t cWnd, uint32_t ssThresh, uint32_t segmentSize, const Time &rtt,
...
public:
  ...
  {
    AddTestCase (
        new TcpHyblaIncrementTest (1000, 0xFFFFFFFF, 500, MilliSeconds (55), "Rho=1.1, slow start"),
        TestCase::QUICK);
    AddTestCase (
        new TcpHyblaIncrementTest (1000, 0xFFFFFFFF, 500, MilliSeconds (100), "Rho=2, slow start"),
        TestCase::QUICK);
    AddTestCase (
        new TcpHyblaIncrementTest (1000, 0xFFFFFFFF, 500, MilliSeconds (750), "Rho=30, slow start"),
        TestCase::QUICK);
