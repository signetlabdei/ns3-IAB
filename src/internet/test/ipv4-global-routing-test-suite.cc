...
TwoLinkTest::TwoLinkTest () : TestCase ("Global routing across two hops (point-to-point links)")
{
}
...
TwoLanTest::TwoLanTest () : TestCase ("Global routing across two hops (broadcast links)")
{
}
...
BridgeTest::BridgeTest () : TestCase ("Global routing across bridging topology (bug 2102)")
{
}
...
TwoBridgeTest::TwoBridgeTest () : TestCase ("Global routing across two bridges")
{
}
...
Ipv4GlobalRoutingTestSuite::Ipv4GlobalRoutingTestSuite () : TestSuite ("ipv4-global-routing", UNIT)
{
