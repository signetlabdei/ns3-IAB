...
GlobalRouteManagerImplTestCase::DoRun ()
{
  ...
  //
  // Router 0
  GlobalRoutingLinkRecord *lr0 = new GlobalRoutingLinkRecord (GlobalRoutingLinkRecord::PointToPoint,
  ...
  GlobalRoutingLinkRecord *lr2 =
      new GlobalRoutingLinkRecord (GlobalRoutingLinkRecord::PointToPoint, "0.0.0.2", "10.1.2.1", 1);
  ...
  GlobalRoutingLinkRecord *lr4 =
      new GlobalRoutingLinkRecord (GlobalRoutingLinkRecord::PointToPoint, "0.0.0.0", "10.1.1.2", 1);
  ...
  GlobalRoutingLinkRecord *lr6 =
      new GlobalRoutingLinkRecord (GlobalRoutingLinkRecord::PointToPoint, "0.0.0.1", "10.1.2.2", 1);
  ...
  GlobalRoutingLinkRecord *lr8 =
      new GlobalRoutingLinkRecord (GlobalRoutingLinkRecord::PointToPoint, "0.0.0.3", "10.1.3.2", 1);
  ...
  GlobalRoutingLinkRecord *lr11 = new GlobalRoutingLinkRecord (GlobalRoutingLinkRecord::StubNetwork,
                                                               "10.1.2.1", "255.255.255.252", 1);
