...
public:
  /**
     ...
     */
  TcpLpToNewReno (uint32_t cWnd, uint32_t segmentSize, uint32_t segmentsAcked, uint32_t ssThresh,
...
TcpLpToNewReno::TcpLpToNewReno (uint32_t cWnd, uint32_t segmentSize, uint32_t segmentsAcked,
...
public:
  /**
     ...
     * \param name Test case name
     */
  TcpLpInferenceTest1 (uint32_t cWnd, uint32_t segmentSize, uint32_t segmentsAcked, Time rtt,
...
public:
  /**
     ...
     * \param name Test case name
     */
  TcpLpInferenceTest2 (uint32_t cWnd, uint32_t segmentSize, uint32_t segmentsAcked, Time rtt,
                       const std::string &name);
...
public:
  ...
  {
    AddTestCase (new TcpLpToNewReno (4 * 1446, 1446, 2, 2 * 1446, MilliSeconds (100),
