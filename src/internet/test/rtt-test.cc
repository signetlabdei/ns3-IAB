...
RttEstimatorTestCase::DoRun ()
{
  ...
  CheckValuesWithTolerance (rtt, Time (MilliSeconds (950)), Time (MilliSeconds (1175)),
                            Time (MilliSeconds (565)));
  CheckValuesWithTolerance (rtt, Time (MilliSeconds (1400)), Time (MicroSeconds (1197500)),
