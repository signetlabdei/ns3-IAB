...
public:
  ...
  /**
     ...
     */
  void
  SetDropCallback (Callback<void, const Ipv4Header &, const TcpHeader &, Ptr<const Packet>> cb)
  {
    m_dropCallback = cb;
  }
...
public:
  ...
  /**
     ...
     */
  void
  AddSeqToKill (const SequenceNumber32 &seq)
  {
...
public:
  ...
  /**
     ...
     */
  void
  SetFlagToKill (TcpHeader::Flags_t flags)
  {
    m_flagsToKill = flags;
  }
  ...
  /**
     ...
     */
  void
  SetKillRepeat (int16_t killNumber)
  {
