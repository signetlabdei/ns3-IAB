...
NetworkNumber6AllocatorTestCase::DoRun ()
{
  ...
  NS_TEST_EXPECT_MSG_EQ (network, Ipv6Address ("1::0:0:0"),
  ...
  Ipv6AddressGenerator::Init (Ipv6Address ("0:1::0:0"), Ipv6Prefix ("FFFF:FFFF::0"),
                              Ipv6Address ("::"));
  network = Ipv6AddressGenerator::GetNetwork (Ipv6Prefix ("FFFF:FFFF::0"));
  NS_TEST_EXPECT_MSG_EQ (network, Ipv6Address ("0:1::0"),
                         "network should equal the initialized network for given prefix");
  ...
  Ipv6AddressGenerator::Init (Ipv6Address ("0:0:1::0"), Ipv6Prefix ("FFFF:FFFF:FFFF::0"),
                              Ipv6Address ("::0"));
  network = Ipv6AddressGenerator::GetNetwork (Ipv6Prefix ("FFFF:FFFF:FFFF::0"));
  NS_TEST_EXPECT_MSG_EQ (network, Ipv6Address ("0:0:1::0"),
                         "network should equal the initialized network for given prefix");
...
AddressAllocator6TestCase::DoRun ()
{
  ...
  NS_TEST_EXPECT_MSG_EQ (address, Ipv6Address ("1::3"),
...
NetworkAndAddress6TestCase::DoRun ()
{
  ...
  address = Ipv6AddressGenerator::NextAddress (Ipv6Prefix (16));
  NS_TEST_EXPECT_MSG_EQ (address, Ipv6Address ("3::3"),
                         "address should equal initialized address for given prefix");
  address = Ipv6AddressGenerator::NextAddress (Ipv6Prefix (16));
  NS_TEST_EXPECT_MSG_EQ (address, Ipv6Address ("3::4"),
                         "address should equal next address for given prefix");

  network = Ipv6AddressGenerator::NextNetwork (Ipv6Prefix ("FFFF::"));
  NS_TEST_EXPECT_MSG_EQ (network, Ipv6Address ("4::0"),
                         "address should equal next address for given prefix");
  address = Ipv6AddressGenerator::NextAddress (Ipv6Prefix (16));
  NS_TEST_EXPECT_MSG_EQ (address, Ipv6Address ("4::3"),
                         "address should equal next address for given prefix");
}
...
ExampleAddress6GeneratorTestCase::DoRun ()
{
  ...
  Ipv6AddressGenerator::Init (Ipv6Address ("2001:0AB8::"), Ipv6Prefix ("FFFF:FFFF:FFFF::0"),
                              Ipv6Address ("::3"));
  address = Ipv6AddressGenerator::NextAddress (Ipv6Prefix (48));
  NS_TEST_EXPECT_MSG_EQ (address, Ipv6Address ("2001:0AB8::0:3"),
                         "address should equal initialized address for given prefix");
  address = Ipv6AddressGenerator::NextAddress (Ipv6Prefix (48));
  NS_TEST_EXPECT_MSG_EQ (address, Ipv6Address ("2001:0AB8::0:4"),
                         "address should equal next address for given prefix");
  address = Ipv6AddressGenerator::NextAddress (Ipv6Prefix (48));
  ...
  //
  address = Ipv6AddressGenerator::NextAddress (Ipv6Prefix (48));
  NS_TEST_EXPECT_MSG_EQ (address, Ipv6Address ("2001:0AB8:1::3"),
                         "address should equal initialized address for given prefix");
}
