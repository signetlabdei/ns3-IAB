...
class Ipv4HeaderTest : public TestCase
{
  ...
  /**
     ...
     */
  void DoSendData_IpHdr_Dscp (Ptr<Socket> socket, std::string to, Ipv4Header::DscpType dscp,
  ...
  /**
     ...
     * \param ecn The ECN field.
     */
  void SendData_IpHdr_Dscp (Ptr<Socket> socket, std::string to, Ipv4Header::DscpType dscp,
                            Ipv4Header::EcnType ecn);
...
Ipv4HeaderTest::Ipv4HeaderTest () : TestCase ("IPv4 Header Test")
{
}
...
Ipv4HeaderTest::ReceivePkt (Ptr<Socket> socket)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (m_receivedPacket->GetSize (), 2,
...
void
Ipv4HeaderTest::DoSendData_IpHdr_Dscp (Ptr<Socket> socket, std::string to,
...
void
Ipv4HeaderTest::SendData_IpHdr_Dscp (Ptr<Socket> socket, std::string to, Ipv4Header::DscpType dscp,
                                     Ipv4Header::EcnType ecn)
{
  m_receivedPacket = Create<Packet> ();
  Simulator::ScheduleWithContext (socket->GetNode ()->GetId (), Seconds (0),
                                  &Ipv4HeaderTest::DoSendData_IpHdr_Dscp, this, socket, to, dscp,
                                  ecn);
  Simulator::Run ();
}
...
Ipv4HeaderTest::DoRun ()
{
  ...
  NS_TEST_EXPECT_MSG_EQ (rxSocket->Bind (InetSocketAddress (Ipv4Address ("0.0.0.0"), 0)), 0,
                         "trivial");
