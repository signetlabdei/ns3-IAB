...
TcpTxBufferTestCase::DoRun ()
{
  ...
  /*
     ...
     */
  Simulator::Schedule (Seconds (0.0), &TcpTxBufferTestCase::TestMergeItemsWhenGetTransmittedSegment,
                       this);
...
TcpTxBufferTestCase::TestNextSeg ()
{
  ...
  NS_TEST_ASSERT_MSG_EQ (ret, head, "Different NextSeq than expected after receiving partial ACK ");
  txBuf->CopyFromSequence (segmentSize, ret);
