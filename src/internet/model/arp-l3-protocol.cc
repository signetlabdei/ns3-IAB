...
ArpL3Protocol::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::ArpL3Protocol")
          ...
          .AddAttribute ("CacheList", "The list of ARP caches", ObjectVectorValue (),
...
ArpL3Protocol::ArpL3Protocol () : m_tc (nullptr)
{
...
void
ArpL3Protocol::Receive (Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol,
...
ArpL3Protocol::Lookup (Ptr<Packet> packet, const Ipv4Header &ipHeader, Ipv4Address destination,
                       Ptr<NetDevice> device, Ptr<ArpCache> cache, Address *hardwareDestination)
{
...
void
ArpL3Protocol::SendArpReply (Ptr<const ArpCache> cache, Ipv4Address myIp, Ipv4Address toIp,
                             Address toMac)
{
