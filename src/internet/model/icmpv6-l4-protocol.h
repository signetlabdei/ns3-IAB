...
public:
  ...
  /**
     ...
     */
  void SendEchoReply (Ipv6Address src, Ipv6Address dst, uint16_t id, uint16_t seq,
                      Ptr<Packet> data);
  ...
  /**
     ...
     */
  void SendErrorParameterError (Ptr<Packet> malformedPacket, Ipv6Address dst, uint8_t code,
                                uint32_t ptr);
  ...
  /**
     ...
     */
  void SendRedirection (Ptr<Packet> redirectedPacket, Ipv6Address src, Ipv6Address dst,
  ...
  /**
     ...
     */
  NdiscCache::Ipv6PayloadHeaderPair ForgeNS (Ipv6Address src, Ipv6Address dst, Ipv6Address target,
                                             Address hardwareAddress);
  ...
  NdiscCache::Ipv6PayloadHeaderPair ForgeNA (Ipv6Address src, Ipv6Address dst,
                                             Address *hardwareAddress, uint8_t flags);
  ...
  /**
     ...
     */
  NdiscCache::Ipv6PayloadHeaderPair ForgeEchoRequest (Ipv6Address src, Ipv6Address dst, uint16_t id,
  ...
  /**
     ...
     */
  enum IpL4Protocol::RxStatus Receive (Ptr<Packet> p, const Ipv4Header &header,
  ...
  /**
     ...
     * \returns the receive status
     */
  enum IpL4Protocol::RxStatus Receive (Ptr<Packet> p, const Ipv6Header &header,
  ...
  /**
     ...
     */
  virtual bool Lookup (Ipv6Address dst, Ptr<NetDevice> device, Ptr<NdiscCache> cache,
  ...
  /**
     ...
     * \return true if the address is in the ND cache, the hardwareDestination is updated.
     */
  virtual bool Lookup (Ptr<Packet> p, const Ipv6Header &ipHeader, Ipv6Address dst,
                       Ptr<NetDevice> device, Ptr<NdiscCache> cache, Address *hardwareDestination);
...
protected:
  ...
  /**
     ...
     */
  void Forward (Ipv6Address source, Icmpv6Header icmp, uint32_t info, Ipv6Header ipHeader,
  ...
  /**
     ...
     * \param interface the interface from which the packet is coming
     */
  void HandleEchoRequest (Ptr<Packet> p, const Ipv6Address &src, const Ipv6Address &dst,
                          Ptr<Ipv6Interface> interface);
  ...
  /**
     ...
     * \param interface the interface from which the packet is coming
     */
  void HandleRedirection (Ptr<Packet> p, const Ipv6Address &src, const Ipv6Address &dst,
                          Ptr<Ipv6Interface> interface);
  ...
  /**
     ...
     * \param interface the interface from which the packet is coming
     */
  void HandleDestinationUnreachable (Ptr<Packet> p, const Ipv6Address &src, const Ipv6Address &dst,
                                     Ptr<Ipv6Interface> interface);
  ...
  /**
     ...
     * \param interface the interface from which the packet is coming
     */
  void HandleTimeExceeded (Ptr<Packet> p, const Ipv6Address &src, const Ipv6Address &dst,
                           Ptr<Ipv6Interface> interface);
  ...
  /**
     ...
     * \param interface the interface from which the packet is coming
     */
  void HandlePacketTooBig (Ptr<Packet> p, const Ipv6Address &src, const Ipv6Address &dst,
                           Ptr<Ipv6Interface> interface);
  ...
  /**
     ...
     * \param interface the interface from which the packet is coming
     */
  void HandleParameterError (Ptr<Packet> p, const Ipv6Address &src, const Ipv6Address &dst,
                             Ptr<Ipv6Interface> interface);
  ...
  /**
     ...
     * \param interface the interface from which the packet is coming
     */
  void ReceiveLLA (Icmpv6OptionLinkLayerAddress lla, const Ipv6Address &src, const Ipv6Address &dst,
                   Ptr<Ipv6Interface> interface);
