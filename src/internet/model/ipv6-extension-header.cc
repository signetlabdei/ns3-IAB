...
Ipv6ExtensionHeader::Ipv6ExtensionHeader () : m_length (0), m_nextHeader (0), m_data (0)
{
}
...
Ipv6ExtensionDestinationHeader::Ipv6ExtensionDestinationHeader () : OptionField (2)
{
}
...
Ipv6ExtensionFragmentHeader::Ipv6ExtensionFragmentHeader () : m_offset (0), m_identification (0)
{
  m_length = 0;
}
...
Ipv6ExtensionRoutingHeader::Ipv6ExtensionRoutingHeader () : m_typeRouting (0), m_segmentsLeft (0)
{
}
...
Ipv6ExtensionLooseRoutingHeader::Ipv6ExtensionLooseRoutingHeader () : m_routersAddress (0)
{
}
