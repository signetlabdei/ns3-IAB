...
Ipv4StaticRouting::Ipv4StaticRouting () : m_ipv4 (nullptr)
{
...
Ipv4StaticRouting::AddNetworkRouteTo (Ipv4Address network, Ipv4Mask networkMask,
                                      Ipv4Address nextHop, uint32_t interface, uint32_t metric)
{
...
void
Ipv4StaticRouting::AddMulticastRoute (Ipv4Address origin, Ipv4Address group,
                                      ...
                                      std::vector<uint32_t> outputInterfaces)
{
  ...
  *route = Ipv4MulticastRoutingTableEntry::CreateMulticastRoute (origin, group, inputInterface,
                                                                 outputInterfaces);
...
bool
Ipv4StaticRouting::RemoveMulticastRoute (Ipv4Address origin, Ipv4Address group,
                                         uint32_t inputInterface)
{
  NS_LOG_FUNCTION (this << origin << " " << group << " " << inputInterface);
...
Ptr<Ipv4Route>
Ipv4StaticRouting::RouteOutput (Ptr<Packet> p, const Ipv4Header &header, Ptr<NetDevice> oif,
...
bool
Ipv4StaticRouting::RouteInput (Ptr<const Packet> p, const Ipv4Header &ipHeader,
  ...
  if (ipHeader.GetDestination ().IsMulticast ())
    {
      ...
      Ptr<Ipv4MulticastRoute> mrtentry = LookupStatic (
          ipHeader.GetSource (), ipHeader.GetDestination (), m_ipv4->GetInterfaceForDevice (idev));
