...
Ipv6EndPointDemux::Ipv6EndPointDemux ()
    : m_ephemeral (49152), m_portFirst (49152), m_portLast (65535)
{
...
Ipv6EndPoint *
Ipv6EndPointDemux::Allocate (Ptr<NetDevice> boundNetDevice, Ipv6Address localAddress,
...
Ipv6EndPointDemux::Lookup (Ipv6Address daddr, uint16_t dport, Ipv6Address saddr, uint16_t sport,
