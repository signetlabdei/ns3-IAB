...
TcpSocketBase::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::TcpSocketBase")
          ...
          .AddAttribute ("CongestionOps", "Pointer to TcpCongestionOps object", PointerValue (),
          ...
          .AddAttribute ("UseEcn", "Parameter to set ECN functionality",
                         ...
                         MakeEnumChecker (TcpSocketState::Off, "Off", TcpSocketState::On, "On",
          ...
          .AddTraceSource ("HighestRxAck", "Highest ack received from peer",
                           ...
                           "ns3::TracedValueCallback::SequenceNumber32")
          .AddTraceSource ("PacingRate", "The current TCP pacing rate",
          ...
          .AddTraceSource ("Rx", "Receive tcp packet from IP protocol",
                           ...
                           "ns3::TcpSocketBase::TcpTxRxTracedCallback")
          .AddTraceSource ("EcnEchoSeq", "Sequence of last received ECN Echo",
                           MakeTraceSourceAccessor (&TcpSocketBase::m_ecnEchoSeq),
                           "ns3::SequenceNumber32TracedValueCallback")
          .AddTraceSource ("EcnCeSeq", "Sequence of last received CE",
                           MakeTraceSourceAccessor (&TcpSocketBase::m_ecnCESeq),
                           "ns3::SequenceNumber32TracedValueCallback")
          .AddTraceSource ("EcnCwrSeq", "Sequence of last received CWR",
...
TcpSocketBase::TcpSocketBase () : TcpSocket ()
{
  ...
  ok = m_tcb->TraceConnectWithoutContext (
      "PacingRate", MakeCallback (&TcpSocketBase::UpdatePacingRateTrace, this));
  NS_ASSERT (ok == true);
  ...
  if (m_congestionControl->HasCongControl ())
    {
      ...
      auto rateSample =
          m_rateOps->GenerateSample (currentDelivered, lost, false, priorInFlight, m_tcb->m_minRtt);
...
TcpSocketBase::AdvertisedWindowSize (bool scale) const
{
  ...
  if (m_tcb->m_rxBuffer->GotFin ())
    ...
    {
      NS_ASSERT_MSG (m_tcb->m_rxBuffer->MaxRxSequence () - m_tcb->m_rxBuffer->NextRxSequence () >=
                         0,
