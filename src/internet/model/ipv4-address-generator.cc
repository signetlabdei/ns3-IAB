...
Ipv4AddressGeneratorImpl::Ipv4AddressGeneratorImpl () : m_entries (), m_test (false)
{
...
Ipv4AddressGeneratorImpl::NextAddress (const Ipv4Mask mask)
{
  ...
  Ipv4Address addr =
      Ipv4Address ((m_netTable[index].network << m_netTable[index].shift) | m_netTable[index].addr);
...
Ipv4AddressGeneratorImpl::AddAllocated (const Ipv4Address address)
{
  ...
  NS_ABORT_MSG_UNLESS (
      addr, "Ipv4AddressGeneratorImpl::Add(): Allocating the broadcast address is not a good idea");
