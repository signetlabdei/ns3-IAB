...
void
LoopbackNetDevice::Receive (Ptr<Packet> packet, uint16_t protocol, Mac48Address to,
                            Mac48Address from)
{
...
LoopbackNetDevice::Send (Ptr<Packet> packet, const Address &dest, uint16_t protocolNumber)
{
  ...
  Simulator::ScheduleWithContext (m_node->GetId (), Seconds (0.0), &LoopbackNetDevice::Receive,
                                  this, packet, protocolNumber, to, m_address);
  return true;
}

bool
LoopbackNetDevice::SendFrom (Ptr<Packet> packet, const Address &source, const Address &dest,
                             uint16_t protocolNumber)
{
  ...
  Simulator::ScheduleWithContext (m_node->GetId (), Seconds (0.0), &LoopbackNetDevice::Receive,
                                  this, packet, protocolNumber, to, from);
  return true;
}
