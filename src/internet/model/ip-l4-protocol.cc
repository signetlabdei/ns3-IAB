...
{
  static TypeId tid =
      TypeId ("ns3::IpL4Protocol")
          .SetParent<Object> ()
          .SetGroupName ("Internet")
          .AddAttribute ("ProtocolNumber", "The IP protocol number.", TypeId::ATTR_GET,
                         IntegerValue (0), MakeIntegerAccessor (&IpL4Protocol::GetProtocolNumber),
...
void
IpL4Protocol::ReceiveIcmp (Ipv4Address icmpSource, uint8_t icmpTtl, uint8_t icmpType,
...
void
IpL4Protocol::ReceiveIcmp (Ipv6Address icmpSource, uint8_t icmpTtl, uint8_t icmpType,
