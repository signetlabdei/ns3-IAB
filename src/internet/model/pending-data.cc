...
PendingData::PendingData () : size (0), data (0), msgSize (0), responseSize (0)
{
...
PendingData::PendingData (const std::string &s)
    : size (s.length () + 1), data (0), msgSize (0), responseSize (0)
{
...
PendingData::PendingData (const PendingData &c)
    : size (c.Size ()), data (c.data), msgSize (c.msgSize), responseSize (c.responseSize)
{
