...
TcpSocket::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::TcpSocket")
          ...
          .AddAttribute (
              "RcvBufSize", "TcpSocket maximum receive buffer size (bytes)", UintegerValue (131072),
          ...
          .AddAttribute (
              ...
              MakeUintegerAccessor (&TcpSocket::GetInitialSSThresh, &TcpSocket::SetInitialSSThresh),
              MakeUintegerChecker<uint32_t> ())
          .AddAttribute (
              "InitialCwnd", "TCP initial congestion window size (segments)", UintegerValue (10),
          ...
          .AddAttribute (
              ...
              MakeUintegerChecker<uint32_t> ())
          .AddAttribute (
              "DataRetries", "Number of data retransmission attempts", UintegerValue (6),
          ...
          .AddAttribute ("TcpNoDelay", "Set to true to disable Nagle's algorithm",
                         ...
                         MakeBooleanChecker ())
          .AddAttribute (
              "PersistTimeout", "Persist timeout to probe for rx window", TimeValue (Seconds (6)),
