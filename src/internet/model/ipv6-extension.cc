...
{
  static TypeId tid =
      TypeId ("ns3::Ipv6Extension")
          .SetParent<Object> ()
          .SetGroupName ("Internet")
          .AddAttribute ("ExtensionNumber", "The IPv6 extension number.", UintegerValue (0),
...
uint8_t
Ipv6Extension::ProcessOptions (Ptr<Packet> &packet, uint8_t offset, uint8_t length,
                               const Ipv6Header &ipv6Header, Ipv6Address dst, uint8_t *nextHeader,
      ...
      if (!ipv6Option)
        {
          ...
          switch (optionType)
            ...
            case 2:
              NS_LOG_LOGIC ("Unknown Option. Drop!");
              icmpv6->SendErrorParameterError (malformedPacket, ipv6Header.GetSource (),
...
uint8_t
Ipv6ExtensionHopByHop::Process (Ptr<Packet> &packet, uint8_t offset, const Ipv6Header &ipv6Header,
                                Ipv6Address dst, uint8_t *nextHeader, bool &stopProcessing,
                                bool &isDropped, Ipv6L3Protocol::DropReason &dropReason)
{
  ...
  processedSize += ProcessOptions (packet, offset, length, ipv6Header, dst, nextHeader,
...
uint8_t
Ipv6ExtensionFragment::Process (Ptr<Packet> &packet, uint8_t offset, const Ipv6Header &ipv6Header,
                                Ipv6Address dst, uint8_t *nextHeader, bool &stopProcessing,
                                bool &isDropped, Ipv6L3Protocol::DropReason &dropReason)
{
  NS_LOG_FUNCTION (this << packet << offset << ipv6Header << dst << nextHeader << isDropped);
...
void
Ipv6ExtensionFragment::GetFragments (Ptr<Packet> packet, Ipv6Header ipv6Header,
  ...
  if (m_timeoutEventList.empty ())
    {
      ...
      m_timeoutEvent = Simulator::Schedule (m_fragmentExpirationTimeout,
                                            &Ipv6ExtensionFragment::HandleTimeout, this);
    }
...
Ipv6ExtensionFragment::Fragments::Fragments () : m_moreFragment (0)
{
}
...
void
Ipv6ExtensionFragment::Fragments::AddFragment (Ptr<Packet> fragment, uint16_t fragmentOffset,
                                               bool moreFragment)
{
...
uint8_t
Ipv6ExtensionRouting::Process (Ptr<Packet> &packet, uint8_t offset, const Ipv6Header &ipv6Header,
                               Ipv6Address dst, uint8_t *nextHeader, bool &stopProcessing,
                               bool &isDropped, Ipv6L3Protocol::DropReason &dropReason)
{
  NS_LOG_FUNCTION (this << packet << offset << ipv6Header << dst << nextHeader << isDropped);
  ...
  if (!ipv6ExtensionRouting)
    {
      if (routingSegmentsLeft == 0)
      ...
      else
        {
          ...
          icmpv6->SendErrorParameterError (malformedPacket, ipv6Header.GetSource (),
                                           Icmpv6Header::ICMPV6_MALFORMED_HEADER, offset + 1);
  ...
  return ipv6ExtensionRouting->Process (packet, offset, ipv6Header, dst, (uint8_t *) nullptr,
                                        stopProcessing, isDropped, dropReason);
}
...
uint8_t
Ipv6ExtensionLooseRouting::Process (Ptr<Packet> &packet, uint8_t offset,
                                    const Ipv6Header &ipv6Header, Ipv6Address dst,
                                    uint8_t *nextHeader, bool &stopProcessing, bool &isDropped,
                                    Ipv6L3Protocol::DropReason &dropReason)
{
  ...
  if (segmentsLeft > nbAddress)
    {
      NS_LOG_LOGIC ("Malformed header. Drop!");
      icmpv6->SendErrorParameterError (malformedPacket, srcAddress,
                                       Icmpv6Header::ICMPV6_MALFORMED_HEADER, offset + 3);
      dropReason = Ipv6L3Protocol::DROP_MALFORMED_HEADER;
      isDropped = true;
      stopProcessing = true;
      return routingHeader.GetSerializedSize ();
...
uint8_t
Ipv6ExtensionESP::Process (Ptr<Packet> &packet, uint8_t offset, const Ipv6Header &ipv6Header,
                           Ipv6Address dst, uint8_t *nextHeader, bool &stopProcessing,
                           bool &isDropped, Ipv6L3Protocol::DropReason &dropReason)
{
  NS_LOG_FUNCTION (this << packet << offset << ipv6Header << dst << nextHeader << isDropped);
...
uint8_t
Ipv6ExtensionAH::Process (Ptr<Packet> &packet, uint8_t offset, const Ipv6Header &ipv6Header,
                          Ipv6Address dst, uint8_t *nextHeader, bool &stopProcessing,
                          bool &isDropped, Ipv6L3Protocol::DropReason &dropReason)
{
  NS_LOG_FUNCTION (this << packet << offset << ipv6Header << dst << nextHeader << isDropped);
