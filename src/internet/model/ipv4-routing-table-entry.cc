...
Ipv4RoutingTableEntry::Ipv4RoutingTableEntry (Ipv4Address dest, Ipv4Address gateway,
                                              uint32_t interface)
    : m_dest (dest),
...
Ipv4RoutingTableEntry::Ipv4RoutingTableEntry (Ipv4Address network, Ipv4Mask networkMask,
...
Ipv4MulticastRoutingTableEntry
Ipv4MulticastRoutingTableEntry::CreateMulticastRoute (Ipv4Address origin, Ipv4Address group,
