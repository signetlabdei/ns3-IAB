  ...
  static TypeId tid =
      TypeId ("ns3::TcpIllinois")
          ...
          .AddAttribute ("BetaMin", "Minimum beta threshold", DoubleValue (0.125),
                         MakeDoubleAccessor (&TcpIllinois::m_betaMin), MakeDoubleChecker<double> ())
          .AddAttribute ("BetaMax", "Maximum beta threshold", DoubleValue (0.5),
                         MakeDoubleAccessor (&TcpIllinois::m_betaMax), MakeDoubleChecker<double> ())
