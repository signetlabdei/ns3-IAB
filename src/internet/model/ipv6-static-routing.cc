...
Ipv6StaticRouting::Ipv6StaticRouting () : m_ipv6 (nullptr)
{
...
void
Ipv6StaticRouting::AddHostRouteTo (Ipv6Address dst, Ipv6Address nextHop, uint32_t interface,
                                   Ipv6Address prefixToUse, uint32_t metric)
{
...
void
Ipv6StaticRouting::AddNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix,
                                      Ipv6Address nextHop, uint32_t interface, uint32_t metric)
{
                                      ...
                                      Ipv6Address prefixToUse, uint32_t metric)
{
  ...
  Ipv6RoutingTableEntry route = Ipv6RoutingTableEntry::CreateNetworkRouteTo (
...
void
Ipv6StaticRouting::SetDefaultRoute (Ipv6Address nextHop, uint32_t interface,
                                    Ipv6Address prefixToUse, uint32_t metric)
{
  NS_LOG_FUNCTION (this << nextHop << interface << prefixToUse);
  AddNetworkRouteTo (Ipv6Address ("::"), Ipv6Prefix::GetZero (), nextHop, interface, prefixToUse,
                     metric);
}

void
Ipv6StaticRouting::AddMulticastRoute (Ipv6Address origin, Ipv6Address group,
                                      ...
                                      std::vector<uint32_t> outputInterfaces)
{
  ...
  *route = Ipv6MulticastRoutingTableEntry::CreateMulticastRoute (origin, group, inputInterface,
                                                                 outputInterfaces);
...
bool
Ipv6StaticRouting::RemoveMulticastRoute (Ipv6Address origin, Ipv6Address group,
                                         uint32_t inputInterface)
{
  NS_LOG_FUNCTION (this << origin << group << inputInterface);
...
void
Ipv6StaticRouting::RemoveRoute (Ipv6Address network, Ipv6Prefix prefix, uint32_t ifIndex,
...
Ptr<Ipv6Route>
Ipv6StaticRouting::RouteOutput (Ptr<Packet> p, const Ipv6Header &header, Ptr<NetDevice> oif,
...
bool
Ipv6StaticRouting::RouteInput (Ptr<const Packet> p, const Ipv6Header &header,
  ...
  if (dst.IsMulticast ())
    {
      ...
      Ptr<Ipv6MulticastRoute> mrtentry = LookupStatic (
          header.GetSource (), header.GetDestination (), m_ipv6->GetInterfaceForDevice (idev));
...
void
Ipv6StaticRouting::NotifyAddRoute (Ipv6Address dst, Ipv6Prefix mask, Ipv6Address nextHop,
...
void
Ipv6StaticRouting::NotifyRemoveRoute (Ipv6Address dst, Ipv6Prefix mask, Ipv6Address nextHop,
                                      uint32_t interface, Ipv6Address prefixToUse)
{
