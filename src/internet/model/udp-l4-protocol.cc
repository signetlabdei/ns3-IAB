  ...
  static TypeId tid =
      TypeId ("ns3::UdpL4Protocol")
          ...
          .AddAttribute ("SocketList", "The list of sockets associated to this protocol.",
                         ObjectVectorValue (), MakeObjectVectorAccessor (&UdpL4Protocol::m_sockets),
...
Ipv4EndPoint *
UdpL4Protocol::Allocate (Ptr<NetDevice> boundNetDevice, Ipv4Address localAddress,
...
Ipv6EndPoint *
UdpL4Protocol::Allocate6 (Ptr<NetDevice> boundNetDevice, Ipv6Address localAddress,
...
void
UdpL4Protocol::ReceiveIcmp (Ipv4Address icmpSource, uint8_t icmpTtl, uint8_t icmpType,
...
void
UdpL4Protocol::ReceiveIcmp (Ipv6Address icmpSource, uint8_t icmpTtl, uint8_t icmpType,
...
void
UdpL4Protocol::Send (Ptr<Packet> packet, Ipv4Address saddr, Ipv4Address daddr, uint16_t sport,
                     uint16_t dport)
{
...
void
UdpL4Protocol::Send (Ptr<Packet> packet, Ipv4Address saddr, Ipv4Address daddr, uint16_t sport,
                     uint16_t dport, Ptr<Ipv4Route> route)
{
...
void
UdpL4Protocol::Send (Ptr<Packet> packet, Ipv6Address saddr, Ipv6Address daddr, uint16_t sport,
                     uint16_t dport)
{
  NS_LOG_FUNCTION (this << packet << saddr << daddr << sport << dport);
...
void
UdpL4Protocol::Send (Ptr<Packet> packet, Ipv6Address saddr, Ipv6Address daddr, uint16_t sport,
                     uint16_t dport, Ptr<Ipv6Route> route)
{
  NS_LOG_FUNCTION (this << packet << saddr << daddr << sport << dport << route);
