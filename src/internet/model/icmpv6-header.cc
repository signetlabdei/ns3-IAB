...
Icmpv6Header::Icmpv6Header () : m_calcChecksum (true), m_checksum (0), m_type (0), m_code (0)
{
  NS_LOG_FUNCTION (this);
}
...
Icmpv6Redirection::Icmpv6Redirection ()
    : m_target (Ipv6Address ("")), m_destination (Ipv6Address ("")), m_reserved (0)
{
  NS_LOG_FUNCTION (this);
...
Icmpv6DestinationUnreachable::Icmpv6DestinationUnreachable () : m_packet (nullptr)
{
  NS_LOG_FUNCTION (this);
...
Icmpv6TooBig::Icmpv6TooBig () : m_packet (nullptr), m_mtu (0)
{
  NS_LOG_FUNCTION (this);
...
Icmpv6TimeExceeded::Icmpv6TimeExceeded () : m_packet (nullptr)
{
  NS_LOG_FUNCTION (this);
...
Icmpv6ParameterError::Icmpv6ParameterError () : m_packet (nullptr), m_ptr (0)
{
  NS_LOG_FUNCTION (this);
...
Icmpv6OptionMtu::Icmpv6OptionMtu (uint32_t mtu) : m_mtu (mtu)
{
  NS_LOG_FUNCTION (this << mtu);
  SetType (Icmpv6Header::ICMPV6_OPT_MTU);
  SetLength (1);
...
Icmpv6OptionRedirected::Icmpv6OptionRedirected () : m_packet (nullptr)
{
  NS_LOG_FUNCTION (this);
