...
Ipv4ListRouting::Ipv4ListRouting () : m_ipv4 (nullptr)
{
...
Ptr<Ipv4Route>
Ipv4ListRouting::RouteOutput (Ptr<Packet> p, const Ipv4Header &header, Ptr<NetDevice> oif,
...
bool
Ipv4ListRouting::RouteInput (Ptr<const Packet> p, const Ipv4Header &header,
