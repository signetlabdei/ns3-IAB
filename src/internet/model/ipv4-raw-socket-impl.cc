...
Ipv4RawSocketImpl::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::Ipv4RawSocketImpl")
          ...
          .AddAttribute ("Protocol", "Protocol number to match.", UintegerValue (0),
          ...
          .AddAttribute ("IcmpFilter",
                         ...
                         UintegerValue (0), MakeUintegerAccessor (&Ipv4RawSocketImpl::m_icmpFilter),
          ...
          .AddAttribute (
              ...
              BooleanValue (false), MakeBooleanAccessor (&Ipv4RawSocketImpl::m_iphdrincl),
              MakeBooleanChecker ());
  return tid;
}
...
bool
Ipv4RawSocketImpl::ForwardUp (Ptr<const Packet> p, Ipv4Header ipHeader,
