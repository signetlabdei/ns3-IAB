...
private:
  /**
     ...
     */
  void EnablePcapIpv4Internal (std::string prefix, Ptr<Ipv4> ipv4, uint32_t interface,
  ...
  /**
     ...
     * @param explicitFilename Treat the prefix as an explicit filename if true
     */
  void EnableAsciiIpv4Internal (Ptr<OutputStreamWrapper> stream, std::string prefix, Ptr<Ipv4> ipv4,
                                uint32_t interface, bool explicitFilename) override;
  ...
  /**
     ...
     * @param explicitFilename Treat the prefix as an explicit filename if true
     */
  void EnablePcapIpv6Internal (std::string prefix, Ptr<Ipv6> ipv6, uint32_t interface,
                               bool explicitFilename) override;
  ...
  /**
     ...
     * @param explicitFilename Treat the prefix as an explicit filename if true
     */
  void EnableAsciiIpv6Internal (Ptr<OutputStreamWrapper> stream, std::string prefix, Ptr<Ipv6> ipv6,
                                uint32_t interface, bool explicitFilename) override;
