...
void
Ipv4StaticRoutingHelper::AddMulticastRoute (Ptr<Node> n, Ipv4Address source, Ipv4Address group,
                                            Ptr<NetDevice> input, NetDeviceContainer output)
{
  ...
  for (NetDeviceContainer::Iterator i = output.Begin (); i != output.End (); ++i)
    {
      ...
      NS_ASSERT_MSG (interface >= 0, "Ipv4StaticRoutingHelper::AddMulticastRoute(): "
  ...
  NS_ASSERT_MSG (inputInterface >= 0, "Ipv4StaticRoutingHelper::AddMulticastRoute(): "
  ...
  if (!ipv4StaticRouting)
    {
      NS_ASSERT_MSG (ipv4StaticRouting, "Ipv4StaticRoutingHelper::SetDefaultMulticastRoute(): "
...
void
Ipv4StaticRoutingHelper::AddMulticastRoute (std::string nName, Ipv4Address source,
                                            Ipv4Address group, Ptr<NetDevice> input,
...
Ipv4StaticRoutingHelper::SetDefaultMulticastRoute (Ptr<Node> n, Ptr<NetDevice> nd)
{
  ...
  NS_ASSERT_MSG (interfaceSrc >= 0, "Ipv4StaticRoutingHelper::SetDefaultMulticastRoute(): "
