                                              ...
                                              Time::Unit unit)
{
  for (uint32_t i = 0; i < NodeList::GetNNodes (); i++)
    {
      Ptr<Node> node = NodeList::GetNode (i);
      Simulator::Schedule (printInterval, &Ipv6RoutingHelper::PrintEvery, printInterval, node,
                           stream, unit);
    }
}

void
Ipv6RoutingHelper::PrintRoutingTableAt (Time printTime, Ptr<Node> node,
...
void
Ipv6RoutingHelper::PrintRoutingTableEvery (Time printInterval, Ptr<Node> node,
                                           Ptr<OutputStreamWrapper> stream, Time::Unit unit)
{
                                               ...
                                               Time::Unit unit /* = Time::S */)
{
  for (uint32_t i = 0; i < NodeList::GetNNodes (); i++)
    {
      Ptr<Node> node = NodeList::GetNode (i);
      Simulator::Schedule (printInterval, &Ipv6RoutingHelper::PrintNdiscCacheEvery, printInterval,
                           node, stream, unit);
    }
}

void
Ipv6RoutingHelper::PrintNeighborCacheAt (Time printTime, Ptr<Node> node,
...
void
Ipv6RoutingHelper::PrintNeighborCacheEvery (Time printInterval, Ptr<Node> node,
                                            Ptr<OutputStreamWrapper> stream,
                                            Time::Unit unit /* = Time::S */)
{
  Simulator::Schedule (printInterval, &Ipv6RoutingHelper::PrintNdiscCacheEvery, printInterval, node,
                       stream, unit);
}
...
void
Ipv6RoutingHelper::PrintNdiscCacheEvery (Time printInterval, Ptr<Node> node,
                                         Ptr<OutputStreamWrapper> stream,
                                         Time::Unit unit /* = Time::S */)
{
  Ptr<Ipv6L3Protocol> ipv6 = node->GetObject<Ipv6L3Protocol> ();
