          ...
          if (netDeviceIfAddr.IsInSameSubnet (neighborDeviceIfAddr.GetAddress ()))
            {
              ...
              AddEntry (ipv6Interface, neighborlinkLocalAddr.GetAddress (),
                        neighborDevice->GetAddress ());
            }
        }
    }
...
void
NeighborCacheHelper::AddEntry (Ptr<Ipv4Interface> netDeviceInterface, Ipv4Address ipv4Address,
...
void
NeighborCacheHelper::AddEntry (Ptr<Ipv6Interface> netDeviceInterface, Ipv6Address ipv6Address,
                               Address macAddress) const
{
