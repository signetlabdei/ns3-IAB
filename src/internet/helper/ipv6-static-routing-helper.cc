...
void
Ipv6StaticRoutingHelper::AddMulticastRoute (Ptr<Node> n, Ipv6Address source, Ipv6Address group,
                                            Ptr<NetDevice> input, NetDeviceContainer output)
{
  ...
  for (NetDeviceContainer::Iterator i = output.Begin (); i != output.End (); ++i)
    {
      ...
      NS_ASSERT_MSG (interface >= 0, "Ipv6StaticRoutingHelper::AddMulticastRoute (): "
  ...
  NS_ASSERT_MSG (inputInterface >= 0, "Ipv6StaticRoutingHelper::AddMulticastRoute (): "
  ...
  if (!ipv6StaticRouting)
    {
      NS_ASSERT_MSG (ipv6StaticRouting, "Ipv6StaticRoutingHelper::SetDefaultMulticastRoute (): "
...
void
Ipv6StaticRoutingHelper::AddMulticastRoute (std::string nName, Ipv6Address source,
                                            Ipv6Address group, Ptr<NetDevice> input,
