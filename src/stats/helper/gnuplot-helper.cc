...
void
GnuplotHelper::PlotProbe (const std::string &typeId, const std::string &path,
...
void
GnuplotHelper::AddProbe (const std::string &typeId, const std::string &probeName,
                                         ...
                                         const std::string &title)
{
  ...
  m_timeSeriesAdaptorMap[probeContext]->TraceConnect (
      adaptorTraceSource, probeContext, MakeCallback (&GnuplotAggregator::Write2d, aggregator));
