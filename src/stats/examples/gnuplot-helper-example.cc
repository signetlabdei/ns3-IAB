...
main (int argc, char *argv[])
{
  ...
  plotHelper.ConfigurePlot ("gnuplot-helper-example", "Emitter Count vs. Time", "Time (Seconds)",
                            "Emitter Count", "png");
  ...
  plotHelper.PlotProbe ("ns3::Uinteger32Probe", "/Names/Emitter/Counter", "Output", "Emitter Count",
