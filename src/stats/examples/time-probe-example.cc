...
Emitter::Emitter (void) : m_interval (Seconds (0)), m_last (Seconds (0))
{
...
main (int argc, char *argv[])
{
  ...
  plotHelper.ConfigurePlot ("time-probe-example", "Emitter interarrivals vs. Time",
  ...
  plotHelper.PlotProbe ("ns3::TimeProbe", "/Names/Emitter/Interval", "Output",
                        "Emitter Interarrival Time", GnuplotAggregator::KEY_INSIDE);
