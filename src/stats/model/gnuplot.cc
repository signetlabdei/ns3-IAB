...
GnuplotDataset::GnuplotDataset (struct Data *data) : m_data (data)
{
}

GnuplotDataset::GnuplotDataset (const GnuplotDataset &original) : m_data (original.m_data)
{
  ++m_data->m_references;
}
...
void
Gnuplot2dDataset::Data2d::PrintExpression (std::ostream &os, bool generateOneOutputFile,
                                           unsigned int dataFileDatasetIndex,
...
Gnuplot2dDataset::Gnuplot2dDataset (const std::string &title) : GnuplotDataset (new Data2d (title))
{
}
...
void
Gnuplot2dFunction::Function2d::PrintExpression (std::ostream &os, bool generateOneOutputFile,
                                                unsigned int dataFileDatasetIndex,
                                                std::string &dataFileName) const
{
  os << m_function;
...
Gnuplot3dDataset::Data3d::Data3d (const std::string &title) : Data (title), m_style (m_defaultStyle)
{
}
...
void
Gnuplot3dDataset::Data3d::PrintExpression (std::ostream &os, bool generateOneOutputFile,
                                           unsigned int dataFileDatasetIndex,
                                           std::string &dataFileName) const
{
  os << "\"-\" ";
...
Gnuplot3dDataset::Gnuplot3dDataset (const std::string &title) : GnuplotDataset (new Data3d (title))
{
}
...
void
Gnuplot3dFunction::Function3d::PrintExpression (std::ostream &os, bool generateOneOutputFile,
                                                unsigned int dataFileDatasetIndex,
                                                std::string &dataFileName) const
{
  os << m_function;
      ...
      if (!isDataEmpty)
        {
          ...
          i->m_data->PrintExpression (osControl, m_generateOneOutputFile, m_dataFileDatasetIndex,
                                      dataFileName);
