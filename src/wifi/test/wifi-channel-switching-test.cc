...
void
WifiChannelSwitchingTest::Transmit (WifiConstPsduMap psduMap, WifiTxVector txVector,
                                    double txPowerW)
{
...
WifiChannelSwitchingTest::DoRun (void)
{
  ...
  mac.SetType ("ns3::ApWifiMac", "Ssid", SsidValue (Ssid ("channel-switching-test")),
  ...
  NS_TEST_EXPECT_MSG_EQ (+m_txCount, 2,
                         "The QoS Data frame should have been transmitted twice by the AP");
  NS_TEST_EXPECT_MSG_EQ (m_rxBytes, m_payloadSize,
