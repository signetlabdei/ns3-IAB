...
WifiMacQueueDropOldestTest::WifiMacQueueDropOldestTest () : TestCase ("Test DROP_OLDEST setting")
{
}
...
WifiMacQueueDropOldestTest::DoRun ()
{
  ...
  for (uint32_t i = 5; i > 0; i--)
    {
      NS_TEST_EXPECT_MSG_EQ ((*it)->GetPacket ()->GetUid (), packetUids.at (i - 1),
...
WifiMacQueueTestSuite::WifiMacQueueTestSuite () : TestSuite ("wifi-mac-queue", UNIT)
{
