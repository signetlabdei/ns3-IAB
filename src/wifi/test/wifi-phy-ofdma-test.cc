...
private:
   ...
   */
  void RxSuccessSta1 (Ptr<WifiPsdu> psdu, RxSignalInfo rxSignalInfo, WifiTxVector txVector,
   ...
   * \param statusPerMpdu reception status per MPDU
   */
  void RxSuccessSta2 (Ptr<WifiPsdu> psdu, RxSignalInfo rxSignalInfo, WifiTxVector txVector,
                      std::vector<bool> statusPerMpdu);
  /**
   ...
   * \param statusPerMpdu reception status per MPDU
   */
  void RxSuccessSta3 (Ptr<WifiPsdu> psdu, RxSignalInfo rxSignalInfo, WifiTxVector txVector,
                      std::vector<bool> statusPerMpdu);
...
TestDlOfdmaPhyTransmission::SendMuPpdu (uint16_t rxStaId1, uint16_t rxStaId2)
{
  ...
  WifiTxVector txVector = WifiTxVector (HePhy::GetHeMcs7 (), 0, WIFI_PREAMBLE_HE_MU, 800, 1, 1, 0,
...
TestDlOfdmaPhyTransmission::CheckResultsSta1 (uint32_t expectedRxSuccess,
                                              uint32_t expectedRxFailure, uint32_t expectedRxBytes)
{
  NS_TEST_ASSERT_MSG_EQ (m_countRxSuccessSta1, expectedRxSuccess,
                         "The number of successfully received packets by STA 1 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_countRxFailureSta1, expectedRxFailure,
                         "The number of unsuccessfully received packets by STA 1 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_countRxBytesSta1, expectedRxBytes,
...
TestDlOfdmaPhyTransmission::CheckResultsSta2 (uint32_t expectedRxSuccess,
                                              uint32_t expectedRxFailure, uint32_t expectedRxBytes)
{
  NS_TEST_ASSERT_MSG_EQ (m_countRxSuccessSta2, expectedRxSuccess,
                         "The number of successfully received packets by STA 2 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_countRxFailureSta2, expectedRxFailure,
                         "The number of unsuccessfully received packets by STA 2 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_countRxBytesSta2, expectedRxBytes,
...
TestDlOfdmaPhyTransmission::CheckResultsSta3 (uint32_t expectedRxSuccess,
                                              uint32_t expectedRxFailure, uint32_t expectedRxBytes)
{
  NS_TEST_ASSERT_MSG_EQ (m_countRxSuccessSta3, expectedRxSuccess,
                         "The number of successfully received packets by STA 3 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_countRxFailureSta3, expectedRxFailure,
                         "The number of unsuccessfully received packets by STA 3 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_countRxBytesSta3, expectedRxBytes,
                         "The number of bytes received by STA 3 is not correct!");
}

void
TestDlOfdmaPhyTransmission::CheckPhyState (Ptr<OfdmaSpectrumWifiPhy> phy,
...
TestDlOfdmaPhyTransmission::RunOne (void)
{
  ...
  auto channelNum = std::get<0> (*WifiPhyOperatingChannel::FindFirst (
      0, m_frequency, m_channelWidth, WIFI_STANDARD_80211ax, WIFI_PHY_BAND_5GHZ));
  ...
  Simulator::Schedule (Seconds (1.1), &TestDlOfdmaPhyTransmission::CheckResultsSta1, this, 1, 0,
                       1000);
  //One PSDU of 1500 bytes should have been successfully received by STA 2
  Simulator::Schedule (Seconds (1.1), &TestDlOfdmaPhyTransmission::CheckResultsSta2, this, 1, 0,
                       1500);
  ...
  //One PSDU of 1000 bytes should have been successfully received by STA 1
  Simulator::Schedule (Seconds (2.1), &TestDlOfdmaPhyTransmission::CheckResultsSta1, this, 1, 0,
                       1000);
  ...
  Simulator::Schedule (Seconds (2.1), &TestDlOfdmaPhyTransmission::CheckResultsSta3, this, 1, 0,
                       1500);
  ...
  *interferencePsdRu1 = interferencePower / ((m_channelWidth / 2) * 20e6);
  ...
  Simulator::Schedule (Seconds (3.0) + MicroSeconds (50),
                       &TestDlOfdmaPhyTransmission::GenerateInterference, this, interferencePsdRu1,
                       MilliSeconds (100));
  ...
  //One PSDU of 1500 bytes should have been successfully received by STA 2
  Simulator::Schedule (Seconds (3.1), &TestDlOfdmaPhyTransmission::CheckResultsSta2, this, 1, 0,
                       1500);
  ...
  *interferencePsdRu2 = interferencePower / ((m_channelWidth / 2) * 20e6);
  ...
  Simulator::Schedule (Seconds (4.0) + MicroSeconds (50),
                       &TestDlOfdmaPhyTransmission::GenerateInterference, this, interferencePsdRu2,
                       MilliSeconds (100));
  ...
  //One PSDU of 1000 bytes should have been successfully received by STA 1
  Simulator::Schedule (Seconds (4.1), &TestDlOfdmaPhyTransmission::CheckResultsSta1, this, 1, 0,
                       1000);
  ...
  *interferencePsdAll = interferencePower / (m_channelWidth * 20e6);
  ...
  Simulator::Schedule (Seconds (5.0) + MicroSeconds (50),
                       &TestDlOfdmaPhyTransmission::GenerateInterference, this, interferencePsdAll,
                       MilliSeconds (100));
...
private:
  ...
  uint8_t
      m_indexSubchannel; ///< Index of the subchannel (starting from 0) that should contain an interference and be punctured during the test run
...
void
TestDlOfdmaPhyPuncturing::SendMuPpdu (uint16_t rxStaId1, uint16_t rxStaId2,
                                      const std::vector<bool> &puncturedSubchannels)
{
  NS_LOG_FUNCTION (this << rxStaId1 << rxStaId2);
  WifiConstPsduMap psdus;
  ...
  HeRu::RuSpec ru2 (ruType, ruType == HeRu::RU_484_TONE ? 2 : (puncturedSubchannels.at (3) ? 3 : 4),
                    true);
  txVector.SetRu (ru2, rxStaId2);
  txVector.SetMode (HePhy::GetHeMcs9 (), rxStaId2);
  txVector.SetNss (1, rxStaId2);
...
void
TestDlOfdmaPhyPuncturing::CheckResultsSta1 (uint32_t expectedRxSuccess, uint32_t expectedRxFailure,
                                            uint32_t expectedRxBytes)
{
  NS_TEST_ASSERT_MSG_EQ (m_countRxSuccessSta1, expectedRxSuccess,
                         "The number of successfully received packets by STA 1 is not correct!");
...
void
TestDlOfdmaPhyPuncturing::CheckResultsSta2 (uint32_t expectedRxSuccess, uint32_t expectedRxFailure,
                                            uint32_t expectedRxBytes)
{
  NS_TEST_ASSERT_MSG_EQ (m_countRxSuccessSta2, expectedRxSuccess,
                         "The number of successfully received packets by STA 2 is not correct!");
...
void
TestDlOfdmaPhyPuncturing::DoCheckPhyState (Ptr<OfdmaSpectrumWifiPhy> phy,
                                           WifiPhyState expectedState)
{
  WifiPhyState currentState;
  PointerValue ptr;
...
TestDlOfdmaPhyPuncturing::RunOne (void)
{
  ...
  *interferencePsd = interferencePower / 10e6;
  ...
  Simulator::Schedule (Seconds (0.0), &TestDlOfdmaPhyPuncturing::GenerateInterference, this,
                       interferencePsd, Seconds (3));

  //---------------------------------------------------------------------------
  //Send MU PPDU with two PSDUs addressed to STA 1 and STA 2 without preamble puncturing:
  Simulator::Schedule (Seconds (1.0), &TestDlOfdmaPhyPuncturing::SendMuPpdu, this, 1, 2,
                       std::vector<bool>{});
  ...
  Simulator::Schedule (Seconds (1.0) + m_expectedPpduDuration40Mhz - NanoSeconds (1),
                       &TestDlOfdmaPhyPuncturing::CheckPhyState, this, m_phySta1, WifiPhyState::RX);
  Simulator::Schedule (Seconds (1.0) + m_expectedPpduDuration40Mhz - NanoSeconds (1),
                       &TestDlOfdmaPhyPuncturing::CheckPhyState, this, m_phySta2, WifiPhyState::RX);
  ...
  if (m_indexSubchannel < 2) // interference in RU 1
    {
      ...
      Simulator::Schedule (Seconds (1.1), &TestDlOfdmaPhyPuncturing::CheckResultsSta1, this, 0, 1,
                           0);
      //One PSDU of 1500 bytes should have been successfully received by STA 2
      Simulator::Schedule (Seconds (1.1), &TestDlOfdmaPhyPuncturing::CheckResultsSta2, this, 1, 0,
                           1500);
    }
  else // interference in RU 2
    {
      //One PSDU of 1000 bytes should have been successfully received by STA 1
      Simulator::Schedule (Seconds (1.1), &TestDlOfdmaPhyPuncturing::CheckResultsSta1, this, 1, 0,
                           1000);
      //One PSDU of 1500 bytes should have been unsuccessfully received by STA 2
      Simulator::Schedule (Seconds (1.1), &TestDlOfdmaPhyPuncturing::CheckResultsSta2, this, 0, 1,
                           0);
    }
  ...
  Simulator::Schedule (Seconds (2.0), &TestDlOfdmaPhyPuncturing::SendMuPpdu, this, 1, 2,
  ...
  //One PSDU of 1000 bytes should have been successfully received by STA 1
  Simulator::Schedule (Seconds (2.1), &TestDlOfdmaPhyPuncturing::CheckResultsSta1, this, 1, 0,
                       1000);
  //One PSDU of 1500 bytes should have been successfully received by STA 2
  Simulator::Schedule (Seconds (2.1), &TestDlOfdmaPhyPuncturing::CheckResultsSta2, this, 1, 0,
                       1500);
...
TestUlOfdmaPpduUid::DoSetup (void)
{
  ...
  m_phyAp->SetErrorRateModel (apErrorModel);
  auto channelNum = std::get<0> (*WifiPhyOperatingChannel::FindFirst (
      0, DEFAULT_FREQUENCY, DEFAULT_CHANNEL_WIDTH, WIFI_STANDARD_80211ax, WIFI_PHY_BAND_5GHZ));
  m_phyAp->SetOperatingChannel (
...
TestUlOfdmaPpduUid::SendTbPpdu (void)
{
  ...
  WifiTxVector txVector1 = WifiTxVector (HePhy::GetHeMcs7 (), 0, WIFI_PREAMBLE_HE_TB, 800, 1, 1, 0,
                                         DEFAULT_CHANNEL_WIDTH, false, false);
...
TestMultipleHeTbPreambles::TestMultipleHeTbPreambles ()
    : TestCase ("UL-OFDMA multiple RX events test"),
      ...
      m_trigVector (HePhy::GetHeMcs7 (), 0, WIFI_PREAMBLE_HE_TB, 800, 1, 1, 0,
                    DEFAULT_CHANNEL_WIDTH, false, false)
{
}
...
void
TestMultipleHeTbPreambles::RxHeTbPpdu (uint64_t uid, uint16_t staId, double txPowerWatts,
                                       size_t payloadSize)
{
  WifiConstPsduMap psdus;
  WifiTxVector txVector = WifiTxVector (HePhy::GetHeMcs7 (), 0, WIFI_PREAMBLE_HE_TB, 800, 1, 1, 0,
                                        DEFAULT_CHANNEL_WIDTH, false, false);
  ...
  Ptr<HePpdu> ppdu = Create<HePpdu> (psdus, txVector, DEFAULT_FREQUENCY, ppduDuration,
                                     WIFI_PHY_BAND_5GHZ, uid, HePpdu::PSD_NON_HE_PORTION, 0);
  ...
  Ptr<SpectrumValue> rxPsd = WifiSpectrumValueHelper::CreateHeOfdmTxPowerSpectralDensity (
      centerFrequency, channelWidth, txPowerWatts, m_phy->GetGuardBandwidth (channelWidth));
  ...
  Ptr<SpectrumValue> rxPsdOfdma = WifiSpectrumValueHelper::CreateHeMuOfdmTxPowerSpectralDensity (
      DEFAULT_FREQUENCY, DEFAULT_CHANNEL_WIDTH, txPowerWatts, DEFAULT_GUARD_WIDTH, band);
  ...
  Simulator::Schedule (nonOfdmaDuration, &TestMultipleHeTbPreambles::RxHeTbPpduOfdmaPart, this,
                       rxParamsOfdma);
}
...
TestMultipleHeTbPreambles::DoRun (void)
{
...

  {
    ...
    Simulator::Schedule (Seconds (1), &TestMultipleHeTbPreambles::RxHeTbPpdu, this, uids[0], 1,
                         txPowerWatts, 1001);
    Simulator::Schedule (Seconds (1) + NanoSeconds (100), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[0], 2, txPowerWatts, 1002);
    ...
    Simulator::Schedule (Seconds (1.0) + MicroSeconds (1),
                         &TestMultipleHeTbPreambles::CheckHeTbPreambles, this, 1, uids);
...

  {
    ...
    Simulator::Schedule (Seconds (2), &TestMultipleHeTbPreambles::RxHeTbPpdu, this, uids[0], 1,
                         txPowerWatts, 1001);
    Simulator::Schedule (Seconds (2) + NanoSeconds (100), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[0], 2, txPowerWatts, 1002);
    Simulator::Schedule (Seconds (2) + NanoSeconds (200), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[1], 1, txPowerWatts / 2, 1003);
    Simulator::Schedule (Seconds (2) + NanoSeconds (300), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[1], 2, txPowerWatts / 2, 1004);
    ...
    Simulator::Schedule (Seconds (2.0) + MicroSeconds (1),
                         &TestMultipleHeTbPreambles::CheckHeTbPreambles, this, 2, uids);
...

  {
    ...
    Simulator::Schedule (Seconds (3), &TestMultipleHeTbPreambles::RxHeTbPpdu, this, uids[0], 1,
                         txPowerWatts / 2, 1001);
    Simulator::Schedule (Seconds (3) + NanoSeconds (100), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[0], 2, txPowerWatts / 2, 1002);
    Simulator::Schedule (Seconds (3) + NanoSeconds (200), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[1], 1, txPowerWatts, 1003);
    Simulator::Schedule (Seconds (3) + NanoSeconds (300), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[1], 2, txPowerWatts, 1004);
    //Check that we received the correct reception of 2 UL MU transmissions with the corresponding UIDs
...

  {
    ...
    Simulator::Schedule (Seconds (4), &TestMultipleHeTbPreambles::RxHeTbPpdu, this, uids[0], 1,
                         txPowerWatts, 1001);
    Simulator::Schedule (Seconds (4) + NanoSeconds (100), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[0], 2, txPowerWatts, 1002);
    Simulator::Schedule (Seconds (4) + MicroSeconds (5), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[1], 1, txPowerWatts, 1003);
    Simulator::Schedule (Seconds (4) + MicroSeconds (5) + NanoSeconds (100),
                         &TestMultipleHeTbPreambles::RxHeTbPpdu, this, uids[1], 2, txPowerWatts,
                         1004);
    ...
    Simulator::Schedule (Seconds (4.0) + MicroSeconds (10),
                         &TestMultipleHeTbPreambles::CheckBytesDropped, this, 1003 + 1004);
...

  {
    ...
    Simulator::Schedule (Seconds (5), &TestMultipleHeTbPreambles::RxHeTbPpdu, this, uids[0], 1,
                         txPowerWatts, 1001);
    Simulator::Schedule (Seconds (5) + NanoSeconds (100), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[0], 2, txPowerWatts, 1002);
    Simulator::Schedule (Seconds (5) + MicroSeconds (50), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[1], 1, txPowerWatts, 1003);
...

  {
    ...
    Simulator::Schedule (Seconds (6), &TestMultipleHeTbPreambles::RxHeTbPpdu, this, uids[0], 1,
                         txPowerWatts, 1001);
    Simulator::Schedule (Seconds (6) + NanoSeconds (500), &TestMultipleHeTbPreambles::RxHeTbPpdu,
                         this, uids[0], 2, txPowerWatts, 1002);
    //Check that we received a single UL MU transmission with the corresponding UID
    ...
    Simulator::Schedule (Seconds (6.0) + MicroSeconds (5),
                         &TestMultipleHeTbPreambles::CheckBytesDropped, this, 1001 + 1002);
...
public:
  ...
  void
  NotifyRxStart (Time duration) override
  {
    NS_LOG_FUNCTION (this << duration);
  ...
  void
  NotifyRxEndError (void) override
  {
    NS_LOG_FUNCTION (this);
    m_lastRxEnd = Simulator::Now ();
    ++m_notifyRxEnd;
  ...
  void
  NotifyTxStart (Time duration, double txPowerDbm) override
  {
  ...
  void
  NotifySwitchingStart (Time duration) override
  {
  }

  void
  NotifySleep (void) override
  {
  }

  void
  NotifyOff (void) override
  {
  }

  void
  NotifyWakeup (void) override
  {
  }

  void
  NotifyOn (void) override
  {
  }
   ...
   */
  uint32_t
  GetNumRxStartNotifications (void) const
  {
   ...
   */
  uint32_t
  GetNumRxEndNotifications (void) const
  {
   ...
   */
  Time
  GetLastRxStartNotification (void) const
  {
   ...
   */
  Time
  GetLastRxEndNotification (void) const
  {
    return m_lastRxEnd;
  }
...
public:
   ...
   */
  enum TrigVectorInfo { NONE = 0, CHANNEL_WIDTH, UL_LENGTH, AID, RU_TYPE, MCS };
...
private:
   ...
   */
  void SendHeTbPpdu (uint16_t txStaId, std::size_t index, std::size_t payloadSize, uint64_t uid,
                     uint8_t bssColor, bool incrementUid);
   ...
   */
  void CheckNonOfdmaRxPower (Ptr<OfdmaSpectrumWifiPhy> phy, WifiSpectrumBand band,
   ...
   * \param expectedRxPower the expected received power in W
   */
  void CheckOfdmaRxPower (Ptr<OfdmaSpectrumWifiPhy> phy, WifiSpectrumBand band,
                          double expectedRxPower);
   ...
   */
  void CheckApRxEnd (uint32_t expectedNotifications, Time expectedLastNotification,
  ...
  void SchedulePowerMeasurementChecks (Time delay, double rxPowerNonOfdmaRu1,
                                       double rxPowerNonOfdmaRu2, double rxPowerOfdmaRu1,
...
void
TestUlOfdmaPhyTransmission::SendHeSuPpdu (uint16_t txStaId, std::size_t payloadSize, uint64_t uid,
                                          uint8_t bssColor)
{
...
WifiTxVector
TestUlOfdmaPhyTransmission::GetTxVectorForHeTbPpdu (uint16_t txStaId, std::size_t index,
...
TestUlOfdmaPhyTransmission::SetTrigVector (uint8_t bssColor, TrigVectorInfo error)
{
  ...
  WifiTxVector txVector (HePhy::GetHeMcs7 (), 0, WIFI_PREAMBLE_HE_TB, 800, 1, 1, 0, channelWidth,
                         false, false, false, bssColor);
  ...
  uint16_t length;
  std::tie (length, m_expectedPpduDuration) = HePhy::ConvertHeTbPpduDurationToLSigLength (
...
void
TestUlOfdmaPhyTransmission::SendHeTbPpdu (uint16_t txStaId, std::size_t index,
...
void
TestUlOfdmaPhyTransmission::RxSuccess (Ptr<WifiPsdu> psdu, RxSignalInfo rxSignalInfo,
                                       WifiTxVector txVector, std::vector<bool> /*statusPerMpdu*/)
{
...
void
TestUlOfdmaPhyTransmission::CheckRxFromSta1 (uint32_t expectedSuccess, uint32_t expectedFailures,
                                             uint32_t expectedBytes)
{
  NS_TEST_ASSERT_MSG_EQ (m_countRxSuccessFromSta1, expectedSuccess,
                         "The number of successfully received packets from STA 1 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (
      m_countRxFailureFromSta1, expectedFailures,
      "The number of unsuccessfully received packets from STA 1 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_countRxBytesFromSta1, expectedBytes,
                         "The number of bytes received from STA 1 is not correct!");
}

void
TestUlOfdmaPhyTransmission::CheckRxFromSta2 (uint32_t expectedSuccess, uint32_t expectedFailures,
                                             uint32_t expectedBytes)
{
  NS_TEST_ASSERT_MSG_EQ (m_countRxSuccessFromSta2, expectedSuccess,
                         "The number of successfully received packets from STA 2 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (
      m_countRxFailureFromSta2, expectedFailures,
      "The number of unsuccessfully received packets from STA 2 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_countRxBytesFromSta2, expectedBytes,
...
TestUlOfdmaPhyTransmission::CheckNonOfdmaRxPower (Ptr<OfdmaSpectrumWifiPhy> phy,
                                                  WifiSpectrumBand band, double expectedRxPower)
{
...
void
TestUlOfdmaPhyTransmission::CheckOfdmaRxPower (Ptr<OfdmaSpectrumWifiPhy> phy, WifiSpectrumBand band,
                                               double expectedRxPower)
{
  /**
  ...
  if (expectedRxPower > 0.0)
    {
      NS_TEST_ASSERT_MSG_EQ (
          phy->GetEnergyDuration (expectedRxPower - step, band).IsStrictlyPositive (), true,
          "At least " << expectedRxPower << " W expected for OFDMA part over (" << band.first
                      << ", " << band.second << ") at " << Simulator::Now ());
      NS_TEST_ASSERT_MSG_EQ (
          phy->GetEnergyDuration (expectedRxPower + step, band).IsStrictlyPositive (), false,
...
void
TestUlOfdmaPhyTransmission::CheckPhyState (Ptr<OfdmaSpectrumWifiPhy> phy,
                                           WifiPhyState expectedState)
{
                                            ...
                                            Time expectedLastNotification)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (
      m_apPhyStateListener->GetLastRxStartNotification (), expectedLastNotification,
      "Last time RX start notification has been received "
          << m_apPhyStateListener->GetLastRxStartNotification () << " does not match expected time "
          << expectedLastNotification << " for AP at " << Simulator::Now ());
}
                                          ...
                                          Time expectedLastNotification, bool expectedSuccess)
{
  NS_TEST_ASSERT_MSG_EQ (m_apPhyStateListener->GetNumRxEndNotifications (), expectedNotifications,
                         "Number of RX end notifications "
                             ...
                             << " for AP at " << Simulator::Now ());
  NS_TEST_ASSERT_MSG_EQ (
      m_apPhyStateListener->GetLastRxEndNotification (), expectedLastNotification,
      "Last time RX end notification has been received "
          << m_apPhyStateListener->GetLastRxEndNotification () << " does not match expected time "
          << expectedLastNotification << " for AP at " << Simulator::Now ());
...
TestUlOfdmaPhyTransmission::ScheduleTest (
    Time delay, bool solicited, WifiPhyState expectedStateAtEnd, uint32_t expectedSuccessFromSta1,
    uint32_t expectedFailuresFromSta1, uint32_t expectedBytesFromSta1,
    uint32_t expectedSuccessFromSta2, uint32_t expectedFailuresFromSta2,
    uint32_t expectedBytesFromSta2, bool scheduleTxSta1, Time ulTimeDifference,
    WifiPhyState expectedStateBeforeEnd, TrigVectorInfo error)
{
  static uint64_t uid = 0;

  //AP sends an SU packet preceding HE TB PPDUs
  Simulator::Schedule (delay - MilliSeconds (10), &TestUlOfdmaPhyTransmission::SendHeSuPpdu, this,
                       0, 50, ++uid, 0);
  if (!solicited)
    {
  ...
  if (scheduleTxSta1)
    {
      Simulator::Schedule (delay, &TestUlOfdmaPhyTransmission::SendHeTbPpdu, this, 1, 1, 1000, uid,
                           0, false);
    }
  Simulator::Schedule (delay + ulTimeDifference, &TestUlOfdmaPhyTransmission::SendHeTbPpdu, this, 2,
                       2, 1001, uid, 0, false);
  ...
  if (expectedSuccessFromSta1 + expectedFailuresFromSta1 + expectedSuccessFromSta2 +
      ...
      0)
    {
      ...
      Simulator::Schedule (expectedPayloadEnd, &TestUlOfdmaPhyTransmission::CheckApRxStart, this, 1,
...
void
TestUlOfdmaPhyTransmission::SchedulePowerMeasurementChecks (Time delay, double rxPowerNonOfdmaRu1,
  ...
  for (uint8_t i = 0; i < 2; ++i)
    {
      ...
      Simulator::Schedule (
          ...
          &TestUlOfdmaPhyTransmission::CheckNonOfdmaRxPower, this, m_phyAp, nonOfdmaBand[i],
          rxPowerNonOfdma[i]);
      ...
      Simulator::Schedule (
          delay + detectionDuration +
              NanoSeconds (1), //just after beginning of portion (once event is stored)
          &TestUlOfdmaPhyTransmission::CheckOfdmaRxPower, this, m_phySta3, nonOfdmaBand[i],
          rxPowerNonOfdma[i]);
      Simulator::Schedule (delay + nonOfdmaDuration - NanoSeconds (1), //just before end of portion
  ...
  if (rxPowerOfdmaRu1 != 0.0)
    {
      ...
      Simulator::Schedule (
          delay + detectionDuration +
              NanoSeconds (1), //just after beginning of portion (once event is stored)
          &TestUlOfdmaPhyTransmission::CheckOfdmaRxPower, this, m_phySta2, nonOfdmaBand[0],
...
TestUlOfdmaPhyTransmission::RunOne (void)
{
  ...
  *interferencePsdRu1 = interferencePower / ((m_channelWidth / 2) * 20e6);
  ...
  Simulator::Schedule (delay + MicroSeconds (50), &TestUlOfdmaPhyTransmission::GenerateInterference,
                       this, interferencePsdRu1, MilliSeconds (100));
  ScheduleTest (
      delay, true,
  ...
  *interferencePsdRu2 = interferencePower / ((m_channelWidth / 2) * 20e6);
  ...
  Simulator::Schedule (delay + MicroSeconds (50), &TestUlOfdmaPhyTransmission::GenerateInterference,
                       this, interferencePsdRu2, MilliSeconds (100));
  ScheduleTest (
      delay, true,
      (m_channelWidth >= 40)
          ? WifiPhyState::IDLE
          : WifiPhyState::
                CCA_BUSY, //PHY should move to CCA_BUSY if interference is generated in its primary channel
      1, 0, 1000, //One PSDU of 1000 bytes should have been successfully received from STA 1
      0, 1,
      0); //Reception of the PSDU from STA 2 should have failed (since interference occupies RU 2)
  delay += Seconds (1.0);
  ...
  *interferencePsdAll = interferencePower / (m_channelWidth * 20e6);
  ...
  Simulator::Schedule (delay + MicroSeconds (50), &TestUlOfdmaPhyTransmission::GenerateInterference,
                       this, interferencePsdAll, MilliSeconds (100));
  ScheduleTest (
      delay, true,
      WifiPhyState::CCA_BUSY, //PHY should move to CCA_BUSY instead of IDLE due to the interference
      0, 1,
  ...
  Simulator::Schedule (delay + MicroSeconds (50), &TestUlOfdmaPhyTransmission::SendHeTbPpdu, this,
                       3, 1, 1002, 1, 0, false);
  ...
  ScheduleTest (
      delay, true,
      WifiPhyState::
          CCA_BUSY, //PHY should move to CCA_BUSY instead of IDLE due to the interference on measurement channel width
      0, 1,
      0, //Reception of the PSDU from STA 1 should have failed (since interference from STA 3 on same 20 MHz channel)
      succ, fail, bytes);
  delay += Seconds (1.0);
  ...
  ScheduleTest (
      ...
      (m_channelWidth >= 40)
          ? WifiPhyState::IDLE
          : WifiPhyState::
                CCA_BUSY, //PHY should move to CCA_BUSY instead of IDLE if HE TB PPDU on primary channel
      succ, fail, bytes, 0, 1,
      0); //Reception of the PSDU from STA 2 should have failed (since interference from STA 3 on same 20 MHz channel)
  delay += Seconds (1.0);
  ...
  Simulator::Schedule (delay + NanoSeconds (300), &TestUlOfdmaPhyTransmission::SendHeSuPpdu, this,
                       3, 1002, 1, 0);
  ScheduleTest (
      delay, true, WifiPhyState::IDLE, 0, 1,
  ...
  Simulator::Schedule (
      delay + m_expectedPpduDuration - NanoSeconds (1), &TestUlOfdmaPhyTransmission::CheckPhyState,
      this, m_phySta3,
      (m_channelWidth >= 40)
          ? WifiPhyState::IDLE
          : WifiPhyState::
                CCA_BUSY); //PHY should move to CCA_BUSY instead of IDLE if HE TB PPDU on primary channel;
  ScheduleTest (delay, true, WifiPhyState::IDLE, 0, 0, 0, //No transmission scheduled for STA 1
                1, 0,
                1001, //One PSDU of 1001 bytes should have been successfully received from STA 2
  ...
  rxPower =
      (m_channelWidth > 40)
          ? DbmToW (19)
          : DbmToW (
                18.0103); //15.0103+1 dBm at STA 2 and +2 at AP for non-OFDMA transmitted only on one 20 MHz channel
  ...
  Simulator::Schedule (delay + m_expectedPpduDuration, &TestUlOfdmaPhyTransmission::SetPsdLimit,
                       this, m_phySta2, 100.0);
  ScheduleTest (delay, true, WifiPhyState::IDLE, 0, 0, 0, //No transmission scheduled for STA 1
                1, 0,
                1001, //One PSDU of 1001 bytes should have been successfully received from STA 2
                false, Seconds (0), WifiPhyState::RX); //Measurement channel is total channel width
  ...
  Simulator::Schedule (delay + MilliSeconds (100), &TestUlOfdmaPhyTransmission::SendHeTbPpdu, this,
                       3, 1, 1002, 1, 2, false);

  //Verify events data have been cleared
  Simulator::Schedule (delay + MilliSeconds (200), &TestUlOfdmaPhyTransmission::VerifyEventsCleared,
                       this);
  ...
  Simulator::Schedule (delay + m_expectedPpduDuration + NanoSeconds (100),
                       &TestUlOfdmaPhyTransmission::SendHeTbPpdu, this, 3, 1, 1002, 1, 2, true);
...
void
TestPhyPaddingExclusion::SendHeTbPpdu (uint16_t txStaId, std::size_t index, std::size_t payloadSize,
                                       Time txDuration)
{
  WifiConstPsduMap psdus;
...
void
TestPhyPaddingExclusion::RxSuccess (Ptr<WifiPsdu> psdu, RxSignalInfo rxSignalInfo,
                                    WifiTxVector txVector, std::vector<bool> /*statusPerMpdu*/)
{
  NS_LOG_FUNCTION (this << *psdu << psdu->GetAddr2 () << rxSignalInfo << txVector);
  if (psdu->GetAddr2 () == Mac48Address ("00:00:00:00:00:01"))
...
void
TestPhyPaddingExclusion::CheckRxFromSta1 (uint32_t expectedSuccess, uint32_t expectedFailures,
                                          uint32_t expectedBytes)
{
  NS_TEST_ASSERT_MSG_EQ (m_countRxSuccessFromSta1, expectedSuccess,
                         "The number of successfully received packets from STA 1 is not correct!");
...
void
TestPhyPaddingExclusion::CheckRxFromSta2 (uint32_t expectedSuccess, uint32_t expectedFailures,
                                          uint32_t expectedBytes)
{
  NS_TEST_ASSERT_MSG_EQ (m_countRxSuccessFromSta2, expectedSuccess,
                         "The number of successfully received packets from STA 2 is not correct!");
...
TestPhyPaddingExclusion::DoRun (void)
{
  ...
  //STA1 and STA2 send MU UL PPDUs addressed to AP:
  Simulator::Schedule (Seconds (1.0), &TestPhyPaddingExclusion::SendHeTbPpdu, this, 1, 1, 1000,
                       ppduWithPaddingDuration);
  Simulator::Schedule (Seconds (1.0), &TestPhyPaddingExclusion::SendHeTbPpdu, this, 2, 2, 1001,
                       ppduWithPaddingDuration);
  ...
  Simulator::Schedule (Seconds (1.0) + ppduWithPaddingDuration - NanoSeconds (1),
                       &TestPhyPaddingExclusion::CheckPhyState, this, m_phyAp, WifiPhyState::RX);
  Simulator::Schedule (Seconds (1.0) + ppduWithPaddingDuration,
                       &TestPhyPaddingExclusion::CheckPhyState, this, m_phyAp, WifiPhyState::IDLE);
  ...
  //STA1 and STA2 send MU UL PPDUs addressed to AP:
  Simulator::Schedule (Seconds (2.0), &TestPhyPaddingExclusion::SendHeTbPpdu, this, 1, 1, 1000,
                       ppduWithPaddingDuration);
  Simulator::Schedule (Seconds (2.0), &TestPhyPaddingExclusion::SendHeTbPpdu, this, 2, 2, 1001,
                       ppduWithPaddingDuration);
  ...
  *interferencePsdRu1 = interferencePower / ((DEFAULT_CHANNEL_WIDTH / 2) * 20e6);
  ...
  Simulator::Schedule (Seconds (2.0) + MicroSeconds (50) + expectedPpduDuration,
                       &TestPhyPaddingExclusion::GenerateInterference, this, interferencePsdRu1,
                       MilliSeconds (100));
...
private:
   ...
   * \param statusPerMpdu reception status per MPDU
   */
  void ReceiveOkCallbackAtAp (Ptr<WifiPsdu> psdu, RxSignalInfo rxSignalInfo, WifiTxVector txVector,
                              std::vector<bool> statusPerMpdu);
...
TestUlOfdmaPowerControl::SendMuBar (std::vector<uint16_t> staIds)
{
  ...
  muBar.SetUlLength (HePhy::ConvertHeTbPpduDurationToLSigLength (MicroSeconds (128), tbTxVector,
                                                                 WIFI_PHY_BAND_5GHZ)
                         .first);
  ...
  nav += m_phyAp->CalculateTxDuration (GetBlockAckSize (BlockAckType::COMPRESSED), tbTxVector,
                                       DEFAULT_WIFI_BAND, staId);
...
TestUlOfdmaPowerControl::DoSetup (void)
{
  ...
  mac.SetType ("ns3::ApWifiMac", "BeaconGeneration", BooleanValue (true), "BeaconInterval",
...
TestUlOfdmaPowerControl::RunOne (bool setupBa)
{
  ...
  if (setupBa)
    {
      ...
      Simulator::Schedule (MilliSeconds (800), &TestUlOfdmaPowerControl::SetupBa, this,
                           m_sta1Dev->GetAddress ());
      Simulator::Schedule (MilliSeconds (850), &TestUlOfdmaPowerControl::SetupBa, this,
...

  {
    ...
    Simulator::Schedule (relativeStart + MilliSeconds (20), &TestUlOfdmaPowerControl::SendMuBar,
                         this, staIds);
  }

  {
    ...
    Simulator::Schedule (relativeStart + MilliSeconds (40), &TestUlOfdmaPowerControl::SendMuBar,
                         this, staIds);
  }
...
WifiPhyOfdmaTestSuite::WifiPhyOfdmaTestSuite () : TestSuite ("wifi-phy-ofdma", UNIT)
{
