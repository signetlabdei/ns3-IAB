...
private:
   ...
   */
  Ptr<ListPositionAllocator> AllocatePositions (double d1, double d2, double d3, double d4,
                                                double d5);
...
TestInterBssConstantObssPdAlgo::AllocatePositions (double d1, double d2, double d3, double d4,
                                                   double d5)
{
...
TestInterBssConstantObssPdAlgo::SetupSimulation ()
{
  ...
  Simulator::Schedule (Seconds (0.25), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       ap_device1, sta_device1, m_payloadSize1);
  Simulator::Schedule (Seconds (0.5), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       sta_device1, ap_device1, m_payloadSize1);
  Simulator::Schedule (Seconds (0.75), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       ap_device2, sta_device2, m_payloadSize2);
  Simulator::Schedule (Seconds (1), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       sta_device2, ap_device2, m_payloadSize2);
  Simulator::Schedule (Seconds (1.25), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       ap_device3, sta_device3, m_payloadSize3);
  Simulator::Schedule (Seconds (1.5), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
  ...
  Simulator::Schedule (Seconds (2.0), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       ap_device2, sta_device2, m_payloadSize2);
  ...
  Simulator::Schedule (Seconds (2.0) + MicroSeconds (13),
                       ...
                       WifiPhyState::IDLE);
  Simulator::Schedule (Seconds (2.0) + MicroSeconds (13),
                       &TestInterBssConstantObssPdAlgo::CheckPhyState, this, sta_device2,
                       WifiPhyState::IDLE);
  Simulator::Schedule (Seconds (2.0) + MicroSeconds (13),
  ...
  Simulator::Schedule (Seconds (2.0) + MicroSeconds (43),
                       &TestInterBssConstantObssPdAlgo::CheckPhyDropReasons, this, sta_device1,
                       dropReasons);
  Simulator::Schedule (Seconds (2.0) + MicroSeconds (43),
                       &TestInterBssConstantObssPdAlgo::CheckPhyState, this, sta_device1,
                       expectPhyReset ? WifiPhyState::IDLE : WifiPhyState::CCA_BUSY);
  Simulator::Schedule (Seconds (2.0) + MicroSeconds (43),
                       &TestInterBssConstantObssPdAlgo::CheckPhyDropReasons, this, ap_device1,
                       dropReasons);
  Simulator::Schedule (Seconds (2.0) + MicroSeconds (43),
                       &TestInterBssConstantObssPdAlgo::CheckPhyState, this, ap_device1,
                       expectPhyReset ? WifiPhyState::IDLE : WifiPhyState::CCA_BUSY);
  ...
  Simulator::Schedule (Seconds (2.1), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       ap_device2, sta_device2, m_payloadSize2);
  ...
  Simulator::Schedule (Seconds (2.1) + MicroSeconds (42),
                       &TestInterBssConstantObssPdAlgo::SendOnePacket, this, sta_device1,
                       ap_device1, m_payloadSize1);
  if (expectPhyReset)
    {
  ...
  Simulator::Schedule (Seconds (2.2), &TestInterBssConstantObssPdAlgo::SetExpectedTxPower, this,
                       m_txPowerDbm);
  Simulator::Schedule (Seconds (2.2), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       ap_device2, sta_device2, m_payloadSize2);
  ...
  Simulator::Schedule (Seconds (2.3), &TestInterBssConstantObssPdAlgo::SetExpectedTxPower, this,
                       m_txPowerDbm);
  // AP2 sends another packet 0.1s later. Power restriction should not be applied.
  Simulator::Schedule (Seconds (2.3), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       ap_device2, sta_device2, m_payloadSize2);
  // STA1 sends a packet 0.1s later. Power restriction should not be applied.
  Simulator::Schedule (Seconds (2.4), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       sta_device1, ap_device1, m_payloadSize1);
  ...
  Simulator::Schedule (Seconds (2.5), &TestInterBssConstantObssPdAlgo::SendOnePacket, this,
                       sta_device2, ap_device2, m_payloadSize2 / 10);
  Simulator::Schedule (Seconds (2.5) + MicroSeconds (15),
                       &TestInterBssConstantObssPdAlgo::SendOnePacket, this, ap_device2,
                       sta_device2, m_payloadSize2 / 10);
  Simulator::Schedule (Seconds (2.5) + MicroSeconds (270),
                       &TestInterBssConstantObssPdAlgo::SendOnePacket, this, ap_device1,
                       sta_device1, m_payloadSize1 / 10);
  Simulator::Schedule (Seconds (2.5) + MicroSeconds (300),
                       &TestInterBssConstantObssPdAlgo::SendOnePacket, this, ap_device3,
                       sta_device3, m_payloadSize3 / 10);
  if (expectPhyReset)
    {
      // In this case, we check the TX power is restricted (and set the expected value slightly before transmission should occur)
      double expectedTxPower = std::min (m_txPowerDbm, 21 - (m_obssPdLevelDbm + 82));
...
TestInterBssConstantObssPdAlgo::CheckResults ()
{
  ...
  NS_TEST_ASSERT_MSG_EQ (m_numSta1PacketsReceived, 2,
                         "The number of packets received by STA1 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_numSta2PacketsReceived, 6,
                         "The number of packets received by STA2 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_numAp1PacketsReceived, 4,
                         "The number of packets received by AP1 is not correct!");
  NS_TEST_ASSERT_MSG_EQ (m_numAp2PacketsReceived, 2,
...
void
TestInterBssConstantObssPdAlgo::SendOnePacket (Ptr<WifiNetDevice> tx_dev, Ptr<WifiNetDevice> rx_dev,
...
void
TestInterBssConstantObssPdAlgo::CheckPhyState (Ptr<WifiNetDevice> device,
    ...
    Ptr<WifiNetDevice> device, std::vector<WifiPhyRxfailureReason> expectedDropReasons)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (currentDropReasons.size (), expectedDropReasons.size (),
  ...
  for (std::size_t i = 0; i < currentDropReasons.size (); ++i)
    {
      NS_TEST_ASSERT_MSG_EQ (
          currentDropReasons[i], expectedDropReasons[i],
          "Drop reason " << i << ": " << currentDropReasons[i] << " does not match expected reason "
                         << expectedDropReasons[i] << " at " << Simulator::Now ());
    }
}
