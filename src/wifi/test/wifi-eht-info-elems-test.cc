...
public:
   ...
   */
  MultiLinkElement
  GetMultiLinkElement (const CommonInfoBasicMle &commonInfo,
...
BasicMultiLinkElementTest::DoRun (void)
{
  ...
  commonInfo.m_mediumSyncDelayInfo = CommonInfoBasicMle::MediumSyncDelayInfo{
      .mediumSyncDuration = 1, .mediumSyncOfdmEdThreshold = 4, .mediumSyncMaxNTxops = 5};
...
WifiEhtInfoElemsTestSuite::WifiEhtInfoElemsTestSuite () : TestSuite ("wifi-eht-info-elems", UNIT)
{
