...
protected:
   ...
   */
  virtual void RxSuccess (Ptr<WifiPsdu> psdu, RxSignalInfo rxSignalInfo, WifiTxVector txVector,
...
WifiPhyThresholdsWeakWifiSignalTest::DoRun (void)
{
  ...
  Simulator::Schedule (Seconds (1), &WifiPhyThresholdsWeakWifiSignalTest::SendSignal, this,
                       txPowerWatts, true);
  ...
  NS_TEST_ASSERT_MSG_EQ (
      ...
      "Reception should not have been triggered if packet is weaker than RxSensitivity threshold");
  NS_TEST_ASSERT_MSG_EQ (
      m_stateChanged, 0,
      "State should stay idle if reception involves a signal weaker than RxSensitivity threshold");
}
...
WifiPhyThresholdsWeakForeignSignalTest::DoRun (void)
{
  ...
  Simulator::Schedule (Seconds (1), &WifiPhyThresholdsWeakForeignSignalTest::SendSignal, this,
                       txPowerWatts, false);
...
WifiPhyThresholdsStrongWifiSignalTest::DoRun (void)
{
  ...
  Simulator::Schedule (Seconds (1), &WifiPhyThresholdsStrongWifiSignalTest::SendSignal, this,
                       txPowerWatts, true);
...
WifiPhyThresholdsStrongForeignSignalTest::DoRun (void)
{
  ...
  Simulator::Schedule (Seconds (1), &WifiPhyThresholdsStrongForeignSignalTest::SendSignal, this,
                       txPowerWatts, false);
...
WifiPhyThresholdsTestSuite::WifiPhyThresholdsTestSuite () : TestSuite ("wifi-phy-thresholds", UNIT)
{
