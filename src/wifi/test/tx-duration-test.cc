...
private:
   ...
   */
  bool CheckPayloadDuration (uint32_t size, WifiMode payloadMode, uint16_t channelWidth,
                             uint16_t guardInterval, WifiPreamble preamble, Time knownDuration);
   ...
   * @return true if values correspond, false otherwise
   */
  bool CheckTxDuration (uint32_t size, WifiMode payloadMode, uint16_t channelWidth,
                        uint16_t guardInterval, WifiPreamble preamble, Time knownDuration);
...
bool
TxDurationTest::CheckPayloadDuration (uint32_t size, WifiMode payloadMode, uint16_t channelWidth,
                                      uint16_t guardInterval, WifiPreamble preamble,
                                      Time knownDuration)
{
...
bool
TxDurationTest::CheckTxDuration (uint32_t size, WifiMode payloadMode, uint16_t channelWidth,
                                 uint16_t guardInterval, WifiPreamble preamble, Time knownDuration)
{
  WifiTxVector txVector;
  txVector.SetMode (payloadMode);
  ...
  for (auto &testedBand : testedBands)
    {
      ...
      Time calculatedDurationUsingList = CalculateTxDurationUsingList (
          std::list<uint32_t>{size}, std::list<uint16_t>{SU_STA_ID}, txVector, testedBand);
                                   ...
                                   WifiPreamble preamble, Time knownDuration)
{
  ...
  std::list<WifiPhyBand> testedBands{
      ...
      WIFI_PHY_BAND_2_4GHZ}; //Durations vary depending on frequency; test also 2.4 GHz (bug 1971)
  for (auto &testedBand : testedBands)
    {
      if (testedBand == WIFI_PHY_BAND_2_4GHZ)
        {
      ...
      if (calculatedDuration != knownDuration || calculatedDuration != calculatedDurationUsingList)
        {
          std::cerr << "size=" << longuestSize << " band=" << testedBand << " staId=" << staId
                    ...
                    << " channelWidth=" << channelWidth << " guardInterval=" << guardInterval
                    << " datarate="
                    << txVector.GetMode (staId).GetDataRate (channelWidth, guardInterval,
...
TxDurationTest::DoRun (void)
{
  ...
  retval = retval &&
           CheckPayloadDuration (1023, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                                 MicroSeconds (744)) &&
           CheckPayloadDuration (1024, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                                 MicroSeconds (745)) &&
           CheckPayloadDuration (1025, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                                 MicroSeconds (746)) &&
           CheckPayloadDuration (1026, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                                 MicroSeconds (747));
  ...
  retval = retval &&
           CheckTxDuration (1023, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (744 + 96)) &&
           CheckTxDuration (1024, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (745 + 96)) &&
           CheckTxDuration (1025, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (746 + 96)) &&
           CheckTxDuration (1026, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (747 + 96)) &&
           CheckTxDuration (1023, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (744 + 192)) &&
           CheckTxDuration (1024, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (745 + 192)) &&
           CheckTxDuration (1025, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (746 + 192)) &&
           CheckTxDuration (1026, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (747 + 192)) &&
           CheckTxDuration (1023, DsssPhy::GetDsssRate5_5Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (1488 + 96)) &&
           CheckTxDuration (1024, DsssPhy::GetDsssRate5_5Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (1490 + 96)) &&
           CheckTxDuration (1025, DsssPhy::GetDsssRate5_5Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (1491 + 96)) &&
           CheckTxDuration (1026, DsssPhy::GetDsssRate5_5Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (1493 + 96)) &&
           CheckTxDuration (1023, DsssPhy::GetDsssRate5_5Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (1488 + 192)) &&
           CheckTxDuration (1024, DsssPhy::GetDsssRate5_5Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (1490 + 192)) &&
           CheckTxDuration (1025, DsssPhy::GetDsssRate5_5Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (1491 + 192)) &&
           CheckTxDuration (1026, DsssPhy::GetDsssRate5_5Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (1493 + 192)) &&
           CheckTxDuration (1023, DsssPhy::GetDsssRate2Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (4092 + 96)) &&
           CheckTxDuration (1024, DsssPhy::GetDsssRate2Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (4096 + 96)) &&
           CheckTxDuration (1025, DsssPhy::GetDsssRate2Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (4100 + 96)) &&
           CheckTxDuration (1026, DsssPhy::GetDsssRate2Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (4104 + 96)) &&
           CheckTxDuration (1023, DsssPhy::GetDsssRate2Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (4092 + 192)) &&
           CheckTxDuration (1024, DsssPhy::GetDsssRate2Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (4096 + 192)) &&
           CheckTxDuration (1025, DsssPhy::GetDsssRate2Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (4100 + 192)) &&
           CheckTxDuration (1026, DsssPhy::GetDsssRate2Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (4104 + 192)) &&
           CheckTxDuration (1023, DsssPhy::GetDsssRate1Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (8184 + 192)) &&
           CheckTxDuration (1024, DsssPhy::GetDsssRate1Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (8192 + 192)) &&
           CheckTxDuration (1025, DsssPhy::GetDsssRate1Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (8200 + 192)) &&
           CheckTxDuration (1026, DsssPhy::GetDsssRate1Mbps (), 22, 800, WIFI_PREAMBLE_SHORT,
                            MicroSeconds (8208 + 192)) &&
           CheckTxDuration (1023, DsssPhy::GetDsssRate1Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (8184 + 192)) &&
           CheckTxDuration (1024, DsssPhy::GetDsssRate1Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (8192 + 192)) &&
           CheckTxDuration (1025, DsssPhy::GetDsssRate1Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (8200 + 192)) &&
           CheckTxDuration (1026, DsssPhy::GetDsssRate1Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (8208 + 192));

  //values from http://mailman.isi.edu/pipermail/ns-developers/2009-July/006226.html
  retval = retval && CheckTxDuration (14, DsssPhy::GetDsssRate1Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                                      MicroSeconds (304));

  //values from http://www.oreillynet.com/pub/a/wireless/2003/08/08/wireless_throughput.html
  retval = retval &&
           CheckTxDuration (1536, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (1310)) &&
           CheckTxDuration (76, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (248)) &&
           CheckTxDuration (14, DsssPhy::GetDsssRate11Mbps (), 22, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (203));
  ...
  //values from http://www.oreillynet.com/pub/a/wireless/2003/08/08/wireless_throughput.html
  retval = retval &&
           CheckTxDuration (1536, OfdmPhy::GetOfdmRate54Mbps (), 20, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (248)) &&
           CheckTxDuration (76, OfdmPhy::GetOfdmRate54Mbps (), 20, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (32)) &&
           CheckTxDuration (14, OfdmPhy::GetOfdmRate54Mbps (), 20, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (24));
  ...
  retval = retval &&
           CheckTxDuration (1536, ErpOfdmPhy::GetErpOfdmRate54Mbps (), 20, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (254)) &&
           CheckTxDuration (76, ErpOfdmPhy::GetErpOfdmRate54Mbps (), 20, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (38)) &&
           CheckTxDuration (14, ErpOfdmPhy::GetErpOfdmRate54Mbps (), 20, 800, WIFI_PREAMBLE_LONG,
                            MicroSeconds (30));
  ...
  retval =
      retval &&
      CheckTxDuration (1536, HtPhy::GetHtMcs7 (), 20, 800, WIFI_PREAMBLE_HT_MF,
                       MicroSeconds (228)) &&
      ...
      CheckTxDuration (1536, HtPhy::GetHtMcs0 (), 20, 400, WIFI_PREAMBLE_HT_MF,
                       NanoSeconds (1742400)) &&
      ...
      CheckTxDuration (14, HtPhy::GetHtMcs0 (), 20, 400, WIFI_PREAMBLE_HT_MF,
                       NanoSeconds (57600)) &&
      CheckTxDuration (1536, HtPhy::GetHtMcs6 (), 20, 400, WIFI_PREAMBLE_HT_MF,
                       NanoSeconds (226800)) &&
      ...
      CheckTxDuration (14, HtPhy::GetHtMcs6 (), 20, 400, WIFI_PREAMBLE_HT_MF,
                       NanoSeconds (39600)) &&
      CheckTxDuration (1536, HtPhy::GetHtMcs7 (), 40, 800, WIFI_PREAMBLE_HT_MF,
                       MicroSeconds (128)) &&
      ...
      CheckTxDuration (1536, HtPhy::GetHtMcs7 (), 40, 400, WIFI_PREAMBLE_HT_MF,
                       NanoSeconds (118800)) &&
  ...
  //802.11ac durations
  retval = retval &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs8 (), 20, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (196)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs8 (), 20, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (48)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs8 (), 20, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (40)) &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs8 (), 20, 400, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (180)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs8 (), 20, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (46800)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs8 (), 20, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (39600)) &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs9 (), 40, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (108)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs9 (), 40, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (40)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs9 (), 40, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (40)) &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs9 (), 40, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (100800)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs9 (), 40, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (39600)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs9 (), 40, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (39600)) &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs0 (), 80, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (460)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs0 (), 80, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (60)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs0 (), 80, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (44)) &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs0 (), 80, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (417600)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs0 (), 80, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (57600)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs0 (), 80, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (43200)) &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs9 (), 80, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (68)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs9 (), 80, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (40)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs9 (), 80, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (40)) &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs9 (), 80, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (64800)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs9 (), 80, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (39600)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs9 (), 80, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (39600)) &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs8 (), 160, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (56)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs8 (), 160, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (40)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs8 (), 160, 800, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (40)) &&
           CheckTxDuration (1536, VhtPhy::GetVhtMcs8 (), 160, 400, WIFI_PREAMBLE_VHT_SU,
                            MicroSeconds (54)) &&
           CheckTxDuration (76, VhtPhy::GetVhtMcs8 (), 160, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (39600)) &&
           CheckTxDuration (14, VhtPhy::GetVhtMcs8 (), 160, 400, WIFI_PREAMBLE_VHT_SU,
                            NanoSeconds (39600));
  ...
  retval =
      retval &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 20, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (1485600)) &&
      ...
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 20, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (71200)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 40, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (764800)) &&
      ...
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 40, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 80, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (397600)) &&
      ...
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 80, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 160, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (220800)) &&
      CheckTxDuration (76, HePhy::GetHeMcs0 (), 160, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 160, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 20, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (1570400)) &&
      CheckTxDuration (76, HePhy::GetHeMcs0 (), 20, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (130400)) &&
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 20, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (72800)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 40, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (807200)) &&
      CheckTxDuration (76, HePhy::GetHeMcs0 (), 40, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (87200)) &&
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 40, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 80, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (418400)) &&
      CheckTxDuration (76, HePhy::GetHeMcs0 (), 80, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (72800)) &&
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 80, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 160, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (231200)) &&
      CheckTxDuration (76, HePhy::GetHeMcs0 (), 160, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 160, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 20, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (1740)) &&
      CheckTxDuration (76, HePhy::GetHeMcs0 (), 20, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (140)) &&
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 20, 3200, WIFI_PREAMBLE_HE_SU, MicroSeconds (76)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 40, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (892)) &&
      ...
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 80, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (460)) &&
      ...
      CheckTxDuration (1536, HePhy::GetHeMcs0 (), 160, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (252)) &&
      CheckTxDuration (76, HePhy::GetHeMcs0 (), 160, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
      CheckTxDuration (14, HePhy::GetHeMcs0 (), 160, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 20, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (139200)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 20, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 20, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 40, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (98400)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 40, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 40, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 80, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (71200)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 80, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 80, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 160, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 160, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 160, 800, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (57600)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 20, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (144800)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 20, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 20, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 40, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (101600)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 40, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 40, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 80, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (72800)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 80, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 80, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 160, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 160, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 160, 1600, WIFI_PREAMBLE_HE_SU,
                       NanoSeconds (58400)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 20, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (156)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 20, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 20, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 40, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (108)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 40, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 40, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 80, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (76)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 80, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
      CheckTxDuration (14, HePhy::GetHeMcs11 (), 80, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
      CheckTxDuration (1536, HePhy::GetHeMcs11 (), 160, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
      CheckTxDuration (76, HePhy::GetHeMcs11 (), 160, 3200, WIFI_PREAMBLE_HE_SU,
                       MicroSeconds (60)) &&
  ...
  retval =
      ...
      CheckMuTxDuration (
          ...
          40, 800, WIFI_PREAMBLE_HE_MU,
          NanoSeconds (1493600)) //equivalent to HE_SU for 20 MHz with 2 extra HE-SIG-B (i.e. 8 us)
      && CheckMuTxDuration (
             std::list<uint32_t>{1536, 1536},
...
HeSigBDurationTest::HeSigBDurationTest () : TestCase ("Check HE-SIG-B duration computation")
{
}
...
HeSigBDurationTest::DoRun (void)
{
  ...
  NS_TEST_EXPECT_MSG_EQ (hePhy->GetSigMode (WIFI_PPDU_FIELD_SIG_B, txVector), VhtPhy::GetVhtMcs5 (),
                         "HE-SIG-B should be sent at MCS 5");
  std::pair<std::size_t, std::size_t> numUsersPerCc = txVector.GetNumRusPerHeSigBContentChannel ();
  NS_TEST_EXPECT_MSG_EQ (numUsersPerCc.first, 2,
                         "Both users should be on HE-SIG-B content channel 1");
  NS_TEST_EXPECT_MSG_EQ (numUsersPerCc.second, 0,
                         "Both users should be on HE-SIG-B content channel 2");
  NS_TEST_EXPECT_MSG_EQ (hePhy->GetDuration (WIFI_PPDU_FIELD_SIG_B, txVector), MicroSeconds (4),
  ...
  NS_TEST_EXPECT_MSG_EQ (hePhy->GetSigMode (WIFI_PPDU_FIELD_SIG_B, txVector), VhtPhy::GetVhtMcs4 (),
  ...
  NS_TEST_EXPECT_MSG_EQ (numUsersPerCc.second, 4,
  ...
  txVector = BuildTxVector (40, userInfos);
  NS_TEST_EXPECT_MSG_EQ (hePhy->GetSigMode (WIFI_PPDU_FIELD_SIG_B, txVector), VhtPhy::GetVhtMcs3 (),
                         "HE-SIG-B should be sent at MCS 3");
  numUsersPerCc = txVector.GetNumRusPerHeSigBContentChannel ();
  NS_TEST_EXPECT_MSG_EQ (numUsersPerCc.first, 2,
                         "Two users should be on HE-SIG-B content channel 1");
  NS_TEST_EXPECT_MSG_EQ (numUsersPerCc.second, 5,
                         "Five users should be on HE-SIG-B content channel 2");
  NS_TEST_EXPECT_MSG_EQ (hePhy->GetDuration (WIFI_PPDU_FIELD_SIG_B, txVector), MicroSeconds (8),
  ...
  NS_TEST_EXPECT_MSG_EQ (hePhy->GetSigMode (WIFI_PPDU_FIELD_SIG_B, txVector), VhtPhy::GetVhtMcs1 (),
                         "HE-SIG-B should be sent at MCS 1");
  numUsersPerCc = txVector.GetNumRusPerHeSigBContentChannel ();
  NS_TEST_EXPECT_MSG_EQ (numUsersPerCc.first, 3,
                         "Three users should be on HE-SIG-B content channel 1");
  NS_TEST_EXPECT_MSG_EQ (numUsersPerCc.second, 6,
                         "Six users should be on HE-SIG-B content channel 2");
  NS_TEST_EXPECT_MSG_EQ (hePhy->GetDuration (WIFI_PPDU_FIELD_SIG_B, txVector), MicroSeconds (16),
  ...
  NS_TEST_EXPECT_MSG_EQ (hePhy->GetSigMode (WIFI_PPDU_FIELD_SIG_B, txVector), VhtPhy::GetVhtMcs1 (),
                         "HE-SIG-B should be sent at MCS 1");
  numUsersPerCc = txVector.GetNumRusPerHeSigBContentChannel ();
  NS_TEST_EXPECT_MSG_EQ (numUsersPerCc.first, 4,
                         "Four users should be on HE-SIG-B content channel 1");
  NS_TEST_EXPECT_MSG_EQ (numUsersPerCc.second, 7,
                         "Seven users should be on HE-SIG-B content channel 2");
  NS_TEST_EXPECT_MSG_EQ (hePhy->GetDuration (WIFI_PPDU_FIELD_SIG_B, txVector), MicroSeconds (20),
...
PhyHeaderSectionsTest::PhyHeaderSectionsTest () : TestCase ("PHY header sections consistency")
{
}
  ...
  for (; itObtained != obtained.end () || itExpected != expected.end ();)
    {
      ...
      NS_TEST_EXPECT_MSG_EQ (
          mode, modeRef, "The expected mode (" << modeRef << ") was not obtained (" << mode << ")");
      ++itObtained;
      ++itExpected;
    }
}
...
PhyHeaderSectionsTest::DoRun (void)
{
  ...
  txVector.SetChannelWidth (20);
  txVector.SetNss (
      2); //HE-LTF duration assumed to be always 8 us for the time being (see note in HePhy::GetTrainingDuration)
  ...
  txVector.SetChannelWidth (20);
  txVector.SetNss (
      2); //EHT-LTF duration assumed to be always 8 us for the time being (see note in HePhy::GetTrainingDuration)
...
TxDurationTestSuite::TxDurationTestSuite () : TestSuite ("wifi-devices-tx-duration", UNIT)
{
