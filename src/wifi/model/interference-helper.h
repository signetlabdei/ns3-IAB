...
public:
   ...
   */
  Event (Ptr<const WifiPpdu> ppdu, const WifiTxVector &txVector, Time duration,
...
public:
   ...
   * \return Event
   */
  Ptr<Event> Add (Ptr<const WifiPpdu> ppdu, const WifiTxVector &txVector, Time duration,
                  RxPowerWattPerChannelBand &rxPower, bool isStartOfdmaRxing = false);
  ...
  CalculatePayloadSnrPer (Ptr<Event> event, uint16_t channelWidth, WifiSpectrumBand band,
   ...
   */
  struct PhyEntity::SnrPer CalculatePhyHeaderSnrPer (Ptr<Event> event, uint16_t channelWidth,
...
protected:
  ...
  double CalculateChunkSuccessRate (double snir, Time duration, WifiMode mode,
                                    const WifiTxVector &txVector, WifiPpduField field) const;
  /**
   ...
   * \return the success rate
   */
  double CalculatePayloadChunkSuccessRate (double snir, Time duration, const WifiTxVector &txVector,
...
private:
   ...
   */
  double CalculatePayloadPer (Ptr<const Event> event, uint16_t channelWidth, NiChangesPerBand *nis,
