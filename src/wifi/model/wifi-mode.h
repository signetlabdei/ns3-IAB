...
public:
   ...
   */
  static WifiMode CreateWifiMode (std::string uniqueName, WifiModulationClass modClass,
  ...
  static WifiMode CreateWifiMcs (std::string uniqueName, uint8_t mcsValue,
                                 WifiModulationClass modClass, bool isMandatory,
...
private:
  ...
  struct WifiModeItem
  {
    ...
    ConstellationSizeCallback
        GetConstellationSizeCallback; ///< Callback to retrieve constellation size of this WifiModeItem
    PhyRateCallback
    ...
    NonHtReferenceRateCallback
        GetNonHtReferenceRateCallback; ///< Callback to calculate non-HT reference rate of this WifiModeItem
    AllowedCallback
