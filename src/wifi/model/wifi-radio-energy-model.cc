...
WifiRadioEnergyModel::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::WifiRadioEnergyModel")
          ...
          .AddAttribute ("CcaBusyCurrentA", "The default radio CCA Busy State current in Ampere.",
          ...
          .AddAttribute ("RxCurrentA", "The radio RX current in Ampere.",
                         ...
                         MakeDoubleChecker<double> ())
          .AddAttribute ("SwitchingCurrentA", "The default radio Channel Switch current in Ampere.",
                         DoubleValue (0.273), // default to be the same as idle mode
...
WifiRadioEnergyModel::SetEnergySource (const Ptr<EnergySource> source)
{
  ...
  m_switchToOffEvent = Simulator::Schedule (durationToOff, &WifiRadioEnergyModel::ChangeState, this,
                                            WifiPhyState::OFF);
}
  ...
  if (newState != WifiPhyState::OFF)
    {
      ...
      m_switchToOffEvent = Simulator::Schedule (durationToOff, &WifiRadioEnergyModel::ChangeState,
...
void
WifiRadioEnergyModelPhyListener::NotifyCcaBusyStart (
    Time duration, WifiChannelListType channelType, const std::vector<Time> & /*per20MhzDurations*/)
{
