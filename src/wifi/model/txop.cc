...
Txop::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::Txop")
          ...
          .AddAttribute (
              "MinCws", "The minimum values of the contention window for all the links",
              TypeId::ATTR_GET | TypeId::ATTR_SET, // do not set at construction time
          ...
          .AddAttribute ("MaxCw",
                         ...
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute (
              "MaxCws", "The maximum values of the contention window for all the links",
              TypeId::ATTR_GET | TypeId::ATTR_SET, // do not set at construction time
              AttributeContainerValue<UintegerValue> (),
          ...
          .AddAttribute (
              "Aifsns", "The values of AIFSN for all the links",
              TypeId::ATTR_GET | TypeId::ATTR_SET, // do not set at construction time
              AttributeContainerValue<UintegerValue> (),
          ...
          .AddAttribute ("TxopLimit",
                         ...
                         MakeTimeChecker ())
          .AddAttribute ("TxopLimits", "The values of TXOP limit for all the links",
                         TypeId::ATTR_GET | TypeId::ATTR_SET, // do not set at construction time
                         AttributeContainerValue<TimeValue> (),
                         MakeAttributeContainerAccessor<TimeValue, std::list> (
                             &Txop::SetTxopLimits, &Txop::GetTxopLimits),
          ...
          .AddTraceSource ("CwTrace", "Trace source for contention window values",
