 ...
 */
typedef Callback<void, Ptr<WifiPsdu>, RxSignalInfo, WifiTxVector, std::vector<bool>> RxOkCallback;
/**
...
public:
   ...
   */
  typedef void (*RxOkTracedCallback) (Ptr<const Packet> packet, double snr, WifiMode mode,
   ...
   */
  typedef void (*TxTracedCallback) (Ptr<const Packet> packet, WifiMode mode, WifiPreamble preamble,
                                    uint8_t power);
