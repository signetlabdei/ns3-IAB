...
public:
   ...
   */
  typedef void (*AgreementStateTracedCallback) (Time now, Mac48Address recipient, uint8_t tid,
...
private:
   ...
   */
  PacketQueueI HandleInFlightMpdu (PacketQueueI mpduIt, MpduStatus status, const AgreementsI &it,
                                   const Time &now);
