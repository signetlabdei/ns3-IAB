...
WifiPpdu::WifiPpdu (Ptr<const WifiPsdu> psdu, const WifiTxVector &txVector, uint16_t txCenterFreq,
...
WifiPpdu::WifiPpdu (const WifiConstPsduMap &psdus, const WifiTxVector &txVector,
                    uint16_t txCenterFreq, uint64_t uid)
    : m_preamble (txVector.GetPreambleType ()),
      m_modulation (txVector.IsValid ()
