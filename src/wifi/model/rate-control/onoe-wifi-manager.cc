  ...
  static TypeId tid =
      TypeId ("ns3::OnoeWifiManager")
          ...
          .AddAttribute ("UpdatePeriod",
                         ...
                         MakeTimeAccessor (&OnoeWifiManager::m_updatePeriod), MakeTimeChecker ())
          ...
          .AddAttribute ("AddCreditThreshold", "Add credit threshold", UintegerValue (10),
...
OnoeWifiManager::OnoeWifiManager () : WifiRemoteStationManager (), m_currentRate (0)
{
...
void
OnoeWifiManager::DoReportRtsOk (WifiRemoteStation *st, double ctsSnr, WifiMode ctsMode,
                                double rtsSnr)
{
