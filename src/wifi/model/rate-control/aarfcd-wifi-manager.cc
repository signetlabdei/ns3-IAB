  ...
  static TypeId tid =
      TypeId ("ns3::AarfcdWifiManager")
          ...
          .AddAttribute ("SuccessK",
                         ...
                         DoubleValue (2.0), MakeDoubleAccessor (&AarfcdWifiManager::m_successK),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("TimerK",
                         "Multiplication factor for the timer threshold in the AARF algorithm.",
                         DoubleValue (2.0), MakeDoubleAccessor (&AarfcdWifiManager::m_timerK),
                         MakeDoubleChecker<double> ())
          ...
          .AddAttribute ("MinSuccessThreshold",
                         ...
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("MinRtsWnd", "Minimum value for RTS window of AARF-CD", UintegerValue (1),
                         MakeUintegerAccessor (&AarfcdWifiManager::m_minRtsWnd),
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("MaxRtsWnd", "Maximum value for RTS window of AARF-CD", UintegerValue (40),
...
AarfcdWifiManager::AarfcdWifiManager () : WifiRemoteStationManager (), m_currentRate (0)
{
...
void
AarfcdWifiManager::DoReportRtsOk (WifiRemoteStation *st, double ctsSnr, WifiMode ctsMode,
                                  double rtsSnr)
{
