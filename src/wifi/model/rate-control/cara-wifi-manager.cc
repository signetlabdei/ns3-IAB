  ...
  static TypeId tid =
      TypeId ("ns3::CaraWifiManager")
          ...
          .AddAttribute (
              ...
              UintegerValue (1), MakeUintegerAccessor (&CaraWifiManager::m_probeThreshold),
          ...
          .AddAttribute ("SuccessThreshold",
                         ...
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("Timeout", "The 'timer' in the CARA algorithm", UintegerValue (15),
...
CaraWifiManager::CaraWifiManager () : WifiRemoteStationManager (), m_currentRate (0)
{
...
void
CaraWifiManager::DoReportRtsOk (WifiRemoteStation *st, double ctsSnr, WifiMode ctsMode,
                                double rtsSnr)
{
