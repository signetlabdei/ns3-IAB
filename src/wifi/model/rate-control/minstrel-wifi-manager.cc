  ...
  static TypeId tid =
      TypeId ("ns3::MinstrelWifiManager")
          ...
          .AddAttribute ("UpdateStatistics", "The interval between updating statistics table",
                         ...
                         MakeTimeAccessor (&MinstrelWifiManager::m_updateStats), MakeTimeChecker ())
          .AddAttribute ("LookAroundRate", "The percentage to try other rates", UintegerValue (10),
          ...
          .AddAttribute ("SampleColumn", "The number of columns used for sampling",
                         ...
                         MakeUintegerChecker<uint8_t> ())
          .AddAttribute ("PacketLength", "The packet length used for calculating mode TxTime",
                         UintegerValue (1200),
                         MakeUintegerAccessor (&MinstrelWifiManager::m_pktLen),
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("PrintStats", "Print statistics table", BooleanValue (false),
                         MakeBooleanAccessor (&MinstrelWifiManager::m_printStats),
                         MakeBooleanChecker ())
          .AddAttribute ("PrintSamples", "Print samples table", BooleanValue (false),
...
MinstrelWifiManager::MinstrelWifiManager () : WifiRemoteStationManager (), m_currentRate (0)
{
...
void
MinstrelWifiManager::DoReportRtsOk (WifiRemoteStation *st, double ctsSnr, WifiMode ctsMode,
                                    double rtsSnr)
{
...
bool
MinstrelWifiManager::DoNeedRetransmission (WifiRemoteStation *st, Ptr<const Packet> packet,
                                           bool normally)
{
...
Time
MinstrelWifiManager::CalculateTimeUnicastPacket (Time dataTransmissionTime, uint32_t shortRetries,
