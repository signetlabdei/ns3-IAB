  ...
  static TypeId tid =
      TypeId ("ns3::ParfWifiManager")
          ...
          .AddAttribute (
              ...
              UintegerValue (10), MakeUintegerAccessor (&ParfWifiManager::m_successThreshold),
              MakeUintegerChecker<uint32_t> ())
...
ParfWifiManager::DoCreateStation (void) const
{
  ...
  NS_LOG_DEBUG ("create station=" << station << ", timer=" << station->m_nAttempt << ", rate="
...
void
ParfWifiManager::DoReportRtsOk (WifiRemoteStation *station, double ctsSnr, WifiMode ctsMode,
                                double rtsSnr)
{
...
void
ParfWifiManager::DoReportDataOk (WifiRemoteStation *st, double ackSnr, WifiMode ackMode,
