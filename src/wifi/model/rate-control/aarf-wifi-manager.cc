  ...
  static TypeId tid =
      TypeId ("ns3::AarfWifiManager")
          ...
          .AddAttribute ("SuccessK",
                         ...
                         DoubleValue (2.0), MakeDoubleAccessor (&AarfWifiManager::m_successK),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("TimerK",
                         "Multiplication factor for the timer threshold in the AARF algorithm.",
                         DoubleValue (2.0), MakeDoubleAccessor (&AarfWifiManager::m_timerK),
                         MakeDoubleChecker<double> ())
...
AarfWifiManager::AarfWifiManager () : WifiRemoteStationManager (), m_currentRate (0)
{
...
void
AarfWifiManager::DoReportRtsOk (WifiRemoteStation *station, double ctsSnr, WifiMode ctsMode,
                                double rtsSnr)
{
