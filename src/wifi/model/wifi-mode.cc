...
WifiMode::WifiMode () : m_uid (0)
{
}

WifiMode::WifiMode (uint32_t uid) : m_uid (uid)
{
}
...
WifiMode
WifiModeFactory::CreateWifiMode (std::string uniqueName, WifiModulationClass modClass,
...
WifiMode
WifiModeFactory::CreateWifiMcs (std::string uniqueName, uint8_t mcsValue,
