...
bool
WifiNoAck::CheckQosAckPolicy (Mac48Address receiver, uint8_t tid,
...
bool
WifiNormalAck::CheckQosAckPolicy (Mac48Address receiver, uint8_t tid,
                                  WifiMacHeader::QosAckPolicy ackPolicy) const
{
...
bool
WifiBlockAck::CheckQosAckPolicy (Mac48Address receiver, uint8_t tid,
                                 WifiMacHeader::QosAckPolicy ackPolicy) const
{
  if (ackPolicy == WifiMacHeader::NORMAL_ACK)
    {
...
bool
WifiBarBlockAck::CheckQosAckPolicy (Mac48Address receiver, uint8_t tid,
                                    WifiMacHeader::QosAckPolicy ackPolicy) const
{
...
WifiDlMuBarBaSequence::WifiDlMuBarBaSequence () : WifiAcknowledgment (DL_MU_BAR_BA_SEQUENCE)
{
}
...
WifiDlMuTfMuBar::WifiDlMuTfMuBar () : WifiAcknowledgment (DL_MU_TF_MU_BAR), ulLength (0)
{
}
...
WifiDlMuAggregateTf::WifiDlMuAggregateTf () : WifiAcknowledgment (DL_MU_AGGREGATE_TF), ulLength (0)
{
}
...
WifiAckAfterTbPpdu::WifiAckAfterTbPpdu () : WifiAcknowledgment (ACK_AFTER_TB_PPDU)
{
}
