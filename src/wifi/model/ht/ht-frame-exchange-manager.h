...
public:
   ...
   */
  bool IsWithinLimitsIfAddMpdu (Ptr<const WifiMacQueueItem> mpdu, const WifiTxParameters &txParams,
...
protected:
   ...
   */
  virtual Ptr<WifiPsdu> GetWifiPsdu (Ptr<WifiMacQueueItem> mpdu,
   ...
   * \return true if frame is transmitted, false otherwise
   */
  virtual bool SendDataFrame (Ptr<const WifiMacQueueItem> peekedItem, Time availableTime,
                              bool initialFrame);
