...
OfdmPpdu::OfdmPpdu (Ptr<const WifiPsdu> psdu, const WifiTxVector &txVector, uint16_t txCenterFreq,
                    WifiPhyBand band, uint64_t uid, bool instantiateLSig /* = true */)
...
OfdmPpdu::LSigHeader::LSigHeader () : m_rate (0b1101), m_length (0)
{
}
