...
protected:
   ...
   * \return the data bit rate of this signal in bps.
   */
  static uint64_t CalculateDataRate (WifiCodeRate codeRate, uint16_t constellationSize,
...
private:
  ...
  static const ModulationLookupTable
      m_ofdmModulationLookupTable; //!< lookup table to retrieve code rate and constellation size corresponding to a unique name of modulation
}; //class OfdmPhy
