...
GetErpOfdmRatesBpsList (void)
{
  return s_erpOfdmRatesBpsList;
};

ErpOfdmPhy::ErpOfdmPhy () : OfdmPhy (OFDM_PHY_DEFAULT, false) //don't add OFDM modes to list
{
...
Ptr<WifiPpdu>
ErpOfdmPhy::BuildPpdu (const WifiConstPsduMap &psdus, const WifiTxVector &txVector,
                       Time /* ppduDuration */)
{
