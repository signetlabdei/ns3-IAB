...
const PhyEntity::PpduFormats DsssPhy::m_dsssPpduFormats{
    {WIFI_PREAMBLE_LONG,
     {WIFI_PPDU_FIELD_PREAMBLE, //PHY preamble
      WIFI_PPDU_FIELD_NON_HT_HEADER, //PHY header
      WIFI_PPDU_FIELD_DATA}},
    {WIFI_PREAMBLE_SHORT,
     {WIFI_PPDU_FIELD_PREAMBLE, //Short PHY preamble
...
Time
DsssPhy::GetPayloadDuration (uint32_t size, const WifiTxVector &txVector, WifiPhyBand /* band */,
...
Ptr<SpectrumValue>
DsssPhy::GetTxPowerSpectralDensity (double txPowerW, Ptr<const WifiPpdu> /* ppdu */,
                                    const WifiTxVector &txVector) const
{
  ...
  Ptr<SpectrumValue> v = WifiSpectrumValueHelper::CreateDsssTxPowerSpectralDensity (
...
public:
  ConstructorDsss ()
  {
    ...
    ns3::WifiPhy::AddStaticPhyEntity (ns3::WIFI_MOD_CLASS_DSSS,
