...
WifiPhyOperatingChannel::WifiPhyOperatingChannel (ConstIterator it)
    : m_channelIt (it), m_primary20Index (0)
{
...
uint8_t
WifiPhyOperatingChannel::GetDefaultChannelNumber (uint16_t width, WifiStandard standard,
                                                  WifiPhyBand band)
{
...
WifiPhyOperatingChannel::FindFirst (uint8_t number, uint16_t frequency, uint16_t width,
                                    WifiStandard standard, WifiPhyBand band, ConstIterator start)
{
