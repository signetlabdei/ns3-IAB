...
DsssSigHeader::DsssSigHeader () : m_rate (0b00001010), m_length (0)
{
}
...
LSigHeader::LSigHeader () : m_rate (0b1101), m_length (0)
{
}
...
HtSigHeader::HtSigHeader ()
    : m_mcs (0), m_cbw20_40 (0), m_htLength (0), m_aggregation (0), m_sgi (0)
{
}
...
HtSigHeader::Print (std::ostream &os) const
{
  os << "MCS=" << +m_mcs << " HT_LENGTH=" << m_htLength << " CHANNEL_WIDTH=" << GetChannelWidth ()
     << " FEC_CODING=" << (m_fecCoding ? "LDPC" : "BCC") << " SGI=" << +m_sgi
...
VhtSigHeader::VhtSigHeader ()
    : m_bw (0), m_nsts (0), m_sgi (0), m_sgi_disambiguation (0), m_suMcs (0), m_mu (false)
{
}
...
VhtSigHeader::Print (std::ostream &os) const
{
  os << "SU_MCS=" << +m_suMcs << " CHANNEL_WIDTH=" << GetChannelWidth () << " SGI=" << +m_sgi
     << " NSTS=" << +m_nsts << " CODING=" << (m_coding ? "LDPC" : "BCC") << " MU=" << +m_mu;
}
...
HeSigHeader::Print (std::ostream &os) const
{
  os << "MCS=" << +m_mcs << " CHANNEL_WIDTH=" << GetChannelWidth () << " GI=" << GetGuardInterval ()
     ...
     << " CODING=" << (m_coding ? "LDPC" : "BCC") << " MU=" << +m_mu;
}
