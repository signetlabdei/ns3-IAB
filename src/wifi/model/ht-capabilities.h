...
private:
  ...
  uint8_t
      m_noncompressedSteeringNBfAntennasSupported; ///< non compressed steering NBF antenna supported
  ...
  uint8_t
      m_explicitCsiFeedbackBasedTxASelCapable; ///< explicit CSI feedback based transmit antenna selection capable
  uint8_t
      m_antennaIndicesFeedbackBasedTxASelCapable; ///< antenna indices feedback based transmit antenna selection capable
