...
WifiTxVector::WifiTxVector (WifiMode mode, uint8_t powerLevel, WifiPreamble preamble,
                            uint16_t guardInterval, uint8_t nTx, uint8_t nss, uint8_t ness,
                            uint16_t channelWidth, bool aggregation, bool stbc, bool ldpc,
                            uint8_t bssColor, uint16_t length)
    : m_mode (mode),
...
WifiTxVector::GetNumRusPerHeSigBContentChannel (void) const
{
  ...
  switch (m_channelWidth)
    ...
    case 80:
      ...
      toneRangesContentChannel1.push_back (
    ...
    case 160:
      ...
      toneRangesContentChannel1.push_back (std::make_pair (
          -528,
          -516)); //first part of center carrier of lower 80 MHz band (in HE-SIG-B content channel 1)
      toneRangesContentChannel1.push_back (std::make_pair (
          -508,
          -496)); //second part of center carrier of lower 80 MHz band (in HE-SIG-B content channel 1)
      ...
      toneRangesContentChannel2.push_back (std::make_pair (
          496,
          508)); //first part of center carrier of upper 80 MHz band (in HE-SIG-B content channel 2)
      toneRangesContentChannel2.push_back (std::make_pair (
          516,
          528)); //second part of center carrier of upper 80 MHz band (in HE-SIG-B content channel 2)
