...
protected:
   ...
   */
  ofpbuf *BufferFromPacket (Ptr<const Packet> packet, Address src, Address dst, int mtu,
                            uint16_t protocol);
...
private:
   ...
   */
  void FlowTableLookup (sw_flow_key key, ofpbuf *buffer, uint32_t packet_uid, int port,
