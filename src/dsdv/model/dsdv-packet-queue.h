...
public:
  ...
  QueueEntry (Ptr<const Packet> pa = 0, Ipv4Header const &h = Ipv4Header (),
      ...
      : m_packet (pa), m_header (h), m_ucb (ucb), m_ecb (ecb), m_expire (Seconds (0))
  {
  }
  ...
  GetUnicastForwardCallback () const
  {
    return m_ucb;
  }
  /**
   ...
   */
  void
  SetUnicastForwardCallback (UnicastForwardCallback ucb)
  {
    m_ucb = ucb;
  }
  /**
   ...
   */
  void
  SetErrorCallback (ErrorCallback ecb)
  {
    m_ecb = ecb;
  }
  /**
...
public:
   ...
   */
  void
  SetMaxPacketsPerDst (uint32_t len)
  {
    m_maxLenPerDst = len;
  }
  /**
