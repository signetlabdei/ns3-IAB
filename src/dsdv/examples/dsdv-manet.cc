...
public:
   ...
   */
  void CaseRun (uint32_t nWifis, uint32_t nSinks, double totalTime, std::string rate,
...
DsdvManetExample::DsdvManetExample () : bytesTotal (0), packetsReceived (0)
{
}
...
DsdvManetExample::CaseRun (uint32_t nWifis, uint32_t nSinks, double totalTime, std::string rate,
                           std::string phyMode, uint32_t nodeSpeed, uint32_t periodicUpdateInterval,
                           uint32_t settlingTime, double dataStart, bool printRoutes,
