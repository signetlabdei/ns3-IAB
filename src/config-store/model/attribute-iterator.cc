...
void
AttributeIterator::DoStartVisitPointerAttribute (Ptr<Object> object, std::string name,
                                                 Ptr<Object> item)
{
}
void
...
void
AttributeIterator::DoStartVisitArrayAttribute (Ptr<Object> object, std::string name,
...
void
AttributeIterator::DoStartVisitArrayItem (const ObjectPtrContainerValue &vector, uint32_t index,
                                          Ptr<Object> item)
{
}
void
...
void
AttributeIterator::StartVisitPointerAttribute (Ptr<Object> object, std::string name,
                                               Ptr<Object> value)
{
  m_currentPath.push_back (name);
...
void
AttributeIterator::StartVisitArrayAttribute (Ptr<Object> object, std::string name,
                                             const ObjectPtrContainerValue &vector)
{
  m_currentPath.push_back (name);
...
void
AttributeIterator::StartVisitArrayItem (const ObjectPtrContainerValue &vector, uint32_t index,
                                        Ptr<Object> item)
{
  std::ostringstream oss;
  oss << index;
