...
private:
   ...
   */
  virtual void DoStartVisitPointerAttribute (Ptr<Object> object, std::string name,
                                             Ptr<Object> value);
  /**
   ...
   */
  virtual void DoStartVisitArrayItem (const ObjectPtrContainerValue &vector, uint32_t index,
                                      Ptr<Object> item);
  /**
   ...
   * \param [in] item the array item to visit
   */
  void StartVisitArrayItem (const ObjectPtrContainerValue &vector, uint32_t index,
                            Ptr<Object> item);
  /**
   * End the visit to the array item
   */
