 ...
 */
gboolean cell_tooltip_callback (GtkWidget *widget, gint x, gint y, gboolean keyboard_tip,
 ...
 */
gboolean clean_model_callback (GtkTreeModel *model, GtkTreePath *path, GtkTreeIter *iter,
                               gpointer data);
 ...
 * \param user_data Pointer to the data to be displayed (or modified)
 */
void cell_data_function_col_1_config_default (GtkTreeViewColumn *col, GtkCellRenderer *renderer,
 ...
 * \param user_data Pointer to the data to be displayed (or modified)
 */
void cell_data_function_col_0_config_default (GtkTreeViewColumn *col, GtkCellRenderer *renderer,
                                              GtkTreeModel *model, GtkTreeIter *iter,
                                              gpointer user_data);
/**
 ...
 *  \param user_data user data
 */
void cell_edited_callback_config_default (GtkCellRendererText *cell, gchar *path_string,
 ...
 * \return true if an error occurred.
 */
gboolean clean_model_callback_config_default (GtkTreeModel *model, GtkTreePath *path,
