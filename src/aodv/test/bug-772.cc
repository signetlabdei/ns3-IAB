...
// UdpChainTest
//-----------------------------------------------------------------------------
Bug772ChainTest::Bug772ChainTest (const char *const prefix, const char *const proto, Time t,
                                  uint32_t size)
...
Bug772ChainTest::CreateNodes ()
{
  ...
  mobility.SetPositionAllocator ("ns3::GridPositionAllocator", "MinX", DoubleValue (0.0), "MinY",
                                 ...
                                 DoubleValue (0), "GridWidth", UintegerValue (m_size), "LayoutType",
...
Bug772ChainTest::CreateDevices ()
{
  ...
  wifi.SetRemoteStationManager ("ns3::ConstantRateWifiManager", "DataMode",
                                ...
                                StringValue ("2200"), "MaxSlrc", UintegerValue (7));
  ...
  NS_TEST_ASSERT_MSG_EQ (streamsUsed, ((devices.GetN () * 3) + (3 * m_size) + m_size),
                         "Stream assignment mismatch");
