...
public:
   ...
   */
  RoutingTableEntry (Ptr<NetDevice> dev = 0, Ipv4Address dst = Ipv4Address (), bool vSeqNo = false,
                     uint32_t seqNo = 0, Ipv4InterfaceAddress iface = Ipv4InterfaceAddress (),
   ...
   */
  void
  SetOutputDevice (Ptr<NetDevice> dev)
  {
   ...
   */
  bool
  operator== (Ipv4Address const dst) const
  {
