...
TrafficControlLayer::TrafficControlLayer () : Object ()
{
...
void
TrafficControlLayer::RegisterProtocolHandler (Node::ProtocolHandler handler, uint16_t protocolType,
...
void
TrafficControlLayer::Receive (Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol,
                              ...
                              NetDevice::PacketType packetType)
{
  ...
  NS_ABORT_MSG_IF (!found, "Handler for protocol "
                               << p << " and device " << device
