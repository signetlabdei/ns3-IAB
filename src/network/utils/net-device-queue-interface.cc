...
NetDeviceQueueInterface::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::NetDeviceQueueInterface")
          ...
          .AddAttribute ("TxQueuesType", "The type of transmission queues to be used",
                         TypeId::ATTR_CONSTRUCT, TypeIdValue (NetDeviceQueue::GetTypeId ()),
          ...
          .AddAttribute ("NTxQueues", "The number of device transmission queues",
                         TypeId::ATTR_GET | TypeId::ATTR_CONSTRUCT, UintegerValue (1),
