...
RadiotapHeader::Print (std::ostream &os) const
{
  ...
  os << " tsft=" << m_tsft << " flags=" << std::hex << m_flags << std::dec << " rate=" << +m_rate
     ...
     << " signal=" << +m_antennaSignal << " noise=" << +m_antennaNoise << " mcsKnown=" << m_mcsKnown
     << " mcsFlags=" << m_mcsFlags << " mcsRate=" << m_mcsRate
     ...
     << " vhtPartialAid=" << m_vhtPartialAid << " heData1=" << m_heData1 << " heData2=" << m_heData2
     << " heData3=" << m_heData3 << " heData4=" << m_heData4 << " heData5=" << m_heData5
     << " heData6=" << m_heData6 << " heMuFlags1=" << m_heMuFlags1 << " heMuFlags2=" << m_heMuFlags2
     << " heMuPerUser1=" << m_heMuPerUser1 << " heMuPerUser2=" << m_heMuPerUser2
...
void
RadiotapHeader::SetVhtFields (uint16_t known, uint8_t flags, uint8_t bandwidth, uint8_t mcs_nss[4],
                              uint8_t coding, uint8_t group_id, uint16_t partial_aid)
{
...
void
RadiotapHeader::SetHeFields (uint16_t data1, uint16_t data2, uint16_t data3, uint16_t data4,
...
void
RadiotapHeader::SetHeMuFields (uint16_t flags1, uint16_t flags2,
...
void
RadiotapHeader::SetHeMuPerUserFields (uint16_t perUser1, uint16_t perUser2, uint8_t perUserPosition,
