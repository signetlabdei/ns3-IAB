...
PacketSocket::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::PacketSocket")
          ...
          .AddAttribute ("RcvBufSize", "PacketSocket maximum receive buffer size (bytes)",
                         UintegerValue (131072), MakeUintegerAccessor (&PacketSocket::m_rcvBufSize),
...
void
PacketSocket::ForwardUp (Ptr<NetDevice> device, Ptr<const Packet> packet, uint16_t protocol,
