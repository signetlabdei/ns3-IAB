...
void
PacketCounterCalculator::FrameUpdate (std::string path, Ptr<const Packet> packet,
                                      Mac48Address realto)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
PacketSizeMinMaxAvgTotalCalculator::FrameUpdate (std::string path, Ptr<const Packet> packet,
                                                 Mac48Address realto)
{
  NS_LOG_FUNCTION_NOARGS ();
