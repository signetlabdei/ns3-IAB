...
SimpleNetDevice::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::SimpleNetDevice")
          ...
          .AddAttribute ("PointToPointMode", "The device is configured in Point to Point mode",
                         BooleanValue (false),
          ...
          .AddAttribute ("DataRate",
                         ...
                         MakeDataRateAccessor (&SimpleNetDevice::m_bps), MakeDataRateChecker ())
...
SimpleNetDevice::SimpleNetDevice ()
    : m_channel (nullptr), m_node (nullptr), m_mtu (0xffff), m_ifIndex (0), m_linkUp (false)
{
...
bool
SimpleNetDevice::SendFrom (Ptr<Packet> p, const Address &source, const Address &dest,
