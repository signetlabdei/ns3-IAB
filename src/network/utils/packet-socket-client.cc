  ...
  static TypeId tid =
      TypeId ("ns3::PacketSocketClient")
          ...
          .AddAttribute (
              ...
              UintegerValue (100), MakeUintegerAccessor (&PacketSocketClient::m_maxPackets),
              MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("Interval", "The time to wait between packets", TimeValue (Seconds (1.0)),
                         MakeTimeAccessor (&PacketSocketClient::m_interval), MakeTimeChecker ())
          .AddAttribute ("PacketSize", "Size of packets generated (bytes).", UintegerValue (1024),
                         MakeUintegerAccessor (&PacketSocketClient::m_size),
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("Priority", "Priority assigned to the packets generated.",
                         UintegerValue (0),
