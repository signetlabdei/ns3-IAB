...
ByteTagList::Iterator::Iterator (uint8_t *start, uint8_t *end, int32_t offsetStart,
...
ByteTagList::ByteTagList ()
    : m_minStart (INT32_MAX), m_maxEnd (INT32_MIN), m_adjustment (0), m_used (0), m_data (nullptr)
{
  NS_LOG_FUNCTION (this);
}
