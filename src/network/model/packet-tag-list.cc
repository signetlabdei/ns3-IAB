...
bool
PacketTagList::RemoveWriter (Tag &tag, bool preMerge, struct PacketTagList::TagData *cur,
...
bool
PacketTagList::ReplaceWriter (Tag &tag, bool preMerge, struct PacketTagList::TagData *cur,
                              struct PacketTagList::TagData **prevNext)
{
  NS_LOG_FUNCTION_NOARGS ();
