...
PacketTagIterator::PacketTagIterator (const struct PacketTagList::TagData *head) : m_current (head)
{
}
...
PacketTagIterator::Item::Item (const struct PacketTagList::TagData *data) : m_data (data)
{
}
