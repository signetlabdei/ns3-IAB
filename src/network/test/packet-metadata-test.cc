...
HistoryHeaderBase::HistoryHeaderBase () : m_ok (true)
{
}
...
template <int N>
HistoryHeader<N>::HistoryHeader () : HistoryHeaderBase ()
{
}
...
HistoryTrailerBase::HistoryTrailerBase () : m_ok (true)
{
}
...
PacketMetadataTest::PacketMetadataTest () : TestCase ("Packet metadata")
{
}
...
PacketMetadataTest::DoRun ()
{
  ...
  delete[] buf;
  NS_TEST_EXPECT_MSG_EQ (msg, std::string ("hello world"),
...
PacketMetadataTestSuite::PacketMetadataTestSuite () : TestSuite ("packet-metadata", UNIT)
{
