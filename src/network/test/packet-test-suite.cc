...
public:
  ...
  void
  Serialize (TagBuffer buf) const override
  {
    buf.WriteU8 (m_data);
  ...
  void
  Deserialize (TagBuffer buf) override
  {
    m_data = buf.ReadU8 ();
    for (uint32_t i = 0; i < N; ++i)
      {
...
public:
  ...
  void
  Serialize (Buffer::Iterator iter) const override
  {
    for (uint32_t i = 0; i < N; ++i)
      {
        iter.WriteU8 (N);
  ...
  uint32_t
  Deserialize (Buffer::Iterator iter) override
  {
    for (uint32_t i = 0; i < N; ++i)
      {
...
PacketTest::DoRun ()
{
  ...
  CHECK (frag1, 6, E (1, 0, 90), E (2, 0, 90), E (4, 0, 90), E (1, 90, 990), E (2, 90, 990),
         E (5, 90, 990));

  CHECK (frag0, 3, E (1, 0, 10), E (2, 0, 10), E (3, 0, 10));
  frag0->AddAtEnd (frag1);
  CHECK (frag0, 9, E (1, 0, 10), E (2, 0, 10), E (3, 0, 10), E (1, 10, 100), E (2, 10, 100),
         E (4, 10, 100), E (1, 100, 1000), E (2, 100, 1000), E (5, 100, 1000));
