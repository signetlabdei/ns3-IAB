  ...
  GetTypeId ()
  {
    static TypeId tid =
        TypeId ("ns3::SequenceNumberTestObj")
            .SetParent<Object> ()
            .AddTraceSource (
                "TestTracedSequenceNumber", "A traceable sequence number",
...
SequenceNumberTestCase::SequenceNumberTestCase () : TestCase ("Sequence number test case")
{
  m_oldval = 0;
  m_newval = 0;
}
...
#define SEQ_TEST_ASSERT(a) NS_TEST_ASSERT_MSG_EQ (bool (a), true, "foo")
...

  {
    SEQ_TEST_ASSERT_EQUAL (
        (SequenceNumber16 (1000) + SequenceNumber16 (6000)) - SequenceNumber16 (1000), 6000);
    SEQ_TEST_ASSERT_EQUAL (
        (SequenceNumber16 (60000) + SequenceNumber16 (6000)) - SequenceNumber16 (60000), 6000);
    SEQ_TEST_ASSERT_EQUAL (SequenceNumber16 (1000) - SequenceNumber16 (6000), -5000);
    SEQ_TEST_ASSERT_EQUAL (
        (SequenceNumber16 (60000) + SequenceNumber16 (1000)) - SequenceNumber16 (65000), -4000);
  }
