...
LollipopCounterTest::LollipopCounterTest () : TestCase ("Lollipop Counter implementation")
{
}
...
LolipopCounterTestSuite::LolipopCounterTestSuite () : TestSuite ("lollipop-counter", UNIT)
{
