...
BitSerializerTest::BitSerializerTest () : TestCase ("BitSerializer")
{
}
...
BitDeserializerTest::BitDeserializerTest () : TestCase ("BitDeserializer")
{
}
...
BitSerializerTestSuite::BitSerializerTestSuite () : TestSuite ("bit-serializer", UNIT)
{
