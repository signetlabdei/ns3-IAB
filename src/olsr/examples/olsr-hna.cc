...
main (int argc, char *argv[])
{
  ...
  if (assocMethod1)
    {
      ...
      hnaEntries->AddNetworkRouteTo (Ipv4Address ("172.16.1.0"), Ipv4Mask ("255.255.255.0"),
  ...
  Simulator::ScheduleWithContext (source->GetNode ()->GetId (), Seconds (15.0), &GenerateTraffic,
