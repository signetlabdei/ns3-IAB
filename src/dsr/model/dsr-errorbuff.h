...
public:
   ...
   */
  DsrErrorBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address d = Ipv4Address (),
   ...
   */
  bool
  operator== (DsrErrorBuffEntry const &o) const
  {
