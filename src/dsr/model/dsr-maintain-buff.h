...
struct LinkKey
{
   ...
   */
  bool
  operator<(const LinkKey &o) const
  {
...
struct NetworkKey
{
   ...
   */
  bool
  operator<(const NetworkKey &o) const
  {
...
struct PassiveKey
{
   ...
   */
  bool
  operator<(const PassiveKey &o) const
  {
    if (m_ackId < o.m_ackId)
      {
        return true;
...
public:
  ...
  DsrMaintainBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address us = Ipv4Address (),
                        Ipv4Address n = Ipv4Address (), Ipv4Address s = Ipv4Address (),
                        Ipv4Address dst = Ipv4Address (), uint16_t ackId = 0, uint8_t segs = 0,
...
public:
   ...
   */
  Time
  GetMaintainBufferTimeout () const
  {
   ...
   */
  void
  SetMaintainBufferTimeout (Time t)
  {
