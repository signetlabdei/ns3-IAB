...
public:
   ...
   */
  void
  SetLinkStability (Time linkStab)
  {
...
public:
   ...
   */
  void
  SetNodeStability (Time nodeStab)
  {
...
public:
   ...
   */
  DsrRouteCacheEntry (IP_VECTOR const &ip = IP_VECTOR (), Ipv4Address dst = Ipv4Address (),
   ...
   */
  bool
  operator== (DsrRouteCacheEntry const &o) const
  {
...
public:
   ...
   */
  void
  SetMaxEntriesEachDst (uint32_t entries)
  {
   ...
   */
  void
  SetStabilityDecrFactor (uint64_t decrFactor)
  {
   ...
   */
  void
  SetStabilityIncrFactor (uint64_t incrFactor)
  {
   ...
   */
  void
  SetInitStability (Time initStability)
  {
   ...
   */
  void
  SetMinLifeTime (Time minLifeTime)
  {
   ...
   */
  void
  SetCallback (Callback<void, Ipv4Address, uint8_t> cb)
  {
...
private:
  ...
  uint32_t
      m_maxCacheLen; ///< The maximum number of packets that we allow a routing protocol to buffer.
  Time
      RouteCacheTimeout; ///< The maximum period of time that dsr is allowed to for an unused route.
