...
public:
   ...
   */
  bool
  operator== (DsrReceivedRreqEntry const &o) const
  {
...
public:
   ...
   */
  void
  SetUniqueRreqIdSize (uint32_t uid)
  {
    m_maxRreqId = uid;
  }
  /**
...
private:
  ...
  struct IsExpired
  {
     ...
     */
    bool
    operator() (const struct BlackList &b) const
    {
