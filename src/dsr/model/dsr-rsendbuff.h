...
public:
  ...
  DsrSendBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address d = Ipv4Address (),
      ...
      : m_packet (pa), m_dst (d), m_expire (exp + Simulator::Now ()), m_protocol (p)
  {
  }
  /**
   ...
   */
  bool
  operator== (DsrSendBuffEntry const &o) const
  {
...
private:
  ...
  Time
      m_sendBufferTimeout; ///< The maximum period of time that a routing protocol is allowed to buffer a packet for, seconds.
};
/*******************************************************************************************************************************/
} // namespace dsr
} // namespace ns3
