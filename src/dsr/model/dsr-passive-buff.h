...
public:
   ...
   */
  DsrPassiveBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address d = Ipv4Address (),
                       Ipv4Address s = Ipv4Address (), Ipv4Address n = Ipv4Address (),
                       uint16_t i = 0, uint16_t f = 0, uint8_t seg = 0,
   ...
   */
  bool
  operator== (DsrPassiveBuffEntry const &o) const
  {
    return ((m_packet == o.m_packet) && (m_source == o.m_source) && (m_nextHop == o.m_nextHop) &&
            (m_dst == o.m_dst) && (m_expire == o.m_expire));
  }
...
public:
   ...
   */
  void
  SetPassiveBufferTimeout (Time t)
  {
...
private:
  ...
  static bool
  LinkEqual (DsrPassiveBuffEntry en, const std::vector<Ipv4Address> link)
  {
