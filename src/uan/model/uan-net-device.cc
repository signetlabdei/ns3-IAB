...
UanNetDevice::UanNetDevice () : NetDevice (), m_mtu (64000), m_cleared (false)
{
}
...
UanNetDevice::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::UanNetDevice")
          ...
          .AddAttribute (
              "Transducer", "The Transducer attached to this device.", PointerValue (),
...
bool
UanNetDevice::SendFrom (Ptr<Packet> packet, [[maybe_unused]] const Address &source,
