...
double
UanPhyCalcSinrDual::CalcSinrDb (Ptr<Packet> pkt, Time arrTime, double rxPowerDb, double ambNoiseDb,
  ...
  static TypeId tid =
      TypeId ("ns3::UanPhyDual")
          ...
          .AddAttribute (
              ...
              MakeDoubleChecker<double> ())
          .AddAttribute (
              "TxPowerPhy1", "Transmission output power in dB of Phy1.", DoubleValue (190),
              MakeDoubleAccessor (&UanPhyDual::GetTxPowerDbPhy1, &UanPhyDual::SetTxPowerDbPhy1),
              MakeDoubleChecker<double> ())
          .AddAttribute (
              "TxPowerPhy2", "Transmission output power in dB of Phy2.", DoubleValue (190),
...
void
UanPhyDual::StartRxPacket (Ptr<Packet> pkt, [[maybe_unused]] double rxPowerDb, UanTxMode txMode,
                           UanPdp pdp)
{
...
void
UanPhyDual::NotifyTransStartTx (Ptr<Packet> packet, [[maybe_unused]] double txPowerDb,
                                UanTxMode txMode)
{
}
void
