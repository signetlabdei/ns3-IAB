...
AcousticModemEnergyDepletionTestCase::SendOnePacket (Ptr<Node> node)
{
  ...
  Simulator::Schedule (Seconds (10), &AcousticModemEnergyDepletionTestCase::SendOnePacket, this,
                       node);
}
...
UanEnergyModelTestSuite::UanEnergyModelTestSuite () : TestSuite ("uan-energy-model", UNIT)
{
