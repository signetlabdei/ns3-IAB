...
main (int argc, char *argv[])
{
  ...
  params.m_sfrmOrd = 3;
  params.m_logCh = 12;
  Simulator::ScheduleWithContext (1, Seconds (2.0), &LrWpanMac::MlmeStartRequest, dev0->GetMac (),
                                  params);
  ...
  params2.m_sfrmOrd = 3;
  params2.m_logCh = 14;
  Simulator::ScheduleWithContext (1, Seconds (2.0), &LrWpanMac::MlmeStartRequest, dev2->GetMac (),
                                  params2);
  ...
  Simulator::ScheduleWithContext (1, Seconds (2.0), &LrWpanMac::MlmeScanRequest, dev1->GetMac (),
                                  scanParams);
