...
private:
  ...
  uint8_t
      m_pndAddrSpecNumShortAddr; //!< Pending Address Specification field Number of Short Address (Bits 0-2)
  //!< Pending Address Specification field Reserved (Not Necessary)(Bit  3)
  uint8_t
      m_pndAddrSpecNumExtAddr; //!< Pending Address Specification field Number of Extended Address (Bits 4-6)
