...
const LrWpanPhyDataAndSymbolRates LrWpanPhy::dataSymbolRates[IEEE_802_15_4_INVALID_PHY_OPTION] = {
    {20.0, 20.0},  {40.0, 40.0},  {20.0, 20.0},  {250.0, 12.5}, {250.0, 50.0},
    {250.0, 62.5}, {100.0, 25.0}, {250.0, 62.5}, {250.0, 62.5}};
...
const LrWpanPhyPpduHeaderSymbolNumber
    LrWpanPhy::ppduHeaderSymbolNumbers[IEEE_802_15_4_INVALID_PHY_OPTION] = {
        {32.0, 8.0, 8.0}, {32.0, 8.0, 8.0}, {32.0, 8.0, 8.0}, {2.0, 1.0, 0.4}, {6.0, 1.0, 1.6},
        {8.0, 2.0, 2.0},  {8.0, 2.0, 2.0},  {8.0, 2.0, 2.0},  {8.0, 2.0, 2.0}};
...
LrWpanPhy::LrWpanPhy (void) : m_edRequest (), m_setTRXState ()
{
...
LrWpanPhy::PhyIsBusy (void) const
{
  ...
  return ((m_trxState == IEEE_802_15_4_PHY_BUSY_TX) || (m_trxState == IEEE_802_15_4_PHY_BUSY_RX) ||
...
LrWpanPhy::EndEd (void)
{
  ...
  m_edPower.averagePower += LrWpanSpectrumValueHelper::TotalAvgPower (
                                m_signal->GetSignalPsd (), m_phyPIBAttributes.phyCurrentChannel) *
