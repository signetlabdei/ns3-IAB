...
LrWpanNetDevice::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::LrWpanNetDevice")
          ...
          .AddAttribute ("UseAcks", "Request acknowledgments for data frames.", BooleanValue (true),
                         MakeBooleanAccessor (&LrWpanNetDevice::m_useAcks), MakeBooleanChecker ())
          .AddAttribute (
...
LrWpanNetDevice::LrWpanNetDevice () : m_configComplete (false)
{
...
bool
LrWpanNetDevice::SendFrom (Ptr<Packet> packet, const Address &source, const Address &dest,
