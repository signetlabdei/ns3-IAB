...
Kun2600MhzPropagationLossModel::Kun2600MhzPropagationLossModel () : PropagationLossModel ()
{
}
...
double
Kun2600MhzPropagationLossModel::DoCalcRxPower (double txPowerDbm, Ptr<MobilityModel> a,
