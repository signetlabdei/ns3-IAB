...
ItuR1411LosPropagationLossModel::ItuR1411LosPropagationLossModel () : PropagationLossModel ()
{
}
...
double
ItuR1411LosPropagationLossModel::DoCalcRxPower (double txPowerDbm, Ptr<MobilityModel> a,
