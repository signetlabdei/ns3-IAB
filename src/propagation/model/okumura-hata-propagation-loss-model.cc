...
OkumuraHataPropagationLossModel::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::OkumuraHataPropagationLossModel")
          ...
          .AddAttribute ("Frequency", "The propagation frequency in Hz", DoubleValue (2160e6),
...
OkumuraHataPropagationLossModel::OkumuraHataPropagationLossModel () : PropagationLossModel ()
{
}
  ...
  if (m_frequency <= 1.500e9)
    {
      ...
      NS_LOG_INFO (
          this << " logf " << 26.16 * log_f << " loga " << log_aHeight << " X "
...
double
OkumuraHataPropagationLossModel::DoCalcRxPower (double txPowerDbm, Ptr<MobilityModel> a,
