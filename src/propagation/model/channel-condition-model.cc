...
ChannelCondition::ChannelCondition ()
    : m_losCondition (LosConditionValue::LC_ND), m_o2iCondition (O2iConditionValue::O2I_ND)
{
}
...
AlwaysLosChannelConditionModel::GetChannelCondition (
    [[maybe_unused]] Ptr<const MobilityModel> a, [[maybe_unused]] Ptr<const MobilityModel> b) const
{
...
ThreeGppChannelConditionModel::ThreeGppChannelConditionModel () : ChannelConditionModel ()
{
