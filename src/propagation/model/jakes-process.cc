...
JakesProcess::Oscillator::Oscillator (std::complex<double> amplitude, double initialPhase,
                                      double omega)
...
JakesProcess::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::JakesProcess")
          ...
          .AddAttribute ("NumberOfOscillators", "The number of oscillators", UintegerValue (20),
...
JakesProcess::JakesProcess () : m_omegaDopplerMax (0), m_nOscillators (0)
{
}
