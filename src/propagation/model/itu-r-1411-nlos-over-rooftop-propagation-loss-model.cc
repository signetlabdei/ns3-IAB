...
ItuR1411NlosOverRooftopPropagationLossModel::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::ItuR1411NlosOverRooftopPropagationLossModel")
          ...
          .AddAttribute (
              "Environment", "Environment Scenario", EnumValue (UrbanEnvironment),
              MakeEnumAccessor (&ItuR1411NlosOverRooftopPropagationLossModel::m_environment),
              MakeEnumChecker (UrbanEnvironment, "Urban", SubUrbanEnvironment, "SubUrban",
          ...
          .AddAttribute (
              "RooftopLevel", "The height of the rooftop level in meters", DoubleValue (20.0),
...
double
ItuR1411NlosOverRooftopPropagationLossModel::DoCalcRxPower (double txPowerDbm, Ptr<MobilityModel> a,
                                                            Ptr<MobilityModel> b) const
{
