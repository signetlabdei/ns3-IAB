...
private:
   ...
   */
  double GetLoss (Ptr<ChannelCondition> cond, double distance2D, double distance3D, double hUt,
                  double hBs) const;
   ...
   */
  virtual double GetShadowingStd (Ptr<MobilityModel> a, Ptr<MobilityModel> b,
   ...
   */
  virtual double
  GetShadowingCorrelationDistance (ChannelCondition::LosConditionValue cond) const = 0;
...
private:
  ...
  Ptr<UniformRandomVariable>
      m_uniformVar; //!< a uniform random variable used for the computation of the breakpoint distance
};
