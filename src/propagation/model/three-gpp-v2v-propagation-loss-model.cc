...
double
ThreeGppV2vUrbanPropagationLossModel::GetLossLos (double /* distance2D */, double distance3D,
...
double
ThreeGppV2vUrbanPropagationLossModel::GetLossNlosv (double distance2D, double distance3D,
                                                    double hUt, double hBs) const
{
  NS_LOG_FUNCTION (this);
...
double
ThreeGppV2vUrbanPropagationLossModel::GetAdditionalNlosvLoss (double distance3D, double hUt,
                                                              double hBs) const
{
  NS_LOG_FUNCTION (this);
  ...
  if (std::min (hUt, hBs) > blockerHeight)
  ...
  else if (std::max (hUt, hBs) < blockerHeight)
    {
      ...
      m_logNorVar->SetAttribute (
          "Mu", DoubleValue (log (pow (mu_a, 2) / sqrt (pow (sigma_a, 2) + pow (mu_a, 2)))));
...
double
ThreeGppV2vUrbanPropagationLossModel::GetLossNlos (double /* distance2D */, double distance3D,
                                                   double /* hUt */, double /* hBs */) const
{
  NS_LOG_FUNCTION (this);
...
double
ThreeGppV2vHighwayPropagationLossModel::GetLossLos (double /* distance2D */, double distance3D,
                                                    double /* hUt */, double /* hBs */) const
{
  NS_LOG_FUNCTION (this);
