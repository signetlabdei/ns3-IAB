 ...
 */
static Gnuplot
TestProbabilistic (Ptr<PropagationLossModel> model, double targetDistance, double step,
 ...
 */
static Gnuplot
TestDeterministicByTime (Ptr<PropagationLossModel> model, Time timeStep, Time timeTotal,
                         double distance)
{
  Ptr<ConstantPositionMobilityModel> a = CreateObject<ConstantPositionMobilityModel> ();
  Ptr<ConstantPositionMobilityModel> b = CreateObject<ConstantPositionMobilityModel> ();
