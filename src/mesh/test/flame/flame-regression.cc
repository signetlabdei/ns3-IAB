...
FlameRegressionTest::FlameRegressionTest ()
    : TestCase ("FLAME regression test"), m_nodes (0), m_time (Seconds (10)), m_sentPktsCounter (0)
{
}
...
FlameRegressionTest::CreateNodes ()
{
  ...
  mobility.SetPositionAllocator ("ns3::GridPositionAllocator", "MinX", DoubleValue (0.0), "MinY",
                                 DoubleValue (0.0), "DeltaX", DoubleValue (120), "DeltaY",
                                 DoubleValue (0), "GridWidth", UintegerValue (3), "LayoutType",
