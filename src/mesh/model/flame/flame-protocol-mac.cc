...
FlameProtocolMac::FlameProtocolMac (Ptr<FlameProtocol> protocol) : m_protocol (protocol)
{
}
...
bool
FlameProtocolMac::UpdateOutcomingFrame (Ptr<Packet> packet, WifiMacHeader &header,
