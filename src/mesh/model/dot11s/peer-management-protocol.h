...
public:
   ...
   */
  void ReceiveBeacon (uint32_t interface, Mac48Address peerAddress, Time beaconInterval,
  ...
  void ReceivePeerLinkFrame (uint32_t interface, Mac48Address peerAddress,
                             ...
                             IePeerManagement peerManagementElement, IeConfiguration meshConfig);
  /**
...
private:
  ...
  void PeerLinkStatus (uint32_t interface, Mac48Address peerAddress,
                       Mac48Address peerMeshPointAddres, PeerLink::PeerState ostate,
   ...
   * \param interface interface
   */
  void NotifyLinkOpen (Mac48Address peerMp, Mac48Address peerIface, Mac48Address myIface,
                       uint32_t interface);
  /**
   ...
   * \param interface interface
   */
  void NotifyLinkClose (Mac48Address peerMp, Mac48Address peerIface, Mac48Address myIface,
                        uint32_t interface);
