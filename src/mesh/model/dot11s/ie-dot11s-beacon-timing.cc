 ...
 * IeBeaconTimingUnit
 *******************************************/
IeBeaconTimingUnit::IeBeaconTimingUnit () : m_aid (0), m_lastBeacon (0), m_beaconInterval (0)
{
}
void
...
IeBeaconTiming::IeBeaconTiming () : m_numOfUnits (0)
{
}
...
void
IeBeaconTiming::AddNeighboursTimingElementUnit (uint16_t aid, Time last_beacon,
...
void
IeBeaconTiming::DelNeighboursTimingElementUnit (uint16_t aid, Time last_beacon,
                                                Time beacon_interval)
{
