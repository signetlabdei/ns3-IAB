...
private:
   ...
   */
  void Forward (Ptr<NetDevice> incomingPort, Ptr<const Packet> packet, uint16_t protocol,
   ...
   */
  void DoSend (bool success, Ptr<Packet> packet, Mac48Address src, Mac48Address dst,
               uint16_t protocol, uint32_t iface);
