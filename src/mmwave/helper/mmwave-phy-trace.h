...
public:
  ...
  static void ReportCurrentCellRsrpSinrCallback (Ptr<MmWavePhyTrace> phyStats, std::string path,
                                                 ...
                                                 SpectrumValue &power);
  static void ReportDownLinkTBSize (Ptr<MmWavePhyTrace> phyStats, std::string path, uint64_t imsi,
                                    uint64_t tbSize);
  static void RxPacketTraceUeCallback (Ptr<MmWavePhyTrace> phyStats, std::string path,
                                       RxPacketTraceParams param);
  static void RxPacketTraceEnbCallback (Ptr<MmWavePhyTrace> phyStats, std::string path,
                                        RxPacketTraceParams param);
