 ...
 */
void
DlTxPduCallback (Ptr<MmWaveBoundCallbackArgument> arg, std::string path, uint16_t rnti,
 ...
 */
void
DlRxPduCallback (Ptr<MmWaveBoundCallbackArgument> arg, std::string path, uint16_t rnti,
 ...
 */
void
UlTxPduCallback (Ptr<MmWaveBoundCallbackArgument> arg, std::string path, uint16_t rnti,
                 uint8_t lcid, uint32_t packetSize)
{
  NS_LOG_FUNCTION (path << rnti << (uint16_t) lcid << packetSize);
 ...
 */
void
UlRxPduCallback (Ptr<MmWaveBoundCallbackArgument> arg, std::string path, uint16_t rnti,
                 uint8_t lcid, uint32_t packetSize, uint64_t delay)
{
  NS_LOG_FUNCTION (path << rnti << (uint16_t) lcid << packetSize << delay);
...
void
SwitchToLteCallback (Ptr<McMmWaveBoundCallbackArgument> arg, std::string path, uint64_t imsi,
...
void
SwitchToMmWaveCallback (Ptr<McMmWaveBoundCallbackArgument> arg, std::string path, uint64_t imsi,
                        uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (path << rnti << cellId << imsi);
...
void
MmWaveBearerStatsConnector::NotifyMmWaveSinr (MmWaveBearerStatsConnector *c, std::string context,
...
void
MmWaveBearerStatsConnector::NotifyLteSinr (MmWaveBearerStatsConnector *c, std::string context,
...
void
MmWaveBearerStatsConnector::PrintEnbStartHandover (uint64_t imsi, uint16_t sourceCellid,
                                                   uint16_t targetCellId, uint16_t rnti)
{
...
void
MmWaveBearerStatsConnector::PrintEnbEndHandover (uint64_t imsi, uint16_t targetCellId,
                                                 uint16_t rnti)
{
...
void
MmWaveBearerStatsConnector::PrintUeStartHandover (uint64_t imsi, uint16_t sourceCellid,
                                                  uint16_t targetCellId, uint16_t rnti)
{
...
void
MmWaveBearerStatsConnector::ConnectSrb0Traces (std::string context, uint64_t imsi, uint16_t cellId,
                                               uint16_t rnti)
{
...
void
MmWaveBearerStatsConnector::ConnectTracesUeIfFirstTime (std::string context, uint64_t imsi,
                                                        uint16_t cellId, uint16_t rnti)
{
...
void
MmWaveBearerStatsConnector::ConnectTracesEnbIfFirstTime (std::string context, uint64_t imsi,
                                                         uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this << context);
...
void
MmWaveBearerStatsConnector::ConnectDrbTracesUe (std::string context, uint64_t imsi, uint16_t cellId,
                                                uint16_t rnti)
{
  NS_LOG_FUNCTION (this << context);
...
void
MmWaveBearerStatsConnector::ConnectSrb1TracesUe (std::string ueRrcPath, uint64_t imsi,
                                                 uint16_t cellId, uint16_t rnti)
{
...
void
MmWaveBearerStatsConnector::ConnectSrb1TracesEnb (std::string context, uint64_t imsi,
                                                  uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this << context);
...
void
MmWaveBearerStatsConnector::ConnectDrbTracesEnb (std::string context, uint64_t imsi,
                                                 uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this << context);
  NS_LOG_LOGIC (this << "expected context  should match /NodeList/*/DeviceList/*/LteEnbRrc/");
  ...
  if (m_pdcpStats)
    {
      ...
      Config::ConnectFailSafe (basePath.str () + "/DataRadioBearerMap/*/LtePdcp/RxPDU",
                               MakeBoundCallback (&UlRxPduCallback, arg));
      Config::ConnectFailSafe (basePath.str () + "/DataRadioBearerMap/*/McEnbPdcp/TxPDU",
                               MakeBoundCallback (&DlTxPduCallback, arg));
      Config::ConnectFailSafe (basePath.str () + "/DataRadioBearerMap/*/McEnbPdcp/RxPDU",
                               MakeBoundCallback (&UlRxPduCallback, arg));
    }
}

void
MmWaveBearerStatsConnector::DisconnectTracesUe (std::string context, uint64_t imsi, uint16_t cellId,
                                                uint16_t rnti)
{
  NS_LOG_FUNCTION (this << context);
  NS_LOG_LOGIC (this << "expected context should match /NodeList/*/DeviceList/*/LteUeRrc/");
...
void
MmWaveBearerStatsConnector::DisconnectDrbTracesUe (std::string context, uint64_t imsi,
                                                   uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this << context);
  NS_LOG_LOGIC (this << "expected context should match /NodeList/*/DeviceList/*/LteUeRrc/");
...
void
MmWaveBearerStatsConnector::DisconnectTracesEnb (std::string context, uint64_t imsi,
                                                 uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
}
...
void
MmWaveBearerStatsConnector::ConnectSecondaryTracesUe (std::string context, uint64_t imsi,
                                                      uint16_t cellId, uint16_t rnti)
{
...
void
MmWaveBearerStatsConnector::ConnectSecondaryTracesEnb (std::string context, uint64_t imsi,
                                                       uint16_t cellId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this << context);
