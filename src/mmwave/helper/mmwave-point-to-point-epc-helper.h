...
public:
  ...
  virtual void AddDu (Ptr<Node> enbNode, Ptr<NetDevice> lteEnbNetDevice, uint16_t cellId,
                      bool isIabNode = false);
  virtual void AddUe (Ptr<NetDevice> ueLteDevice, uint64_t imsi);
  virtual void AddX2Interface (Ptr<Node> enbNode1, Ptr<Node> enbNode2);
  virtual uint32_t ActivateEpsBearer (Ptr<NetDevice> ueLteDevice, uint64_t imsi, Ptr<EpcTft> tft,
                                      EpsBearer bearer);
  virtual uint32_t ActivateEpsBearer (Ptr<NetDevice> ueLteDevice, Ptr<EpcUeNas> ueNas,
  ...
  Ptr<const EpcSgwPgwApplication> GetEpcSgwPgwApplication ();
  Ptr<EpcSgwPgwApplication> GetNonConstEpcSgwPgwApplication ();
