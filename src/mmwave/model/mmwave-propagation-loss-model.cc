...
MmWavePropagationLossModel::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::MmWavePropagationLossModel")
          ...
          .AddAttribute ("ChannelStates", "'l' for LOS, 'n' for NLOS, 'o' for outage, 'a' for all",
                         StringValue ("a"),
                         MakeStringAccessor (&MmWavePropagationLossModel::m_channelStates),
                         MakeStringChecker ())
          .AddAttribute ("LossFixedDb", "", DoubleValue (0.0),
                         MakeDoubleAccessor (&MmWavePropagationLossModel::m_lossFixedDb),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("FixedLossTst", "", BooleanValue (false),
...
double
MmWavePropagationLossModel::DoCalcRxPower (double txPowerDbm, Ptr<MobilityModel> a,
