  ...
  static TypeId tid =
      TypeId ("ns3::MmWavePhyMacCommon")
          ...
          .AddAttribute (
              ...
              UintegerValue (20), MakeUintegerAccessor (&MmWavePhyMacCommon::m_numHarqProcess),
              MakeUintegerChecker<uint8_t> ())
          .AddAttribute ("HarqDlTimeout", "Hybrid ARQ timeout period", UintegerValue (20),
...
MmWavePhyMacCommon::MmWavePhyMacCommon ()
    : m_dlCtrlSymbols (1), m_ulCtrlSymbols (1), m_numRefSc (864), m_L1L2Latency (2)
{
...
MmWavePhyMacCommon::SetNrNumerology (uint8_t index)
{
  ...
  m_symbolPeriod =
      Time (m_subframePeriod / m_symbolsPerSlot / m_slotsPerSubframe); // Duration of an OFDM symbol
