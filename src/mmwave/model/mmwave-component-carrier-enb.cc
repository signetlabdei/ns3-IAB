...
MmWaveComponentCarrierEnb::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::MmWaveComponentCarrierEnb")
          ...
          .AddAttribute ("MmWaveEnbPhy", "The PHY associated to this ComponentCarrierEnb",
                         PointerValue (), MakePointerAccessor (&MmWaveComponentCarrierEnb::m_phy),
                         MakePointerChecker<MmWaveEnbPhy> ())
          .AddAttribute ("MmWaveEnbMac", "The MAC associated to this ComponentCarrierEnb",
                         PointerValue (), MakePointerAccessor (&MmWaveComponentCarrierEnb::m_mac),
                         MakePointerChecker<MmWaveEnbMac> ())
          .AddAttribute ("MmWaveMacScheduler",
                         "The scheduler associated to this ComponentCarrierEnb", PointerValue (),
