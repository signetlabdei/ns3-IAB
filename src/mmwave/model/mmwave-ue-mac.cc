...
UeMemberMmWaveUeCmacSapProvider::UeMemberMmWaveUeCmacSapProvider (MmWaveUeMac *mac) : m_mac (mac)
{
}
...
void
UeMemberMmWaveUeCmacSapProvider::AddLc (uint8_t lcId, LogicalChannelConfig lcConfig,
                                        LteMacSapUser *msu)
{
...
UeMemberMmWaveMacSapProvider::UeMemberMmWaveMacSapProvider (MmWaveUeMac *mac) : m_mac (mac)
{
}
...
MacUeMemberPhySapUser::MacUeMemberPhySapUser (MmWaveUeMac *mac) : m_mac (mac)
{
}
void
...
MmWaveUeMac::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::MmWaveUeMac")
          ...
          .AddAttribute (
              "UpdateUeSinrEstimatePeriod",
              "Period (in ms) of reporting of SINR estimate of all the UE", DoubleValue (25.6),
              MakeDoubleAccessor (&MmWaveUeMac::m_ueUpdateSinrPeriod), MakeDoubleChecker<double> ())
          .AddAttribute (
              "InterRatHoCapable", "True if this UE supports hard handover between LTE and MmWave",
              BooleanValue (false), MakeBooleanAccessor (&MmWaveUeMac::m_interRatHoCapable),
              MakeBooleanChecker ())
          .AddTraceSource ("TxMacPacketTraceUe", "Packets transmitted by UeMac",
...
void
MmWaveUeMac::DoStartNonContentionBasedRandomAccessProcedure (uint16_t rnti, uint8_t preambleId,
                                                             uint8_t prachMask)
{
...
void
MmWaveUeMac::AddLc (uint8_t lcId, LteUeCmacSapProvider::LogicalChannelConfig lcConfig,
                    LteMacSapUser *msu)
{
