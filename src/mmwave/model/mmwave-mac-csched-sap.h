...
public:
  ...
  struct CschedUeConfigReqParameters
  {
    ...
    enum MeasGapConfigPattern_e { MGP_GP1, MGP_GP2, OFF } m_measGapConfigPattern;
    ...
    enum OpenClosedLoop_e { noneloop, openloop, closedloop } m_ueTransmitAntennaSelection;
    ...
    enum RepMode_e { rm12, rm20, rm22, rm30, rm31, nonemode } m_aperiodicCqiRepMode;
...
public:
  ...
  virtual void
  CschedCellConfigUpdateInd (const struct CschedCellConfigUpdateIndParameters &params) = 0;
