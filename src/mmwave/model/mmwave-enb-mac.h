...
*/
  ...
  void
  DoCschedCellConfigUpdateInd (MmWaveMacCschedSapUser::CschedCellConfigUpdateIndParameters params);
   ...
   */
  typedef void (*HarqRetxCallback) (uint16_t rnti, uint16_t cellId, uint32_t tbSize,
                                    uint8_t numRetx);
...
private:
  ...
  */
  ...
  TracedCallback<MmWaveSchedTraceInfo>
      m_schedEnbInfo; //!< Trace information registering the scheduling decisions undertaken by the scheduler.
};
