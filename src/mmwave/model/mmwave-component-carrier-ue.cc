...
MmWaveComponentCarrierUe::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::MmWaveComponentCarrierUe")
          ...
          .AddAttribute ("MmWaveUePhy", "The PHY associated to this ComponentCarrierUe",
                         PointerValue (), MakePointerAccessor (&MmWaveComponentCarrierUe::m_phy),
                         MakePointerChecker<MmWaveUePhy> ())
          .AddAttribute ("MmWaveUeMac", "The MAC associated to this ComponentCarrierUe",
                         PointerValue (), MakePointerAccessor (&MmWaveComponentCarrierUe::m_mac),
