...
McUeNetDevice::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::McUeNetDevice")
          ...
          .AddAttribute ("Mtu", "The MAC-level Maximum Transmission Unit", UintegerValue (30000),
                         MakeUintegerAccessor (&McUeNetDevice::SetMtu, &McUeNetDevice::GetMtu),
                         MakeUintegerChecker<uint16_t> ())
          // Common attributes
          .AddAttribute ("EpcUeNas", "The NAS associated to the this NetDevice", PointerValue (),
          ...
          .AddAttribute ("Imsi", "International Mobile Subscriber Identity assigned to this UE",
                         UintegerValue (0), MakeUintegerAccessor (&McUeNetDevice::m_imsi),
          ...
          // LTE stack
          .AddAttribute ("LteUeRrc", "The RRC associated to the LTE stack of this NetDevice",
                         PointerValue (), MakePointerAccessor (&McUeNetDevice::m_lteRrc),
          ...
          .AddAttribute ("LteComponentCarrierMapUe", "List of all LTE CCs.", ObjectMapValue (),
          ...
          .AddAttribute (
              ...
              UintegerValue (100),
              MakeUintegerAccessor (&McUeNetDevice::SetLteDlEarfcn, &McUeNetDevice::GetLteDlEarfcn),
              MakeUintegerChecker<uint16_t> (0, 6149))
          // mmWave stack attributes
          .AddAttribute ("MmWaveUeRrc", "The RRC associated to the mmWave stack of this NetDevice",
                         PointerValue (), MakePointerAccessor (&McUeNetDevice::m_mmWaveRrc),
                         MakePointerChecker<LteUeRrc> ())
          ...
          .AddAttribute ("MmWaveComponentCarrierMapUe", "List of all mmWave CCs.",
                         ObjectMapValue (), MakeObjectMapAccessor (&McUeNetDevice::m_mmWaveCcMap),
                         MakeObjectMapChecker<MmWaveComponentCarrierUe> ())
          .AddAttribute (
              "AntennaNum", "Antenna number of the device", UintegerValue (16),
              MakeUintegerAccessor (&McUeNetDevice::SetAntennaNum, &McUeNetDevice::GetAntennaNum),
              MakeUintegerChecker<uint16_t> ());
  return tid;
}

McUeNetDevice::McUeNetDevice () : m_isConstructed (false), m_csgId (0)
{
...
bool
McUeNetDevice::SendFrom (Ptr<Packet> packet, const Address &source, const Address &dest,
...
void
McUeNetDevice::SetMmWaveTargetIab (Ptr<MmWaveIabNetDevice> iab)
{
  m_mmWaveTargetIab = iab;
}
...
McUeNetDevice::GetMmWaveTargetIab (void)
{
  return m_mmWaveTargetIab;
}
