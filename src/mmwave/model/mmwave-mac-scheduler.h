...
typedef Callback<uint32_t, uint16_t> MmWaveMacSchedulerCallback;
...
public:
  ...
  void SetDepthCallback (MmWaveMacSchedulerCallback c);
...
protected:
  ...
  MmWaveMacSchedulerCallback m_getDepthCallback{MakeNullCallback<uint32_t, uint16_t> ()};
  uint16_t m_cellId;
};
