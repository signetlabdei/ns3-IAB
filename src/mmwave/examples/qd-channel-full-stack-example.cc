...
main (int argc, char *argv[])
{
  ...
  uint16_t enbAntennaNum =
      64; // The number of antenna elements for the gNBs antenna arrays, assuming a square architecture
  uint16_t ueAntennaNum =
      16; // The number of antenna elements for the UE antenna arrays, assuming a square architecture
  ...
  cmd.AddValue (
      "enbAntennaNum",
      "The number of antenna elements for the gNBs antenna arrays, assuming a square architecture",
      enbAntennaNum);
  cmd.AddValue (
      "ueAntennaNum",
