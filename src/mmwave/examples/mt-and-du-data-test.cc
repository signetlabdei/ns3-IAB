...
main (int argc, char *argv[])
{
  ...
  //                            dataSensorParams);
  //     InstallUdpPacketSink (remoteCommandsMrStream, ueIpIface.GetAddress (i), ueNode.Get (i),
  //                           dataSensorParams);
  //   }
  ...
  // EpsBearer bearer (q);
  // mmwaveHelper->ActivateDataRadioBearer (ueMmWaveDev, bearer);
