...
main (int argc, char *argv[])
{
  ...
  nixRouting.PrintRoutingPathAt (Seconds (3), nodes12.Get (0), interfaces12.GetAddress (1, 1),
                                 routingStream);
  ...
  nixRouting.PrintRoutingPathAt (Seconds (7), nodes12.Get (0), Ipv4Address ("10.2.3.2"),
                                 routingStream);
