  ...
  if (!useIpv6)
    {
      ...
      nixRouting.PrintRoutingPathAt (Seconds (7), wifiStaNodes1.Get (2),
                                     staDevicesInterfaces2.GetAddress (2), routingStream);
    }
  else
    {
      InternetStackHelper stack;
      ...
      nixRouting.PrintRoutingPathAt (Seconds (7), wifiStaNodes1.Get (2),
                                     staDevicesInterfaces2.GetAddress (2, 1), routingStream);
    }
