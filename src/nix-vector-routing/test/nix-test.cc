...
NixVectorRoutingTest::NixVectorRoutingTest () : TestCase ("three router, two path test")
{
}
...
NixVectorRoutingTest::DoRun (void)
{
  ...
  NS_TEST_EXPECT_MSG_EQ (rxSocketv4->Bind (InetSocketAddress (iCiDstv4.GetAddress (1), 1234)), 0,
                         "trivial");
  ...
  ipv4NixRouting.PrintRoutingPathAt (Seconds (3), nSrcnA.Get (0), iCiDstv4.GetAddress (1),
                                     routingStream1v4);
  ipv6NixRouting.PrintRoutingPathAt (Seconds (3), nSrcnA.Get (0), iCiDstv6.GetAddress (1, 1),
                                     routingStream1v6);
  ...
  ipv4NixRouting.PrintRoutingPathAt (Seconds (9), nSrcnA.Get (0), iCiDstv4.GetAddress (1),
                                     routingStream3v4);
  ipv6NixRouting.PrintRoutingPathAt (Seconds (9), nSrcnA.Get (0), iCiDstv6.GetAddress (1, 1),
                                     routingStream3v6);
  ...
  NS_TEST_EXPECT_MSG_EQ (m_receivedPacketSizes.size (), 4,
