...
NullMessageSimulatorImpl::ScheduleNullMessageEvent (Ptr<RemoteChannelBundle> bundle)
{
  ...
  bundle->SetEventId (Simulator::Schedule (
      delay, &NullMessageSimulatorImpl::NullMessageEventHandler, this, PeekPointer (bundle)));
}
...
void
NullMessageSimulatorImpl::ScheduleWithContext (uint32_t context, Time const &delay,
                                               EventImpl *event)
{
