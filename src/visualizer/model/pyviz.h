...
public:
  ...
  struct NetDeviceStatistics
  {
    /// constructor
    NetDeviceStatistics ()
        : transmittedBytes (0), receivedBytes (0), transmittedPackets (0), receivedPackets (0)
    {
    }
  ...
  static void LineClipping (double boundsX1, double boundsY1, double boundsX2, double boundsY2,
...
private:
   ...
   */
  void TraceNetDevTxCommon (std::string const &context, Ptr<const Packet> packet,
   ...
   */
  void TraceNetDevRxCommon (std::string const &context, Ptr<const Packet> packet,
