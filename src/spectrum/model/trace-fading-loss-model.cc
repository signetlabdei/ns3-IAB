...
TraceFadingLossModel::TraceFadingLossModel () : m_streamsAssigned (false)
{
...
TraceFadingLossModel::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::TraceFadingLossModel")
          ...
          .AddAttribute ("TraceFilename", "Name of file to load a trace from.", StringValue (""),
          ...
          .AddAttribute (
              ...
              TimeValue (Seconds (10.0)), MakeTimeAccessor (&TraceFadingLossModel::SetTraceLength),
              MakeTimeChecker ())
          .AddAttribute ("SamplesNum", "The number of samples the trace is made of (default 10000)",
                         UintegerValue (10000),
          ...
          .AddAttribute ("WindowSize",
                         ...
                         MakeTimeAccessor (&TraceFadingLossModel::m_windowSize), MakeTimeChecker ())
          .AddAttribute ("RbNum", "The number of RB the trace is made of (default 100)",
                         UintegerValue (100), MakeUintegerAccessor (&TraceFadingLossModel::m_rbNum),
          ...
          .AddAttribute (
              ...
              UintegerValue (200000), MakeUintegerAccessor (&TraceFadingLossModel::m_streamSetSize),
                                                    ...
                                                    Ptr<const MobilityModel> b) const
{
  ...
  if (itOff != m_windowOffsetsMap.end ())
  ...
  else
    {
      ...
      startV->SetAttribute (
          "Max", DoubleValue ((m_traceLength.GetSeconds () - m_windowSize.GetSeconds ()) * 1000.0));
