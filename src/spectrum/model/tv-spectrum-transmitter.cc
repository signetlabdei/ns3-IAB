...
TvSpectrumTransmitter::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::TvSpectrumTransmitter")
          ...
          .AddAttribute ("TvType", "The type of TV transmitter/modulation to be used.",
          ...
          .AddAttribute ("BasePsd",
                         ...
                         DoubleValue (20), MakeDoubleAccessor (&TvSpectrumTransmitter::m_basePsd),
          ...
          .AddAttribute (
              ...
              MakeTimeAccessor (&TvSpectrumTransmitter::m_transmitDuration), MakeTimeChecker ());
  return tid;
}
