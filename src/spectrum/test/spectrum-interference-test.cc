...
public:
   ...
   */
  SpectrumInterferenceTestCase (Ptr<SpectrumValue> s, uint32_t txBytes, bool rxCorrect,
                                std::string name);
...
SpectrumInterferenceTestCase::SpectrumInterferenceTestCase (Ptr<SpectrumValue> s, uint32_t txBytes,
    ...
    : TestSuite ("spectrum-interference", UNIT)
{
  ...
  AddTestCase (new SpectrumInterferenceTestCase (s1, 0, true, "sdBm  = [-46 -48]  tx bytes: 1"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s1, static_cast<uint32_t> (b * 0.5 + 0.5), true,
                                                 "sdBm  = [-46 -48]  tx bytes: b*0.5"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s1, static_cast<uint32_t> (b * (1 - e) + 0.5),
                                                 true, "sdBm  = [-46 -48]  tx bytes: b*(1-e)"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s1, static_cast<uint32_t> (b * (1 + e) + 0.5),
                                                 false, "sdBm  = [-46 -48]  tx bytes: b*(1+e)"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s1, static_cast<uint32_t> (b * 1.5 + 0.5), false,
                                                 "sdBm  = [-46 -48]  tx bytes: b*1.5"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s1, 0xffffffff, false,
  ...
  AddTestCase (new SpectrumInterferenceTestCase (s2, 1, true, "sdBm  = [-63 -61]  tx bytes: 1"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s2, static_cast<uint32_t> (b * 0.5 + 0.5), true,
                                                 "sdBm  = [-63 -61]  tx bytes: b*0.5"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s2, static_cast<uint32_t> (b * (1 - e) + 0.5),
                                                 true, "sdBm  = [-63 -61]  tx bytes: b*(1-e)"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s2, static_cast<uint32_t> (b * (1 + e) + 0.5),
                                                 false, "sdBm  = [-63 -61]  tx bytes: b*(1+e)"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s2, static_cast<uint32_t> (b * 1.5 + 0.5), false,
                                                 "sdBm  = [-63 -61]  tx bytes: b*1.5"),
               TestCase::QUICK);
  AddTestCase (new SpectrumInterferenceTestCase (s2, 0xffffffff, false,
