...
{
  NS_TEST_ASSERT_MSG_SPECTRUM_MODEL_EQ_TOL (*m_a.GetSpectrumModel (), *m_b.GetSpectrumModel (),
                                            TOLERANCE, "");
...
SpectrumValueTestSuite::SpectrumValueTestSuite () : TestSuite ("spectrum-value", UNIT)
{
...
SpectrumConverterTestSuite::SpectrumConverterTestSuite () : TestSuite ("spectrum-converter", UNIT)
{
  double f;
