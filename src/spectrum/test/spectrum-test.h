          ...
          if ((i->fl > j->fl + (tol)) || (i->fl < j->fl - (tol)) || (i->fc > j->fc + (tol)) || \
            ...
            {                                                                                  \
              ...
              ReportTestFailure (std::string (#actual) + indexStream.str () +                  \
                                 ...
                                 actualStream.str (), expectedStream.str (), msgStream.str (), \
                                 (__FILE__), (__LINE__));                                      \
              CONTINUE_ON_FAILURE;                                                             \
            }                                                                                  \
          ++i;                                                                                 \
      ...
      if (i != (actual).End () || j != (expected).End ())                                      \
        {                                                                                      \
          ...
          ReportTestFailure ("Bands::iterator == End ()", actualStream.str (),                 \
                             expectedStream.str (), msgStream.str (), (__FILE__), (__LINE__)); \
        }                                                                                      \
  } while (false);
    ...
    {                                                                                            \
      ...
      if (i != (actual).ConstValuesEnd () || j != (expected).ConstValuesEnd ())                  \
        {                                                                                        \
          ...
          ReportTestFailure ("Values::const_iterator == ConstValuesEnd ()", actualStream.str (), \
                             expectedStream.str (), msgStream.str (), (__FILE__), (__LINE__));   \
        }                                                                                        \
  } while (false);
