...
public:
  ...
  IpcsClassifierRecord (Ipv4Address srcAddress, Ipv4Mask srcMask, Ipv4Address dstAddress,
                        Ipv4Mask dstMask, uint16_t srcPortLow, uint16_t srcPortHigh,
                        uint16_t dstPortLow, uint16_t dstPortHigh, uint8_t protocol,
                        uint8_t priority);
  /**
   ...
   */
  bool CheckMatch (Ipv4Address srcAddress, Ipv4Address dstAddress, uint16_t srcPort,
