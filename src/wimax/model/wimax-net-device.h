...
public:
  ...
  static Time
      m_frameStartTime; ///< temp, to determine the frame start time at SS side, shall actually be determined by frame start preamble
...
private:
   ...
   * \returns true if successful
   */
  virtual bool DoSend (Ptr<Packet> packet, const Mac48Address &source, const Mac48Address &dest,
