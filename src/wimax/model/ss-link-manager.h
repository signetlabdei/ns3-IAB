...
public:
   ...
   */
  void ScheduleScanningRestart (Time interval, SubscriberStationNetDevice::EventType eventType,
...
private:
  ...
  uint8_t
      m_initRangOppNumber; ///< Initial Ranging opportunity (1–255) in which SS transmitted the RNG_REQ
  ...
  uint64_t
      m_frequency; ///< frequency on which it is currently operating, i.e., where scanning was successful
