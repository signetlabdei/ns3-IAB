...
public:
   ...
   */
  void GetChannelDescriptorsToUpdate (bool &updateDcd, bool &updateUcd, bool &sendDcd,
                                      bool &sendUcd);
  /**
   ...
   */
  Ptr<UlJob> CreateUlJob (SSRecord *ssRecord, enum ServiceFlow::SchedulingType schedType,
                          ReqType reqType);
