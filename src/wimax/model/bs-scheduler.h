...
public:
   ...
   */
  virtual void AddDownlinkBurst (Ptr<const WimaxConnection> connection, uint8_t diuc,
   ...
   */
  bool CheckForFragmentation (Ptr<WimaxConnection> connection, int availableSymbols,
                              WimaxPhy::ModulationType modulationType);
