...
WimaxHelper::WimaxHelper (void) : m_channel (0)
{
}
...
void
WimaxHelper::EnableAsciiForConnection (Ptr<OutputStreamWrapper> os, uint32_t nodeid,
                                       uint32_t deviceid, char *netdevice, char *connection)
{
...
NetDeviceContainer
WimaxHelper::Install (NodeContainer c, NetDeviceType deviceType, PhyType phyType,
                      SchedulerType schedulerType, double frameDuration)
{
...
void
WimaxHelper::AsciiRxEvent (Ptr<OutputStreamWrapper> stream, std::string path,
                           Ptr<const Packet> packet, const Mac48Address &source)
{
...
void
WimaxHelper::AsciiTxEvent (Ptr<OutputStreamWrapper> stream, std::string path,
...
void
WimaxHelper::EnableAsciiInternal (Ptr<OutputStreamWrapper> stream, std::string prefix,
  ...
  if (!stream)
    {
      ...
      EnableAsciiForConnection (theStream, nodeid, deviceid, (char *) "WimaxNetDevice",
...
void
WimaxHelper::EnablePcapInternal (std::string prefix, Ptr<NetDevice> nd, bool explicitFilename,
                                 bool promiscuous)
{
  //
