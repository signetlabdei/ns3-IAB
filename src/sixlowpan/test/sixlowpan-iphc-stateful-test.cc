...
class SixlowpanIphcStatefulImplTest : public TestCase
{
   ...
   * \returns true.
   */
  bool PromiscReceiveFromSixLowPanDevice (Ptr<NetDevice> device, Ptr<const Packet> packet,
  ...
  if (mockDev)
    {
      ...
      Simulator::ScheduleWithContext (id, Time (1), &MockNetDevice::Receive, mockDev,
                                      incomingPkt.packet, protocol, destination, source,
                                      packetType);
    }
  return true;
}
...
SixlowpanIphcStatefulImplTest::PromiscReceiveFromSixLowPanDevice (
    Ptr<NetDevice> device, Ptr<const Packet> packet, uint16_t protocol, Address const &source,
...
void
SixlowpanIphcStatefulImplTest::SendOnePacket (Ptr<NetDevice> device, Ipv6Address from,
                                              Ipv6Address to)
{
...
SixlowpanIphcStatefulImplTest::DoRun (void)
{
  ...
  Simulator::Schedule (Seconds (1), &SixlowpanIphcStatefulImplTest::SendOnePacket, this,
                       m_sixDevices.Get (0), Ipv6Address::GetAny (), dstElided);

  Simulator::Schedule (Seconds (2), &SixlowpanIphcStatefulImplTest::SendOnePacket, this,
                       m_sixDevices.Get (0), Ipv6Address ("2001:2::f00d:f00d:cafe:cafe"),
                       Ipv6Address ("2001:1::0000:00ff:fe00:cafe"));

  Simulator::Schedule (Seconds (3), &SixlowpanIphcStatefulImplTest::SendOnePacket, this,
                       m_sixDevices.Get (0), Ipv6Address ("2001:1::0000:00ff:fe00:cafe"),
                       Ipv6Address ("2001:1::f00d:f00d:cafe:cafe"));

  Simulator::Schedule (Seconds (4), &SixlowpanIphcStatefulImplTest::SendOnePacket, this,
                       m_sixDevices.Get (0), srcElided,
                       Ipv6Address ("2001:1::f00d:f00d:cafe:cafe"));
  ...
  NS_TEST_EXPECT_MSG_EQ (ipv6Hdr.GetSource (), Ipv6Address ("2001:2::f00d:f00d:cafe:cafe"),
                         "Src address wrongly rebuilt");
  NS_TEST_EXPECT_MSG_EQ (ipv6Hdr.GetDestination (), Ipv6Address ("2001:1::0000:00ff:fe00:cafe"),
  ...
  NS_TEST_EXPECT_MSG_EQ (ipv6Hdr.GetSource (), Ipv6Address ("2001:1::0000:00ff:fe00:cafe"),
                         "Src address wrongly rebuilt");
  NS_TEST_EXPECT_MSG_EQ (ipv6Hdr.GetDestination (), Ipv6Address ("2001:1::f00d:f00d:cafe:cafe"),
                         "Dst address wrongly rebuilt");
