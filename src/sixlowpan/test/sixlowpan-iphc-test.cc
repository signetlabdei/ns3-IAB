...
SixlowpanIphcImplTest::SixlowpanIphcImplTest () : TestCase ("Sixlowpan implementation")
{
}
...
SixlowpanIphcTestSuite::SixlowpanIphcTestSuite () : TestSuite ("sixlowpan-iphc", UNIT)
{
