...
private:
  ...
  uint8_t
      m_roomX; ///< The room number along x-axis at which the MobilityBuildingInfo instance is located
  uint8_t
      m_roomY; ///< The room number along y-axis at which the MobilityBuildingInfo instance is located
