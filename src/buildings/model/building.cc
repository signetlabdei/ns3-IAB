...
Building::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("ns3::Building")
          ...
          .AddAttribute ("NRoomsX", "The number of rooms in the X axis.", UintegerValue (1),
                         MakeUintegerAccessor (&Building::GetNRoomsX, &Building::SetNRoomsX),
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("NRoomsY", "The number of rooms in the Y axis.", UintegerValue (1),
                         MakeUintegerAccessor (&Building::GetNRoomsY, &Building::SetNRoomsY),
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("NFloors", "The number of floors of this building.", UintegerValue (1),
                         MakeUintegerAccessor (&Building::GetNFloors, &Building::SetNFloors),
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("Id", "The id (unique integer) of this Building.", UintegerValue (0),
                         MakeUintegerAccessor (&Building::GetId), MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("Boundaries",
                         ...
                         MakeBoxChecker ())
          .AddAttribute ("Type", "The type of building", EnumValue (Building::Residential),
                         MakeEnumAccessor (&Building::GetBuildingType, &Building::SetBuildingType),
                         MakeEnumChecker (Building::Residential, "Residential", Building::Office,
          ...
          .AddAttribute (
              ...
              MakeEnumChecker (Building::Wood, "Wood", Building::ConcreteWithWindows,
                               "ConcreteWithWindows", Building::ConcreteWithoutWindows,
                               "ConcreteWithoutWindows", Building::StoneBlocks, "StoneBlocks"));
  return tid;
}
