...
public:
   ...
   */
  std::size_t
  operator() (ns3::Length::Unit u) const noexcept
  {
...
Length::Length () : m_value (0)
{
  NS_LOG_FUNCTION (this);
}

Length::Length (const std::string &input) : m_value (0)
{
...
Length::Length (double value, const std::string &unitString) : m_value (0)
{
...
Length::Length (double value, Length::Unit unit) : m_value (0)
{
...
Length::Length (Quantity quantity) : Length (quantity.Value (), quantity.Unit ())
{
...
ToSymbol (Length::Unit unit)
{
  ...
  static const StringTable STRINGS{
      {Length::Unit::Nanometer, "nm"},     {Length::Unit::Micrometer, "um"},
      {Length::Unit::Millimeter, "mm"},    {Length::Unit::Centimeter, "cm"},
      {Length::Unit::Meter, "m"},          {Length::Unit::Kilometer, "km"},
      {Length::Unit::NauticalMile, "nmi"}, {Length::Unit::Inch, "in"},
      {Length::Unit::Foot, "ft"},          {Length::Unit::Yard, "yd"},
      {Length::Unit::Mile, "mi"}};
