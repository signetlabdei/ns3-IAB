...
CommandLine::CommandLine () : m_NNonOptions (0), m_nonOptionCount (0), m_usage (), m_shortName ()
{
  NS_LOG_FUNCTION (this);
}
CommandLine::CommandLine (const std::string filename)
    : m_NNonOptions (0), m_nonOptionCount (0), m_usage ()
{
...
void
CommandLine::PrintAttributeList (std::ostream &os, const TypeId tid,
...
void
CommandLine::AddValue (const std::string &name, const std::string &help,
