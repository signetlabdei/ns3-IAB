...
ArithmeticOperators ()
{
  ...
  std::cout << "\nArithmetic Operations:"
            << "\nAddition: " << oneMeter << " + " << oneMeter << " = " << (oneMeter + oneMeter)
            << "\nSubtraction: " << oneMeter << " - " << oneMeter << " = " << (oneMeter - oneMeter)
...
EqualityOperators ()
{
  ...
  std::cout << "\nComparison Operations:" << std::boolalpha << "\nEquality: " << oneMeter
            << " == " << oneMeter << " is " << (oneMeter == oneMeter) << "\nEquality: " << oneMeter
            << " == " << twoMeter << " is " << (oneMeter == twoMeter)
            << "\nInequality: " << oneMeter << " != " << oneMeter << " is "
            << (oneMeter != oneMeter) << "\nInequality: " << oneMeter << " != " << twoMeter
            << " is " << (oneMeter != twoMeter) << "\nLesser: " << oneMeter << " < " << oneMeter
            << " is " << (oneMeter < oneMeter) << "\nLesser: " << oneMeter << " < " << twoMeter
            << " is " << (oneMeter < twoMeter) << "\nLesser: " << threeMeter << " < " << oneMeter
            << " is " << (threeMeter < oneMeter) << "\nGreater: " << oneMeter << " > " << oneMeter
            << " is " << (oneMeter > oneMeter) << "\nGreater: " << oneMeter << " > " << twoMeter
            << " is " << (oneMeter > twoMeter) << "\nGreater: " << threeMeter << " > " << oneMeter
            << " is " << (threeMeter > oneMeter) << std::endl;
}
