...
CreateObjectTestCase::DoRun (void)
{
  ...
  //
  NS_TEST_ASSERT_MSG_EQ (baseA->GetObject<DerivedA> (), baseA,
...
AggregateObjectTestCase::DoRun (void)
{
  ...
  //
  NS_TEST_ASSERT_MSG_NE (baseBCopy->GetObject<BaseA> (), nullptr,
  ...
  NS_TEST_ASSERT_MSG_NE (baseB, nullptr,
  ...
  NS_TEST_ASSERT_MSG_NE (baseBCopy->GetObject<BaseA> (), nullptr,
                         "Cannot GetObject (through baseBCopy) for a BaseA Object");
  NS_TEST_ASSERT_MSG_NE (baseBCopy->GetObject<DerivedA> (), nullptr,
                         "Cannot GetObject (through baseBCopy) for a BaseA Object");
...
ObjectFactoryTestCase::ObjectFactoryTestCase () : TestCase ("Check ObjectFactory functionality")
{
}
...
ObjectFactoryTestCase::DoRun (void)
{
  ...
  //
  NS_TEST_ASSERT_MSG_NE (!a->GetObject<DerivedA> (), 0,
