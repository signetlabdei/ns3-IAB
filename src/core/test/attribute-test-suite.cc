...
public:
  ...
  GetTypeId (void)
  {
    static TypeId tid =
        TypeId ("ns3::AttributeObjectTest")
            ...
            .AddAttribute ("TestInt16WithBounds", "help text", IntegerValue (-2),
            ...
            .AddAttribute (
                "TestEnumSetGet", "help text", EnumValue (TEST_B),
                MakeEnumAccessor (&AttributeObjectTest::DoSetEnum, &AttributeObjectTest::DoGetEnum),
                MakeEnumChecker (TEST_A, "TestA", TEST_B, "TestB", TEST_C, "TestC"))
            ...
            .AddAttribute ("TestVector1", "help text", ObjectVectorValue (),
                           MakeObjectVectorAccessor (&AttributeObjectTest::m_vector1),
                           MakeObjectVectorChecker<Derived> ())
            .AddAttribute ("TestVector2", "help text", ObjectVectorValue (),
            ...
            .AddAttribute ("IntegerTraceSource2", "help text", IntegerValue (-2),
            ...
            .AddAttribute ("BoolTraceSource", "help text", BooleanValue (false),
                           ...
                           MakeBooleanChecker ())
            .AddAttribute ("EnumTraceSource", "help text", EnumValue (false),
                           MakeEnumAccessor (&AttributeObjectTest::m_enumSrc),
                           MakeEnumChecker (TEST_A, "TestA"))
            .AddAttribute ("ValueClassSource", "help text", ValueClassTestValue (ValueClassTest ()),
            ...
            .AddAttribute ("PointerInitialized", "help text", StringValue ("ns3::Derived"),
                           MakePointerAccessor (&AttributeObjectTest::m_ptrInitialized),
                           MakePointerChecker<Derived> ())
            .AddAttribute ("PointerInitialized2", "help text", StringValue ("ns3::Derived[]"),
            ...
            .AddAttribute ("Callback", "help text", CallbackValue (),
                           ...
                           MakeCallbackChecker ())
            .AddAttribute ("TestTimeWithBounds", "help text", TimeValue (Seconds (-2)),
                           MakeTimeAccessor (&AttributeObjectTest::m_timeWithBounds),
                           MakeTimeChecker (Seconds (-5), Seconds (10)))
            .AddAttribute ("TestDeprecated", "help text", BooleanValue (false),
                           MakeBooleanAccessor (&AttributeObjectTest::m_boolTestDeprecated),
                           MakeBooleanChecker (), TypeId::DEPRECATED, "DEPRECATED test working.");
   ...
   */
  void
  InvokeCb (double a, int b, float c)
  {
    m_cb (a, b, c);
  }
...
private:
   ...
   */
  Ptr<Derived>
  DoGetVector (std::size_t i) const
  {
    return m_vector2[i];
  }
  /**
...
private:
   ...
   */
  bool CheckGetCodePaths (Ptr<Object> p, std::string attributeName, std::string expectedString,
                          T expectedValue);
};

template <typename T>
AttributeTestCase<T>::AttributeTestCase (std::string description) : TestCase (description)
{
}
...
template <typename T>
bool
AttributeTestCase<T>::CheckGetCodePaths (Ptr<Object> p, std::string attributeName,
...
ObjectVectorAttributeTestCase::DoRun (void)
{
  ...
  //
  p->GetAttribute ("TestVector1", vector);
  NS_TEST_ASSERT_MSG_EQ (vector.GetN (), 1,
  ...
  //
  p->GetAttribute ("TestVector1", vector);
  NS_TEST_ASSERT_MSG_EQ (vector.GetN (), 2,
                         "ObjectVectorValue \"TestVector1\" should be incremented");
}
...
ObjectMapAttributeTestCase::DoRun (void)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (map.GetN (), 0,
...
IntegerTraceSourceAttributeTestCase::DoRun (void)
{
  ...
  p->GetAttribute ("IntegerTraceSource1", iv);
  NS_TEST_ASSERT_MSG_EQ (iv.Get (), 5,
...
private:
   ...
   */
  void
  NotifySource1 ([[maybe_unused]] int8_t old, int8_t n)
  {
    m_got1 = n;
  }
...
IntegerTraceSourceTestCase::DoRun (void)
{
  ...
  ok = p->TraceConnectWithoutContext (
      "Source1", MakeCallback (&IntegerTraceSourceTestCase::NotifySource1, this));
  NS_TEST_ASSERT_MSG_EQ (ok, true,
  ...
  NS_TEST_ASSERT_MSG_EQ (m_got1, 0,
...
private:
   ...
   */
  void
  NotifySource2 (double a, [[maybe_unused]] int b, [[maybe_unused]] float c)
  {
    m_got2 = a;
  }
...
TracedCallbackTestCase::TracedCallbackTestCase (std::string description) : TestCase (description)
{
}
...
TracedCallbackTestCase::DoRun (void)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (
      m_got2, 4.3, "Invoking a newly created TracedCallback results in an unexpected callback");
  ...
  p->InvokeCb (-1.0, -5, 0.0);
  NS_TEST_ASSERT_MSG_EQ (
      m_got2, 1.0, "Invoking disconnected TracedCallback unexpectedly results in trace callback");
}
...
PointerAttributeTestCase::DoRun (void)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (storedBase, stored,
  ...
  NS_TEST_ASSERT_MSG_EQ ((bool) x, false,
  ...
  NS_TEST_ASSERT_MSG_NE (storedPtr, storedPtr2,
  ...
  NS_TEST_ASSERT_MSG_NE (storedPtr, storedPtr3,
  ...
  NS_TEST_ASSERT_MSG_NE (storedPtr4, storedPtr5,
...
CallbackValueTestCase::CallbackValueTestCase (std::string description) : TestCase (description)
{
}
