  ...
  static TypeId tid =
      TypeId ("ns3::PairObject")
          ...
          .AddAttribute ("StringPair", "Pair: string, string",
                         ...
                         MakePairChecker<StringValue, StringValue> (MakeStringChecker (),
                                                                    MakeStringChecker ()))
...
PairValueTestCase::PairValueTestCase () : TestCase ("test instantiation, initialization, access")
{
}
...
PairValueTestSuite::PairValueTestSuite () : TestSuite ("pair-value-test-suite", UNIT)
{
