...
TupleObject::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::TupleObject")
          ...
          .AddAttribute (
              "StringStringEnumTuple", "Tuple1: string, string, enum",
          ...
          .AddAttribute (
              ...
              MakeTupleChecker<DoubleValue, UintegerValue, StringValue> (
                  MakeDoubleChecker<double> (1.0, 10.0), MakeUintegerChecker<int> (1, 30),
                  MakeStringChecker ()));
  return tid;
}
...
TupleValueTestCase::TupleValueTestCase () : TestCase ("test TupleValue attribute value")
{
}
...
TupleValueTestCase::DoRun ()
{
  ...
  bool ret1 = tupleObject->SetAttributeFailSafe (
      "StringStringEnumTuple", MakeTupleValue<TupleObject::Tuple1Pack> (
  ...
  ret2 = tupleObject->SetAttributeFailSafe (
      "DoubleUintStringTuple", TupleValue<DoubleValue, UintegerValue, StringValue, StringValue> (
...
TupleValueTestSuite::TupleValueTestSuite () : TestSuite ("tuple-value-test-suite", UNIT)
{
