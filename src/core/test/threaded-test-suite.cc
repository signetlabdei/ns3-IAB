...
public:
   ...
   */
  ThreadedSimulatorEventsTestCase (ObjectFactory schedulerFactory, const std::string &simulatorType,
...
ThreadedSimulatorEventsTestCase::EventD (int d)
{
  ...
  if (m_stop)
    ...
    {
      Simulator::Schedule (MicroSeconds (10), &ThreadedSimulatorEventsTestCase::EventA, this,
                           d + 1);
    }
}
...
public:
  ThreadedSimulatorTestSuite () : TestSuite ("threaded-simulator")
  {
    ...
    std::string schedulerTypes[] = {"ns3::ListScheduler", "ns3::HeapScheduler", "ns3::MapScheduler",
