...
AttributeContainerObject::GetTypeId ()
{
  static TypeId tid =
      TypeId ("ns3::AttributeContainerObject")
          ...
          .AddAttribute (
              "DoubleList", "List of doubles", AttributeContainerValue<DoubleValue> (),
          ...
          .AddAttribute (
              ...
              MakeAttributeContainerAccessor<IntegerValue, std::list> (
                  &AttributeContainerObject::SetIntVec, &AttributeContainerObject::GetIntVec),
...
AttributeContainerSetGetTestCase::DoRun (void)
{
  Ptr<AttributeContainerObject> obj = CreateObject<AttributeContainerObject> ();
  {
    ...
    NS_TEST_ASSERT_MSG_EQ (oss.str (),
                           "AttributeContainerObject: ", "DoubleList initialized incorrectly");
  }
  ...
  obj->SetAttribute ("DoubleList", AttributeContainerValue<DoubleValue> (doubles));
  {
    std::ostringstream oss;
    oss << *obj;
    NS_TEST_ASSERT_MSG_EQ (oss.str (), "AttributeContainerObject: 1.1, 2.22, 3.333",
  ...
  obj->ReverseList ();
  {
    std::ostringstream oss;
    oss << *obj;
    NS_TEST_ASSERT_MSG_EQ (oss.str (), "AttributeContainerObject: 3.333, 2.22, 1.1",
