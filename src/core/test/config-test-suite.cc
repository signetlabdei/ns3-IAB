  ...
  static TypeId tid =
      TypeId ("ConfigTestObject")
          ...
          .AddAttribute ("NodeB", "", PointerValue (),
                         ...
                         MakePointerChecker<ConfigTestObject> ())
          .AddAttribute ("A", "", IntegerValue (10), MakeIntegerAccessor (&ConfigTestObject::m_a),
                         MakeIntegerChecker<int8_t> ())
          .AddAttribute ("B", "", IntegerValue (9), MakeIntegerAccessor (&ConfigTestObject::m_b),
                         MakeIntegerChecker<int8_t> ())
          .AddAttribute ("Source", "XX", IntegerValue (-1),
                         MakeIntegerAccessor (&ConfigTestObject::m_trace),
                         MakeIntegerChecker<int16_t> ())
          .AddTraceSource ("Source", "XX", MakeTraceSourceAccessor (&ConfigTestObject::m_trace),
...
BaseConfigObject::GetTypeId (void)
{
  static TypeId tid =
      TypeId ("BaseConfigObject")
          .SetParent<Object> ()
          .AddAttribute ("X", "", IntegerValue (10), MakeIntegerAccessor (&BaseConfigObject::m_x),
                         MakeIntegerChecker<int8_t> ());
  return tid;
}
...
public:
   ...
   */
  void
  Trace ([[maybe_unused]] int16_t oldValue, int16_t newValue)
  {
    m_newValue = newValue;
  }
  /**
   ...
   */
  void
  TraceWithPath (std::string path, [[maybe_unused]] int16_t old, int16_t newValue)
  {
    m_newValue = newValue;
    m_path = path;
  }
...
SearchAttributesOfParentObjectsTestCase::SearchAttributesOfParentObjectsTestCase ()
    : TestCase ("Check that attributes of base class are searchable from paths including objects "
                "of derived class")
{
}
