...
void
bar4i (int, int, int, int)
{
}
/// Function with five int parameters.
void
bar5i (int, int, int, int, int)
{
}
...
TimerStateTestCase::TimerStateTestCase () : TestCase ("Check correct state transitions")
{
}
void
...
TimerTemplateTestCase::TimerTemplateTestCase () : TestCase ("Check that template magic is working")
{
}
