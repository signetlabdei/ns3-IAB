...
RngUniformTestCase::RngUniformTestCase () : TestCase ("Uniform Random Number Generator")
{
}
...
RngNormalTestCase::RngNormalTestCase () : TestCase ("Normal Random Number Generator")
{
}
...
RngExponentialTestCase::RngExponentialTestCase () : TestCase ("Exponential Random Number Generator")
{
}
...
RngParetoTestCase::RngParetoTestCase () : TestCase ("Pareto Random Number Generator")
{
}
