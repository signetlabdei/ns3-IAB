...
public:
   ...
   */
  int
  Target4 ([[maybe_unused]] double a, [[maybe_unused]] int b)
  {
    m_test4 = true;
    return 4;
  }
...
BasicCallbackTestCase::BasicCallbackTestCase () : TestCase ("Check basic Callback mechansim")
{
}
...
MakeCallbackTestCase::MakeCallbackTestCase () : TestCase ("Check MakeCallback() mechanism")
{
}
...
CallbackEqualityTestCase::CallbackEqualityTestCase () : TestCase ("Check Callback equality test")
{
}
...
NullifyCallbackTestCase::NullifyCallbackTestCase () : TestCase ("Check Nullify() and IsNull()")
{
}
...
void
TestFThree (int, int, int)
{
}
void
TestFFour (int, int, int, int)
{
}
void
TestFFive (int, int, int, int, int)
{
}
void
TestFSix (int, int, int, int, int, int)
{
}
...
void
TestFRThree (int &, int &, int &)
{
}
void
TestFRFour (int &, int &, int &, int &)
{
}
void
TestFRFive (int &, int &, int &, int &, int &)
{
}
void
TestFRSix (int &, int &, int &, int &, int &, int &)
{
}
/** @} */
/* *NS_CHECK_STYLE_ON* */
...
protected:
  ...
  void
  ProtectedParent (void)
  {
  }
  /// A static protected function.
  static void
  StaticProtectedParent (void)
  {
  }
...
public:
  ...
  void
  TestThree (int, int, int)
  {
  }
  void
  TestFour (int, int, int, int)
  {
  }
  void
  TestFive (int, int, int, int, int)
  {
  }
  void
  TestSix (int, int, int, int, int, int)
  {
  }
  void
  TestCZero (void) const
  {
  }
  void
  TestCOne (int) const
  ...
  void
  TestCTwo (int, int) const
  {
  }
  void
  TestCThree (int, int, int) const
  {
  }
  void
  TestCFour (int, int, int, int) const
  {
  }
  void
  TestCFive (int, int, int, int, int) const
  {
  }
  void
  TestCSix (int, int, int, int, int, int) const
  {
  }
  /** @} */
  /* *NS_CHECK_STYLE_ON* */
