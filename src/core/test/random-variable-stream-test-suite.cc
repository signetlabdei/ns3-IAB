...
public:
   ...
   */
  std::vector<double>
  UniformHistogramBins (gsl_histogram *h, double start, double end, bool underflow = true,
   ...
   */
  double
  ChiSquared (gsl_histogram *h, const std::vector<double> &expected,
   ...
   */
  double
  ChiSquaredsAverage (const RngGeneratorBase *generator, std::size_t nRuns) const
  {
...
UniformTestCase::UniformTestCase () : TestCaseBase ("Uniform Random Variable Stream Generator")
{
}
...
ConstantTestCase::ConstantTestCase () : TestCaseBase ("Constant Random Variable Stream Generator")
{
}
...
NormalTestCase::NormalTestCase () : TestCaseBase ("Normal Random Variable Stream Generator")
{
}
...
ParetoTestCase::ParetoTestCase () : TestCaseBase ("Pareto Random Variable Stream Generator")
{
}
...
WeibullTestCase::WeibullTestCase () : TestCaseBase ("Weibull Random Variable Stream Generator")
{
}
...
GammaTestCase::GammaTestCase () : TestCaseBase ("Gamma Random Variable Stream Generator")
{
}
...
ErlangTestCase::ErlangTestCase () : TestCaseBase ("Erlang Random Variable Stream Generator")
{
}
...
ZipfTestCase::ZipfTestCase () : TestCaseBase ("Zipf Random Variable Stream Generator")
{
}
...
ZetaTestCase::ZetaTestCase () : TestCaseBase ("Zeta Random Variable Stream Generator")
{
}
...
RandomVariableSuite::RandomVariableSuite () : TestSuite ("random-variable-stream-generators", UNIT)
{
