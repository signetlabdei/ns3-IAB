  ...
  static TypeId tid =
      TypeId ("ns3::ThreeGppHttpServer")
          ...
          .AddAttribute ("LocalAddress",
                         ...
                         AddressValue (), MakeAddressAccessor (&ThreeGppHttpServer::m_localAddress),
                         MakeAddressChecker ())
          .AddAttribute ("LocalPort", "Port on which the application listen for incoming packets.",
          ...
          .AddTraceSource ("MainObject", "A main object has been generated.",
                           MakeTraceSourceAccessor (&ThreeGppHttpServer::m_mainObjectTrace),
                           "ns3::HttpServer::HttpObjectCallback")
          .AddTraceSource ("EmbeddedObject", "An embedded object has been generated.",
          ...
          .AddTraceSource ("RxDelay", "A packet has been received with delay information.",
      ...
      switch (httpHeader.GetContentType ())
        ...
        case ThreeGppHttpHeader::EMBEDDED_OBJECT:
          ...
          m_txBuffer->RecordNextServe (
              socket,
              Simulator::Schedule (processingDelay, &ThreeGppHttpServer::ServeNewEmbeddedObject,
                                   this, socket),
              httpHeader.GetClientTs ());
          break;
...
ThreeGppHttpServerTxBuffer::AddSocket (Ptr<Socket> socket)
{
  ...
  NS_ASSERT_MSG (!IsSocketAvailable (socket), this << " Cannot add socket " << socket
...
void
ThreeGppHttpServerTxBuffer::RecordNextServe (Ptr<Socket> socket, const EventId &eventId,
                                             const Time &clientTs)
{
