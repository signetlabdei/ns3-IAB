...
void
FdNetDeviceHelper::EnablePcapInternal (std::string prefix, Ptr<NetDevice> nd, bool promiscuous,
...
void
FdNetDeviceHelper::EnableAsciiInternal (Ptr<OutputStreamWrapper> stream, std::string prefix,
  ...
  if (!stream)
    {
      ...
      //
      asciiTraceHelper.HookDefaultReceiveSinkWithoutContext<FdNetDevice> (device, "MacRx",
                                                                          theStream);
