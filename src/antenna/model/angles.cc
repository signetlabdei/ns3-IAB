...
Angles::Angles () : Angles (NAN, NAN)
{
}

Angles::Angles (double azimuth, double inclination)
    : m_azimuth (azimuth), m_inclination (inclination)
{
  NormalizeAngles ();
}

Angles::Angles (Vector v)
    : m_azimuth (std::atan2 (v.y, v.x)), m_inclination (std::acos (v.z / v.GetLength ()))
{
...
Angles::Angles (Vector v, Vector o) : Angles (v - o)
{
}
