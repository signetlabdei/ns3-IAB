...
private:
  double
      m_verticalBeamwidthDegrees; //!< beamwidth in the vertical direction \f$(\theta_{3dB})\f$ [deg]
  double
      m_horizontalBeamwidthDegrees; //!< beamwidth in the horizontal direction \f$(\phi_{3dB})\f$ [deg]
