...
Vector
GeographicPositions::GeographicToCartesianCoordinates (double latitude, double longitude,
  ...
  for (int i = 0; i < numPoints; i++)
    {
      ...
      Vector pointPosition = GeographicPositions::GeographicToCartesianCoordinates (
          randPointLatitude * RAD2DEG, randPointLongitude * RAD2DEG, randAltitude, SPHERE);
      // convert coordinates
