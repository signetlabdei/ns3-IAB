...
void
ListPositionAllocator::Add (const std::string filePath, double defaultZ /* = 0 */,
                            char delimiter /* = ',' */)
{
  ...
  static TypeId tid =
      TypeId ("ns3::GridPositionAllocator")
          ...
          .AddAttribute ("GridWidth", "The number of objects laid out on a line.",
                         UintegerValue (10), MakeUintegerAccessor (&GridPositionAllocator::m_n),
          ...
          .AddAttribute ("MinY", "The y coordinate where the grid starts.", DoubleValue (0.0),
                         ...
                         MakeDoubleChecker<double> ())
          .AddAttribute ("Z", "The z coordinate of all the positions allocated.", DoubleValue (0.0),
...
GridPositionAllocator::GridPositionAllocator () : m_current (0)
{
}
  ...
  static TypeId tid =
      TypeId ("ns3::RandomDiscPositionAllocator")
          ...
          .AddAttribute (
              ...
              MakePointerChecker<RandomVariableStream> ())
          .AddAttribute ("X", "The x coordinate of the center of the random position disc.",
                         DoubleValue (0.0), MakeDoubleAccessor (&RandomDiscPositionAllocator::m_x),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("Y", "The y coordinate of the center of the random position disc.",
                         DoubleValue (0.0), MakeDoubleAccessor (&RandomDiscPositionAllocator::m_y),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("Z", "The z coordinate of all the positions in the disc.",
                         DoubleValue (0.0), MakeDoubleAccessor (&RandomDiscPositionAllocator::m_z),
                         MakeDoubleChecker<double> ());
  return tid;
}
...
{
  static TypeId tid =
      TypeId ("ns3::UniformDiscPositionAllocator")
          .SetParent<PositionAllocator> ()
          .SetGroupName ("Mobility")
          .AddConstructor<UniformDiscPositionAllocator> ()
          .AddAttribute ("rho", "The radius of the disc", DoubleValue (0.0),
          ...
          .AddAttribute ("Y", "The y coordinate of the center of the  disc.", DoubleValue (0.0),
                         ...
                         MakeDoubleChecker<double> ())
          .AddAttribute ("Z", "The z coordinate of all the positions in the disc.",
                         DoubleValue (0.0), MakeDoubleAccessor (&UniformDiscPositionAllocator::m_z),
                         MakeDoubleChecker<double> ());
  return tid;
}
