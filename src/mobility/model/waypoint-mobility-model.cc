  ...
  static TypeId tid =
      TypeId ("ns3::WaypointMobilityModel")
          ...
          .AddAttribute ("NextWaypoint", "The next waypoint used to determine position.",
                         TypeId::ATTR_GET, WaypointValue (),
                         MakeWaypointAccessor (&WaypointMobilityModel::GetNextWaypoint),
                         MakeWaypointChecker ())
          .AddAttribute ("WaypointsLeft", "The number of waypoints remaining.", TypeId::ATTR_GET,
                         UintegerValue (0),
...
WaypointMobilityModel::WaypointMobilityModel ()
    : m_first (true), m_lazyNotify (false), m_initialPositionIsWaypoint (false)
{
}
