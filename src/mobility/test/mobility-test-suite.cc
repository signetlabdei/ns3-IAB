...
WaypointLazyNotifyFalse::CourseChangeCallback (std::string path, Ptr<const MobilityModel> model)
{
  ...
  NS_TEST_EXPECT_MSG_EQ_TOL (m_courseChanges * 10.0, Simulator::Now ().GetSeconds (), 0.001,
...
WaypointInitialPositionIsWaypoint::DoRun ()
{
  ...
  Simulator::Schedule (Seconds (1.0), &WaypointInitialPositionIsWaypoint::TestNumWaypoints, this,
                       m_mob1, 0);
  // At time 15s, the model should still be at x position 10.0
  Simulator::Schedule (Seconds (15.0), &WaypointInitialPositionIsWaypoint::TestXPosition, this,
                       m_mob1, 10.0);
  ...
  Simulator::Schedule (Seconds (3.0), &WaypointInitialPositionIsWaypoint::TestXPosition, this,
                       m_mob2, 10.0);
  Simulator::Schedule (Seconds (3.0), &WaypointInitialPositionIsWaypoint::TestNumWaypoints, this,
                       m_mob2, 1);
  ...
  Simulator::Schedule (Seconds (8.0), &WaypointInitialPositionIsWaypoint::TestXPosition, this,
                       m_mob2, 18.0);
  Simulator::Schedule (Seconds (8.0), &WaypointInitialPositionIsWaypoint::TestNumWaypoints, this,
                       m_mob2, 0);
  ...
  Simulator::Schedule (Seconds (6.0), &WaypointInitialPositionIsWaypoint::TestXPosition, this,
                       m_mob4, 16.0);
...
WaypointMobilityModelViaHelper::DoRun ()
{
  ...
  Simulator::Schedule (Seconds (7.5), &WaypointMobilityModelViaHelper::TestXPosition, this, mob,
                       15);
  ...
  mobility2.SetMobilityModel ("ns3::WaypointMobilityModel", "InitialPositionIsWaypoint",
                              BooleanValue (true));
