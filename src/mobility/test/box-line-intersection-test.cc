...
BoxLineIntersectionTestCase::BoxLineIntersectionTestCase (uint16_t indexPos1, uint16_t indexPos2,
                                                          Box box, bool intersect)
...
std::string
BoxLineIntersectionTestCase::BuildNameString (uint16_t indexPos1, uint16_t indexPos2, Box box,
                                              bool intersect)
{
...
BoxLineIntersectionTestCase::DoRun ()
{
  ...
  NS_TEST_ASSERT_MSG_EQ (intersect, m_intersect,
