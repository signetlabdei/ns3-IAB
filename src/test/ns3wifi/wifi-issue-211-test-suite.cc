...
Issue211Test::DoRun ()
{
  ...
  wifi.SetRemoteStationManager ("ns3::ConstantRateWifiManager", "DataMode", StringValue ("HtMcs0"),
  ...
  mac.SetType ("ns3::ApWifiMac", "Ssid", SsidValue (Ssid ("issue211-test")), "EnableBeaconJitter",
               BooleanValue (false));
  ...
  Simulator::Schedule (warmup + moveAwayTime + MilliSeconds (10), &Issue211Test::CalcThroughput,
  ...
  NS_TEST_EXPECT_MSG_GT (m_tputValues[0], 0,
