 ...
 */
void
PhyRxOkTrace (std::string context, Ptr<const Packet> packet, double snr, WifiMode mode,
 ...
 */
void
PhyTxTrace (std::string context, Ptr<const Packet> packet, WifiMode mode, WifiPreamble preamble,
            uint8_t txPower)
{
  if (g_verbose)
    {
...
main (int argc, char *argv[])
{
  ...
  // setup stas.
  wifiMac.SetType ("ns3::StaWifiMac", "ActiveProbing", BooleanValue (true), "Ssid",
                   SsidValue (ssid));
