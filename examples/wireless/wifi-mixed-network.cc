...
Experiment::Run (Parameters params)
{
  ...
  mac.SetType ("ns3::StaWifiMac", "Ssid", SsidValue (ssid), "ShortSlotTimeSupported",
  ...
  mac.SetType ("ns3::StaWifiMac", "Ssid", SsidValue (ssid), "BE_BlockAckThreshold",
               UintegerValue (2), "ShortSlotTimeSupported",
               BooleanValue (params.enableShortSlotTime));
