...
main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("channelBandwidth", "Bandwidth of the channel in MHz [20, 40, or 80]",
                channelBandwidth);
  ...
  spectrumPhy.SetPreambleDetectionModel ("ns3::ThresholdPreambleDetectionModel", "MinimumRssi",
